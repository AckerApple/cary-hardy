 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Q;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(Q||(Q={}));const nT={debug:Q.DEBUG,verbose:Q.VERBOSE,info:Q.INFO,warn:Q.WARN,error:Q.ERROR,silent:Q.SILENT},rT=Q.INFO,sT={[Q.DEBUG]:"log",[Q.VERBOSE]:"log",[Q.INFO]:"info",[Q.WARN]:"warn",[Q.ERROR]:"error"},iT=(n,e,...t)=>{if(e<n.logLevel)return;const r=new Date().toISOString(),s=sT[e];if(s)console[s](`[${r}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Cc{constructor(e){this.name=e,this._logLevel=rT,this._logHandler=iT,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in Q))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?nT[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,Q.DEBUG,...e),this._logHandler(this,Q.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,Q.VERBOSE,...e),this._logHandler(this,Q.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,Q.INFO,...e),this._logHandler(this,Q.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,Q.WARN,...e),this._logHandler(this,Q.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,Q.ERROR,...e),this._logHandler(this,Q.ERROR,...e)}}const oT=(n,e)=>e.some(t=>n instanceof t);let Xu,Zu;function aT(){return Xu||(Xu=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function cT(){return Zu||(Zu=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const fp=new WeakMap,Na=new WeakMap,pp=new WeakMap,aa=new WeakMap,Rc=new WeakMap;function lT(n){const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("success",i),n.removeEventListener("error",o)},i=()=>{t(rn(n.result)),s()},o=()=>{r(n.error),s()};n.addEventListener("success",i),n.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&fp.set(t,n)}).catch(()=>{}),Rc.set(e,n),e}function uT(n){if(Na.has(n))return;const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("complete",i),n.removeEventListener("error",o),n.removeEventListener("abort",o)},i=()=>{t(),s()},o=()=>{r(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",i),n.addEventListener("error",o),n.addEventListener("abort",o)});Na.set(n,e)}let Oa={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return Na.get(n);if(e==="objectStoreNames")return n.objectStoreNames||pp.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return rn(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function hT(n){Oa=n(Oa)}function dT(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const r=n.call(ca(this),e,...t);return pp.set(r,e.sort?e.sort():[e]),rn(r)}:cT().includes(n)?function(...e){return n.apply(ca(this),e),rn(fp.get(this))}:function(...e){return rn(n.apply(ca(this),e))}}function fT(n){return typeof n=="function"?dT(n):(n instanceof IDBTransaction&&uT(n),oT(n,aT())?new Proxy(n,Oa):n)}function rn(n){if(n instanceof IDBRequest)return lT(n);if(aa.has(n))return aa.get(n);const e=fT(n);return e!==n&&(aa.set(n,e),Rc.set(e,n)),e}const ca=n=>Rc.get(n);function pT(n,e,{blocked:t,upgrade:r,blocking:s,terminated:i}={}){const o=indexedDB.open(n,e),c=rn(o);return r&&o.addEventListener("upgradeneeded",l=>{r(rn(o.result),l.oldVersion,l.newVersion,rn(o.transaction),l)}),t&&o.addEventListener("blocked",l=>t(l.oldVersion,l.newVersion,l)),c.then(l=>{i&&l.addEventListener("close",()=>i()),s&&l.addEventListener("versionchange",h=>s(h.oldVersion,h.newVersion,h))}).catch(()=>{}),c}const gT=["get","getKey","getAll","getAllKeys","count"],mT=["put","add","delete","clear"],la=new Map;function eh(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(la.get(e))return la.get(e);const t=e.replace(/FromIndex$/,""),r=e!==t,s=mT.includes(t);if(!(t in(r?IDBIndex:IDBObjectStore).prototype)||!(s||gT.includes(t)))return;const i=async function(o,...c){const l=this.transaction(o,s?"readwrite":"readonly");let h=l.store;return r&&(h=h.index(c.shift())),(await Promise.all([h[t](...c),s&&l.done]))[0]};return la.set(e,i),i}hT(n=>({...n,get:(e,t,r)=>eh(e,t)||n.get(e,t,r),has:(e,t)=>!!eh(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yT{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(_T(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function _T(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const La="@firebase/app",th="0.14.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const br=zT;function gp(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r={name:Ma,automaticDataCollectionEnabled:!0,...e},s=r.name;if(typeof s!="string"||!s)throw sn.create("bad-app-name",{appName:String(s)});if(t||(t=lp()),!t)throw sn.create("no-options");const i=Ri.get(s);if(i){if(xn(t,i.options)&&xn(r,i.config))return i;throw sn.create("duplicate-app",{appName:s})}const o=new tT(s);for(const l of Fa.values())o.addComponent(l);const c=new KT(t,r,o);return Ri.set(s,c),c}function mp(n=Ma){const e=Ri.get(n);if(!e&&n===Ma&&lp())return gp();if(!e)throw sn.create("no-app",{appName:n});return e}function on(n,e,t){let r=GT[n]??n;t&&(r+=`-${t}`);const s=r.match(/\s|\//),i=e.match(/\s|\//);if(s||i){const o=[`Unable to register library "${r}" with version "${e}":`];s&&o.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&i&&o.push("and"),i&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ot.warn(o.join(" "));return}cr(new Vn(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ZT=1024,eE=30;class tE{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new rE(t),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,t;try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=sh();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(o=>o.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:s}),this._heartbeatsCache.heartbeats.length>eE){const o=sE(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(r){Ot.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=sh(),{heartbeatsToSend:r,unsentEntries:s}=nE(this._heartbeatsCache.heartbeats),i=Ci(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=t,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}catch(t){return Ot.warn(t),""}}}function sh(){return new Date().toISOString().substring(0,10)}function nE(n,e=ZT){const t=[];let r=n.slice();for(const s of n){const i=t.find(o=>o.agent===s.agent);if(i){if(i.dates.push(s.date),ih(t)>e){i.dates.pop();break}}else if(t.push({agent:s.agent,dates:[s.date]}),ih(t)>e){t.pop();break}r=r.slice(1)}return{heartbeatsToSend:t,unsentEntries:r}}class rE{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return qb()?$b().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await XT(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return rh(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return rh(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function ih(n){return Ci(JSON.stringify({version:2,heartbeats:n})).length}function sE(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let r=1;r<n.length;r++)n[r].date<t&&(t=n[r].date,e=r);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iE(n){cr(new Vn("platform-logger",e=>new yT(e),"PRIVATE")),cr(new Vn("heartbeat",e=>new tE(e),"PRIVATE")),on(La,th,n),on(La,th,"esm2020"),on("fire-js","")}iE("");var oE="firebase",aE="12.8.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Si=new Cc("@firebase/auth");function lE(n,...e){Si.logLevel<=Q.WARN&&Si.warn(`Auth (${br}): ${n}`,...e)}function ui(n,...e){Si.logLevel<=Q.ERROR&&Si.error(`Auth (${br}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ua(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function uE(){return oh()==="http:"||oh()==="https:"}function oh(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pE=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],gE=new Ss(3e4,6e4);function Vc(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function Tr(n,e,t,r,s={}){return vp(n,s,async()=>{let i={},o={};r&&(e==="GET"?o=r:i={body:JSON.stringify(r)});const c=Rs({key:n.config.apiKey,...o}).slice(1),l=await n._getAdditionalHeaders();l["Content-Type"]="application/json",n.languageCode&&(l["X-Firebase-Locale"]=n.languageCode);const h={method:e,headers:l,...i};return Fb()||(h.referrerPolicy="no-referrer"),n.emulatorConfig&&wr(n.emulatorConfig.host)&&(h.credentials="include"),Ep.fetch()(await Ip(n,n.config.apiHost,t,c),h)})}async function vp(n,e,t){n._canInitEmulator=!1;const r={...fE,...e};try{const s=new yE(n),i=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const o=await i.json();if("needConfirmation"in o)throw ti(n,"account-exists-with-different-credential",o);if(i.ok&&!("errorMessage"in o))return o;{const c=i.ok?o.errorMessage:o.error.message,[l,h]=c.split(" : ");if(l==="FEDERATED_USER_ID_ALREADY_LINKED")throw ti(n,"credential-already-in-use",o);if(l==="EMAIL_EXISTS")throw ti(n,"email-already-in-use",o);if(l==="USER_DISABLED")throw ti(n,"user-disabled",o);const f=r[l]||l.toLowerCase().replace(/[_\s]+/g,"-");if(h)throw kc(n,f,h);vt(n,f)}}catch(s){if(s instanceof Ut)throw s;vt(n,"network-request-failed",{message:String(s)})}}async function mE(n,e,t,r,s={}){const i=await Tr(n,e,t,r,s);return"mfaPendingCredential"in i&&vt(n,"multi-factor-auth-required",{_serverResponse:i}),i}async function Ip(n,e,t,r){const s=`${e}${t}?${r}`,i=n,o=i.config.emulator?xc(n.config,s):`${n.config.apiScheme}://${s}`;return pE.includes(t)&&(await i._persistenceManagerAvailable,i._getPersistenceType()==="COOKIE")?i._getPersistence()._getFinalTarget(o).toString():o}class yE{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,r)=>{this.timer=setTimeout(()=>r(ut(this.auth,"network-request-failed")),gE.get())})}}function ti(n,e,t){const r={appName:n.name};t.email&&(r.email=t.email),t.phoneNumber&&(r.phoneNumber=t.phoneNumber);const s=ut(n,e,r);return s.customData._tokenResponse=t,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _E(n,e){return Tr(n,"POST","/v1/accounts:delete",e)}async function ki(n,e){return Tr(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function es(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function wE(n,e=!1){const t=qe(n),r=await t.getIdToken(e),s=Dc(r);H(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,o=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:es(ha(s.auth_time)),issuedAtTime:es(ha(s.iat)),expirationTime:es(ha(s.exp)),signInProvider:o||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function ha(n){return Number(n)*1e3}function Dc(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return ui("JWT malformed, contained fewer than 3 sections"),null;try{const s=ap(t);return s?JSON.parse(s):(ui("Failed to decode base64 JWT payload"),null)}catch(s){return ui("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function ah(n){const e=Dc(n);return H(e,"internal-error"),H(typeof e.exp<"u","internal-error"),H(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uh(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Pp(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Rp(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Vp(e))return"Blackberry";if(Dp(e))return"Webos";if(Sp(e))return"Safari";if((e.includes("chrome/")||kp(e))&&!e.includes("edge/"))return"Chrome";if(xp(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Rp(n=He()){return/firefox\//i.test(n)}function Sp(n=He()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function kp(n=He()){return/crios\//i.test(n)}function Pp(n=He()){return/iemobile/i.test(n)}function xp(n=He()){return/android/i.test(n)}function Vp(n=He()){return/blackberry/i.test(n)}function Dp(n=He()){return/webos/i.test(n)}function Nc(n=He()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function CE(n=He()){var e;return Nc(n)&&!!((e=window.navigator)!=null&&e.standalone)}function RE(){return Bb()&&document.documentMode===10}function Np(n=He()){return Nc(n)||xp(n)||Dp(n)||Vp(n)||/windows phone/i.test(n)||Pp(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Op(n,e=[]){let t;switch(n){case"Browser":t=uh(He());break;case"Worker":t=`${uh(He())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${br}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kE(n,e={}){return Tr(n,"GET","/v2/passwordPolicy",Vc(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Oc={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function DE(n){Oc=n}function NE(n){return Oc.loadJS(n)}function OE(){return Oc.gapiScript}function LE(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ME(n,e){const t=Sc(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(xn(i,e??{}))return s;vt(s,"already-initialized")}return t.initialize({options:e})}function FE(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(Pt);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function UE(n,e,t){const r=Er(n);H(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=Lp(e),{host:o,port:c}=jE(e),l=c===null?"":`:${c}`,h={url:`${i}//${o}${l}/`},f=Object.freeze({host:o,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){H(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),H(xn(h,r.config.emulator)&&xn(f,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=h,r.emulatorConfig=f,r.settings.appVerificationDisabledForTesting=!0,wr(o)?(hp(`${i}//${o}${l}`),dp("Auth",!0)):BE()}function Lp(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function jE(n){const e=Lp(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:dh(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:dh(o)}}}function dh(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function BE(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ir(n,e){return mE(n,"POST","/v1/accounts:signInWithIdp",Vc(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yt extends ks{constructor(){super("facebook.com")}static credential(e){return Dn._fromParams({providerId:Yt.PROVIDER_ID,signInMethod:Yt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Yt.credentialFromTaggedObject(e)}static credentialFromError(e){return Yt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Yt.credential(e.oauthAccessToken)}catch{return null}}}Yt.FACEBOOK_SIGN_IN_METHOD="facebook.com";Yt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class St extends ks{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return Dn._fromParams({providerId:St.PROVIDER_ID,signInMethod:St.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return St.credentialFromTaggedObject(e)}static credentialFromError(e){return St.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return St.credential(t,r)}catch{return null}}}St.GOOGLE_SIGN_IN_METHOD="google.com";St.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xt extends ks{constructor(){super("github.com")}static credential(e){return Dn._fromParams({providerId:Xt.PROVIDER_ID,signInMethod:Xt.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Xt.credentialFromTaggedObject(e)}static credentialFromError(e){return Xt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Xt.credential(e.oauthAccessToken)}catch{return null}}}Xt.GITHUB_SIGN_IN_METHOD="github.com";Xt.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zt extends ks{constructor(){super("twitter.com")}static credential(e,t){return Dn._fromParams({providerId:Zt.PROVIDER_ID,signInMethod:Zt.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return Zt.credentialFromTaggedObject(e)}static credentialFromError(e){return Zt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return Zt.credential(t,r)}catch{return null}}}Zt.TWITTER_SIGN_IN_METHOD="twitter.com";Zt.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fc(n,e){return e?Pt(e):(H(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bv(n,e,t){return Tv(n,e,t)}async function Tv(n,e,t){if(Ze(n.app))return Promise.reject(an(n));const r=Er(n);Tp(n,e,ao),await r._initializationPromise;const s=Fc(r,t);return await _v(s,r),s._openRedirect(r,e,"signInViaRedirect")}async function Ev(n,e){return await Er(n)._initializationPromise,Yp(n,e,!1)}async function Yp(n,e,t=!1){if(Ze(n.app))return Promise.reject(an(n));const r=Er(n),s=Fc(r,e),o=await new mv(r,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cv(n,e={}){return Tr(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nv=new Ss(5e3,15e3),Ov="__/auth/iframe",Lv="emulator/auth/iframe",Mv={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Fv=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Uv(n){const e=n.config;H(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?xc(e,Lv):`https://${n.config.authDomain}/${Ov}`,r={apiKey:e.apiKey,appName:n.name,v:br},s=Fv.get(n.config.apiHost);s&&(r.eid=s);const i=n._getFrameworks();return i.length&&(r.fw=i.join(",")),`${t}?${Rs(r).slice(1)}`}async function jv(n){const e=await Dv(n),t=wt().gapi;return H(t,n,"internal-error"),e.open({where:document.body,url:Uv(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Mv,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const o=ut(n,"network-request-failed"),c=wt().setTimeout(()=>{i(o)},Nv.get());function l(){wt().clearTimeout(c),s(r)}r.ping(l).then(l,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bv={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Hv=500,qv=600,$v="_blank",zv="http://localhost";class _h{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Gv(n,e,t,r=Hv,s=qv){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let c="";const l={...Bv,width:r.toString(),height:s.toString(),top:i,left:o},h=He().toLowerCase();t&&(c=kp(h)?$v:t),Rp(h)&&(e=e||zv,l.scrollbars="yes");const f=Object.entries(l).reduce((m,[y,R])=>`${m}${y}=${R},`,"");if(CE(h)&&c!=="_self")return Wv(e||"",c),new _h(null);const p=window.open(e||"",c,f);H(p,n,"popup-blocked");try{p.focus()}catch{}return new _h(p)}function Wv(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jv="__/auth/handler",Kv="emulator/auth/handler",Qv=encodeURIComponent("fac");async function wh(n,e,t,r,s,i){H(n.config.authDomain,n,"auth-domain-config-required"),H(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:br,eventId:s};if(e instanceof ao){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Jb(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,p]of Object.entries({}))o[f]=p}if(e instanceof ks){const f=e.getScopes().filter(p=>p!=="");f.length>0&&(o.scopes=f.join(","))}n.tenantId&&(o.tid=n.tenantId);const c=o;for(const f of Object.keys(c))c[f]===void 0&&delete c[f];const l=await n._getAppCheckToken(),h=l?`#${Qv}=${encodeURIComponent(l)}`:"";return`${Yv(n)}?${Rs(c).slice(1)}${h}`}function Yv({config:n}){return n.emulator?xc(n,Kv):`https://${n.authDomain}/${Jv}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tI(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function nI(n){cr(new Vn("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:o,authDomain:c}=r.options;H(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:o,authDomain:c,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Op(n)},h=new VE(r,s,i,l);return FE(h,t),h},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),cr(new Vn("auth-internal",e=>{const t=Er(e.getProvider("auth").getImmediate());return(r=>new eI(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),on(bh,Th,tI(n)),on(bh,Th,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var eg,Wr,tg,pi,Ha,ng,rg,sg;(function(){var n,e=Object.defineProperty;function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof ni=="object"&&ni];for(var u=0;u<a.length;++u){var d=a[u];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var r=t(this);function s(a,u){if(u)e:{var d=r;a=a.split(".");for(var g=0;g<a.length-1;g++){var A=a[g];if(!(A in d))break e;d=d[A]}a=a[a.length-1],g=d[a],u=u(g),u!=g&&u!=null&&e(d,a,{configurable:!0,writable:!0,value:u})}}s("Symbol.dispose",function(a){return a||Symbol("Symbol.dispose")}),s("Array.prototype.values",function(a){return a||function(){return this[Symbol.iterator]()}}),s("Object.entries",function(a){return a||function(u){var d=[],g;for(g in u)Object.prototype.hasOwnProperty.call(u,g)&&d.push([g,u[g]]);return d}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var i=i||{},o=this||self;function c(a){var u=typeof a;return u=="object"&&a!=null||u=="function"}function l(a,u,d){return a.call.apply(a.bind,arguments)}function h(a,u,d){return h=l,h.apply(null,arguments)}function f(a,u){var d=Array.prototype.slice.call(arguments,1);return function(){var g=d.slice();return g.push.apply(g,arguments),a.apply(this,g)}}function p(a,u){function d(){}d.prototype=u.prototype,a.Z=u.prototype,a.prototype=new d,a.prototype.constructor=a,a.Ob=function(g,A,S){for(var O=Array(arguments.length-2),J=2;J<arguments.length;J++)O[J-2]=arguments[J];return u.prototype[A].apply(g,O)}}var m=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?a=>a&&AsyncContext.Snapshot.wrap(a):a=>a;function y(a){const u=a.length;if(u>0){const d=Array(u);for(let g=0;g<u;g++)d[g]=a[g];return d}return[]}function R(a,u){for(let g=1;g<arguments.length;g++){const A=arguments[g];var d=typeof A;if(d=d!="object"?d:A?Array.isArray(A)?"array":d:"null",d=="array"||d=="object"&&typeof A.length=="number"){d=a.length||0;const S=A.length||0;a.length=d+S;for(let O=0;O<S;O++)a[d+O]=A[O]}else a.push(A)}}class x{constructor(u,d){this.i=u,this.j=d,this.h=0,this.g=null}get(){let u;return this.h>0?(this.h--,u=this.g,this.g=u.next,u.next=null):u=this.i(),u}}function N(a){o.setTimeout(()=>{throw a},0)}function D(){var a=v;let u=null;return a.g&&(u=a.g,a.g=a.g.next,a.g||(a.h=null),u.next=null),u}class V{constructor(){this.h=this.g=null}add(u,d){const g=G.get();g.set(u,d),this.h?this.h.next=g:this.g=g,this.h=g}}var G=new x(()=>new ve,a=>a.reset());class ve{constructor(){this.next=this.g=this.h=null}set(u,d){this.h=u,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let Je,Ne=!1,v=new V,_=()=>{const a=Promise.resolve(void 0);Je=()=>{a.then(b)}};function b(){for(var a;a=D();){try{a.h.call(a.g)}catch(d){N(d)}var u=G;u.j(a),u.h<100&&(u.h++,a.next=u.g,u.g=a)}Ne=!1}function I(){this.u=this.u,this.C=this.C}I.prototype.u=!1,I.prototype.dispose=function(){this.u||(this.u=!0,this.N())},I.prototype[Symbol.dispose]=function(){this.dispose()},I.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function E(a,u){this.type=a,this.g=this.target=u,this.defaultPrevented=!1}E.prototype.h=function(){this.defaultPrevented=!0};var C=(function(){if(!o.addEventListener||!Object.defineProperty)return!1;var a=!1,u=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const d=()=>{};o.addEventListener("test",d,u),o.removeEventListener("test",d,u)}catch{}return a})();function w(a){return/^[\s\xa0]*$/.test(a)}function Ge(a,u){E.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a&&this.init(a,u)}p(Ge,E),Ge.prototype.init=function(a,u){const d=this.type=a.type,g=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement,this.g=u,u=a.relatedTarget,u||(d=="mouseover"?u=a.fromElement:d=="mouseout"&&(u=a.toElement)),this.relatedTarget=u,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=a.pointerType,this.state=a.state,this.i=a,a.defaultPrevented&&Ge.Z.h.call(this)},Ge.prototype.h=function(){Ge.Z.h.call(this);const a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var wn="closure_listenable_"+(Math.random()*1e6|0),ly=0;function uy(a,u,d,g,A){this.listener=a,this.proxy=null,this.src=u,this.type=d,this.capture=!!g,this.ha=A,this.key=++ly,this.da=this.fa=!1}function Us(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function js(a,u,d){for(const g in a)u.call(d,a[g],g,a)}function hy(a,u){for(const d in a)u.call(void 0,a[d],d,a)}function Vl(a){const u={};for(const d in a)u[d]=a[d];return u}const Dl="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Nl(a,u){let d,g;for(let A=1;A<arguments.length;A++){g=arguments[A];for(d in g)a[d]=g[d];for(let S=0;S<Dl.length;S++)d=Dl[S],Object.prototype.hasOwnProperty.call(g,d)&&(a[d]=g[d])}}function Bs(a){this.src=a,this.g={},this.h=0}Bs.prototype.add=function(a,u,d,g,A){const S=a.toString();a=this.g[S],a||(a=this.g[S]=[],this.h++);const O=No(a,u,g,A);return O>-1?(u=a[O],d||(u.fa=!1)):(u=new uy(u,this.src,S,!!g,A),u.fa=d,a.push(u)),u};function Do(a,u){const d=u.type;if(d in a.g){var g=a.g[d],A=Array.prototype.indexOf.call(g,u,void 0),S;(S=A>=0)&&Array.prototype.splice.call(g,A,1),S&&(Us(u),a.g[d].length==0&&(delete a.g[d],a.h--))}}function No(a,u,d,g){for(let A=0;A<a.length;++A){const S=a[A];if(!S.da&&S.listener==u&&S.capture==!!d&&S.ha==g)return A}return-1}var Oo="closure_lm_"+(Math.random()*1e6|0),Lo={};function Ol(a,u,d,g,A){if(Array.isArray(u)){for(let S=0;S<u.length;S++)Ol(a,u[S],d,g,A);return null}return d=Fl(d),a&&a[wn]?a.J(u,d,c(g)?!!g.capture:!1,A):dy(a,u,d,!1,g,A)}function dy(a,u,d,g,A,S){if(!u)throw Error("Invalid event type");const O=c(A)?!!A.capture:!!A;let J=Fo(a);if(J||(a[Oo]=J=new Bs(a)),d=J.add(u,d,g,O,S),d.proxy)return d;if(g=fy(),d.proxy=g,g.src=a,g.listener=d,a.addEventListener)C||(A=O),A===void 0&&(A=!1),a.addEventListener(u.toString(),g,A);else if(a.attachEvent)a.attachEvent(Ml(u.toString()),g);else if(a.addListener&&a.removeListener)a.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return d}function fy(){function a(d){return u.call(a.src,a.listener,d)}const u=py;return a}function Ll(a,u,d,g,A){if(Array.isArray(u))for(var S=0;S<u.length;S++)Ll(a,u[S],d,g,A);else g=c(g)?!!g.capture:!!g,d=Fl(d),a&&a[wn]?(a=a.i,S=String(u).toString(),S in a.g&&(u=a.g[S],d=No(u,d,g,A),d>-1&&(Us(u[d]),Array.prototype.splice.call(u,d,1),u.length==0&&(delete a.g[S],a.h--)))):a&&(a=Fo(a))&&(u=a.g[u.toString()],a=-1,u&&(a=No(u,d,g,A)),(d=a>-1?u[a]:null)&&Mo(d))}function Mo(a){if(typeof a!="number"&&a&&!a.da){var u=a.src;if(u&&u[wn])Do(u.i,a);else{var d=a.type,g=a.proxy;u.removeEventListener?u.removeEventListener(d,g,a.capture):u.detachEvent?u.detachEvent(Ml(d),g):u.addListener&&u.removeListener&&u.removeListener(g),(d=Fo(u))?(Do(d,a),d.h==0&&(d.src=null,u[Oo]=null)):Us(a)}}}function Ml(a){return a in Lo?Lo[a]:Lo[a]="on"+a}function py(a,u){if(a.da)a=!0;else{u=new Ge(u,this);const d=a.listener,g=a.ha||a.src;a.fa&&Mo(a),a=d.call(g,u)}return a}function Fo(a){return a=a[Oo],a instanceof Bs?a:null}var Uo="__closure_events_fn_"+(Math.random()*1e9>>>0);function Fl(a){return typeof a=="function"?a:(a[Uo]||(a[Uo]=function(u){return a.handleEvent(u)}),a[Uo])}function Oe(){I.call(this),this.i=new Bs(this),this.M=this,this.G=null}p(Oe,I),Oe.prototype[wn]=!0,Oe.prototype.removeEventListener=function(a,u,d,g){Ll(this,a,u,d,g)};function $e(a,u){var d,g=a.G;if(g)for(d=[];g;g=g.G)d.push(g);if(a=a.M,g=u.type||u,typeof u=="string")u=new E(u,a);else if(u instanceof E)u.target=u.target||a;else{var A=u;u=new E(g,a),Nl(u,A)}A=!0;let S,O;if(d)for(O=d.length-1;O>=0;O--)S=u.g=d[O],A=Hs(S,g,!0,u)&&A;if(S=u.g=a,A=Hs(S,g,!0,u)&&A,A=Hs(S,g,!1,u)&&A,d)for(O=0;O<d.length;O++)S=u.g=d[O],A=Hs(S,g,!1,u)&&A}Oe.prototype.N=function(){if(Oe.Z.N.call(this),this.i){var a=this.i;for(const u in a.g){const d=a.g[u];for(let g=0;g<d.length;g++)Us(d[g]);delete a.g[u],a.h--}}this.G=null},Oe.prototype.J=function(a,u,d,g){return this.i.add(String(a),u,!1,d,g)},Oe.prototype.K=function(a,u,d,g){return this.i.add(String(a),u,!0,d,g)};function Hs(a,u,d,g){if(u=a.i.g[String(u)],!u)return!0;u=u.concat();let A=!0;for(let S=0;S<u.length;++S){const O=u[S];if(O&&!O.da&&O.capture==d){const J=O.listener,Ie=O.ha||O.src;O.fa&&Do(a.i,O),A=J.call(Ie,g)!==!1&&A}}return A&&!g.defaultPrevented}function gy(a,u){if(typeof a!="function")if(a&&typeof a.handleEvent=="function")a=h(a.handleEvent,a);else throw Error("Invalid listener argument");return Number(u)>2147483647?-1:o.setTimeout(a,u||0)}function Ul(a){a.g=gy(()=>{a.g=null,a.i&&(a.i=!1,Ul(a))},a.l);const u=a.h;a.h=null,a.m.apply(null,u)}class my extends I{constructor(u,d){super(),this.m=u,this.l=d,this.h=null,this.i=!1,this.g=null}j(u){this.h=arguments,this.g?this.i=!0:Ul(this)}N(){super.N(),this.g&&(o.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Sr(a){I.call(this),this.h=a,this.g={}}p(Sr,I);var jl=[];function Bl(a){js(a.g,function(u,d){this.g.hasOwnProperty(d)&&Mo(u)},a),a.g={}}Sr.prototype.N=function(){Sr.Z.N.call(this),Bl(this)},Sr.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var jo=o.JSON.stringify,yy=o.JSON.parse,_y=class{stringify(a){return o.JSON.stringify(a,void 0)}parse(a){return o.JSON.parse(a,void 0)}};function Hl(){}function ql(){}var kr={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Bo(){E.call(this,"d")}p(Bo,E);function Ho(){E.call(this,"c")}p(Ho,E);var bn={},$l=null;function qs(){return $l=$l||new Oe}bn.Ia="serverreachability";function zl(a){E.call(this,bn.Ia,a)}p(zl,E);function Pr(a){const u=qs();$e(u,new zl(u))}bn.STAT_EVENT="statevent";function Gl(a,u){E.call(this,bn.STAT_EVENT,a),this.stat=u}p(Gl,E);function ze(a){const u=qs();$e(u,new Gl(u,a))}bn.Ja="timingevent";function Wl(a,u){E.call(this,bn.Ja,a),this.size=u}p(Wl,E);function xr(a,u){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return o.setTimeout(function(){a()},u)}function Vr(){this.g=!0}Vr.prototype.ua=function(){this.g=!1};function wy(a,u,d,g,A,S){a.info(function(){if(a.g)if(S){var O="",J=S.split("&");for(let ae=0;ae<J.length;ae++){var Ie=J[ae].split("=");if(Ie.length>1){const Ce=Ie[0];Ie=Ie[1];const yt=Ce.split("_");O=yt.length>=2&&yt[1]=="type"?O+(Ce+"="+Ie+"&"):O+(Ce+"=redacted&")}}}else O=null;else O=S;return"XMLHTTP REQ ("+g+") [attempt "+A+"]: "+u+`
`+d+`
`+O})}function by(a,u,d,g,A,S,O){a.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+A+"]: "+u+`
`+d+`
`+S+" "+O})}function $n(a,u,d,g){a.info(function(){return"XMLHTTP TEXT ("+u+"): "+Ey(a,d)+(g?" "+g:"")})}function Ty(a,u){a.info(function(){return"TIMEOUT: "+u})}Vr.prototype.info=function(){};function Ey(a,u){if(!a.g)return u;if(!u)return null;try{const S=JSON.parse(u);if(S){for(a=0;a<S.length;a++)if(Array.isArray(S[a])){var d=S[a];if(!(d.length<2)){var g=d[1];if(Array.isArray(g)&&!(g.length<1)){var A=g[0];if(A!="noop"&&A!="stop"&&A!="close")for(let O=1;O<g.length;O++)g[O]=""}}}}return jo(S)}catch{return u}}var $s={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Jl={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},Kl;function qo(){}p(qo,Hl),qo.prototype.g=function(){return new XMLHttpRequest},Kl=new qo;function Dr(a){return encodeURIComponent(String(a))}function vy(a){var u=1;a=a.split(":");const d=[];for(;u>0&&a.length;)d.push(a.shift()),u--;return a.length&&d.push(a.join(":")),d}function Bt(a,u,d,g){this.j=a,this.i=u,this.l=d,this.S=g||1,this.V=new Sr(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new Ql}function Ql(){this.i=null,this.g="",this.h=!1}var Yl={},$o={};function zo(a,u,d){a.M=1,a.A=Gs(mt(u)),a.u=d,a.R=!0,Xl(a,null)}function Xl(a,u){a.F=Date.now(),zs(a),a.B=mt(a.A);var d=a.B,g=a.S;Array.isArray(g)||(g=[String(g)]),hu(d.i,"t",g),a.C=0,d=a.j.L,a.h=new Ql,a.g=ku(a.j,d?u:null,!a.u),a.P>0&&(a.O=new my(h(a.Y,a,a.g),a.P)),u=a.V,d=a.g,g=a.ba;var A="readystatechange";Array.isArray(A)||(A&&(jl[0]=A.toString()),A=jl);for(let S=0;S<A.length;S++){const O=Ol(d,A[S],g||u.handleEvent,!1,u.h||u);if(!O)break;u.g[O.key]=O}u=a.J?Vl(a.J):{},a.u?(a.v||(a.v="POST"),u["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.B,a.v,a.u,u)):(a.v="GET",a.g.ea(a.B,a.v,null,u)),Pr(),wy(a.i,a.v,a.B,a.l,a.S,a.u)}Bt.prototype.ba=function(a){a=a.target;const u=this.O;u&&$t(a)==3?u.j():this.Y(a)},Bt.prototype.Y=function(a){try{if(a==this.g)e:{const J=$t(this.g),Ie=this.g.ya(),ae=this.g.ca();if(!(J<3)&&(J!=3||this.g&&(this.h.h||this.g.la()||_u(this.g)))){this.K||J!=4||Ie==7||(Ie==8||ae<=0?Pr(3):Pr(2)),Go(this);var u=this.g.ca();this.X=u;var d=Iy(this);if(this.o=u==200,by(this.i,this.v,this.B,this.l,this.S,J,u),this.o){if(this.U&&!this.L){t:{if(this.g){var g,A=this.g;if((g=A.g?A.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!w(g)){var S=g;break t}}S=null}if(a=S)$n(this.i,this.l,a,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Wo(this,a);else{this.o=!1,this.m=3,ze(12),Tn(this),Nr(this);break e}}if(this.R){a=!0;let Ce;for(;!this.K&&this.C<d.length;)if(Ce=Ay(this,d),Ce==$o){J==4&&(this.m=4,ze(14),a=!1),$n(this.i,this.l,null,"[Incomplete Response]");break}else if(Ce==Yl){this.m=4,ze(15),$n(this.i,this.l,d,"[Invalid Chunk]"),a=!1;break}else $n(this.i,this.l,Ce,null),Wo(this,Ce);if(Zl(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),J!=4||d.length!=0||this.h.h||(this.m=1,ze(16),a=!1),this.o=this.o&&a,!a)$n(this.i,this.l,d,"[Invalid Chunked Response]"),Tn(this),Nr(this);else if(d.length>0&&!this.W){this.W=!0;var O=this.j;O.g==this&&O.aa&&!O.P&&(O.j.info("Great, no buffering proxy detected. Bytes received: "+d.length),ta(O),O.P=!0,ze(11))}}else $n(this.i,this.l,d,null),Wo(this,d);J==4&&Tn(this),this.o&&!this.K&&(J==4?Au(this.j,this):(this.o=!1,zs(this)))}else Uy(this.g),u==400&&d.indexOf("Unknown SID")>0?(this.m=3,ze(12)):(this.m=0,ze(13)),Tn(this),Nr(this)}}}catch{}finally{}};function Iy(a){if(!Zl(a))return a.g.la();const u=_u(a.g);if(u==="")return"";let d="";const g=u.length,A=$t(a.g)==4;if(!a.h.i){if(typeof TextDecoder>"u")return Tn(a),Nr(a),"";a.h.i=new o.TextDecoder}for(let S=0;S<g;S++)a.h.h=!0,d+=a.h.i.decode(u[S],{stream:!(A&&S==g-1)});return u.length=0,a.h.g+=d,a.C=0,a.h.g}function Zl(a){return a.g?a.v=="GET"&&a.M!=2&&a.j.Aa:!1}function Ay(a,u){var d=a.C,g=u.indexOf(`
`,d);return g==-1?$o:(d=Number(u.substring(d,g)),isNaN(d)?Yl:(g+=1,g+d>u.length?$o:(u=u.slice(g,g+d),a.C=g+d,u)))}Bt.prototype.cancel=function(){this.K=!0,Tn(this)};function zs(a){a.T=Date.now()+a.H,eu(a,a.H)}function eu(a,u){if(a.D!=null)throw Error("WatchDog timer not null");a.D=xr(h(a.aa,a),u)}function Go(a){a.D&&(o.clearTimeout(a.D),a.D=null)}Bt.prototype.aa=function(){this.D=null;const a=Date.now();a-this.T>=0?(Ty(this.i,this.B),this.M!=2&&(Pr(),ze(17)),Tn(this),this.m=2,Nr(this)):eu(this,this.T-a)};function Nr(a){a.j.I==0||a.K||Au(a.j,a)}function Tn(a){Go(a);var u=a.O;u&&typeof u.dispose=="function"&&u.dispose(),a.O=null,Bl(a.V),a.g&&(u=a.g,a.g=null,u.abort(),u.dispose())}function Wo(a,u){try{var d=a.j;if(d.I!=0&&(d.g==a||Jo(d.h,a))){if(!a.L&&Jo(d.h,a)&&d.I==3){try{var g=d.Ba.g.parse(u)}catch{g=null}if(Array.isArray(g)&&g.length==3){var A=g;if(A[0]==0){e:if(!d.v){if(d.g)if(d.g.F+3e3<a.F)Ys(d),Ks(d);else break e;ea(d),ze(18)}}else d.xa=A[1],0<d.xa-d.K&&A[2]<37500&&d.F&&d.A==0&&!d.C&&(d.C=xr(h(d.Va,d),6e3));ru(d.h)<=1&&d.ta&&(d.ta=void 0)}else vn(d,11)}else if((a.L||d.g==a)&&Ys(d),!w(u))for(A=d.Ba.g.parse(u),u=0;u<A.length;u++){let ae=A[u];const Ce=ae[0];if(!(Ce<=d.K))if(d.K=Ce,ae=ae[1],d.I==2)if(ae[0]=="c"){d.M=ae[1],d.ba=ae[2];const yt=ae[3];yt!=null&&(d.ka=yt,d.j.info("VER="+d.ka));const In=ae[4];In!=null&&(d.za=In,d.j.info("SVER="+d.za));const zt=ae[5];zt!=null&&typeof zt=="number"&&zt>0&&(g=1.5*zt,d.O=g,d.j.info("backChannelRequestTimeoutMs_="+g)),g=d;const Gt=a.g;if(Gt){const Zs=Gt.g?Gt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Zs){var S=g.h;S.g||Zs.indexOf("spdy")==-1&&Zs.indexOf("quic")==-1&&Zs.indexOf("h2")==-1||(S.j=S.l,S.g=new Set,S.h&&(Ko(S,S.h),S.h=null))}if(g.G){const na=Gt.g?Gt.g.getResponseHeader("X-HTTP-Session-Id"):null;na&&(g.wa=na,le(g.J,g.G,na))}}d.I=3,d.l&&d.l.ra(),d.aa&&(d.T=Date.now()-a.F,d.j.info("Handshake RTT: "+d.T+"ms")),g=d;var O=a;if(g.na=Su(g,g.L?g.ba:null,g.W),O.L){su(g.h,O);var J=O,Ie=g.O;Ie&&(J.H=Ie),J.D&&(Go(J),zs(J)),g.g=O}else vu(g);d.i.length>0&&Qs(d)}else ae[0]!="stop"&&ae[0]!="close"||vn(d,7);else d.I==3&&(ae[0]=="stop"||ae[0]=="close"?ae[0]=="stop"?vn(d,7):Zo(d):ae[0]!="noop"&&d.l&&d.l.qa(ae),d.A=0)}}Pr(4)}catch{}}var Cy=class{constructor(a,u){this.g=a,this.map=u}};function tu(a){this.l=a||10,o.PerformanceNavigationTiming?(a=o.performance.getEntriesByType("navigation"),a=a.length>0&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(o.chrome&&o.chrome.loadTimes&&o.chrome.loadTimes()&&o.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function nu(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function ru(a){return a.h?1:a.g?a.g.size:0}function Jo(a,u){return a.h?a.h==u:a.g?a.g.has(u):!1}function Ko(a,u){a.g?a.g.add(u):a.h=u}function su(a,u){a.h&&a.h==u?a.h=null:a.g&&a.g.has(u)&&a.g.delete(u)}tu.prototype.cancel=function(){if(this.i=iu(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function iu(a){if(a.h!=null)return a.i.concat(a.h.G);if(a.g!=null&&a.g.size!==0){let u=a.i;for(const d of a.g.values())u=u.concat(d.G);return u}return y(a.i)}var ou=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Ry(a,u){if(a){a=a.split("&");for(let d=0;d<a.length;d++){const g=a[d].indexOf("=");let A,S=null;g>=0?(A=a[d].substring(0,g),S=a[d].substring(g+1)):A=a[d],u(A,S?decodeURIComponent(S.replace(/\+/g," ")):"")}}}function Ht(a){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let u;a instanceof Ht?(this.l=a.l,Or(this,a.j),this.o=a.o,this.g=a.g,Lr(this,a.u),this.h=a.h,Qo(this,du(a.i)),this.m=a.m):a&&(u=String(a).match(ou))?(this.l=!1,Or(this,u[1]||"",!0),this.o=Mr(u[2]||""),this.g=Mr(u[3]||"",!0),Lr(this,u[4]),this.h=Mr(u[5]||"",!0),Qo(this,u[6]||"",!0),this.m=Mr(u[7]||"")):(this.l=!1,this.i=new Ur(null,this.l))}Ht.prototype.toString=function(){const a=[];var u=this.j;u&&a.push(Fr(u,au,!0),":");var d=this.g;return(d||u=="file")&&(a.push("//"),(u=this.o)&&a.push(Fr(u,au,!0),"@"),a.push(Dr(d).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.u,d!=null&&a.push(":",String(d))),(d=this.h)&&(this.g&&d.charAt(0)!="/"&&a.push("/"),a.push(Fr(d,d.charAt(0)=="/"?Py:ky,!0))),(d=this.i.toString())&&a.push("?",d),(d=this.m)&&a.push("#",Fr(d,Vy)),a.join("")},Ht.prototype.resolve=function(a){const u=mt(this);let d=!!a.j;d?Or(u,a.j):d=!!a.o,d?u.o=a.o:d=!!a.g,d?u.g=a.g:d=a.u!=null;var g=a.h;if(d)Lr(u,a.u);else if(d=!!a.h){if(g.charAt(0)!="/")if(this.g&&!this.h)g="/"+g;else{var A=u.h.lastIndexOf("/");A!=-1&&(g=u.h.slice(0,A+1)+g)}if(A=g,A==".."||A==".")g="";else if(A.indexOf("./")!=-1||A.indexOf("/.")!=-1){g=A.lastIndexOf("/",0)==0,A=A.split("/");const S=[];for(let O=0;O<A.length;){const J=A[O++];J=="."?g&&O==A.length&&S.push(""):J==".."?((S.length>1||S.length==1&&S[0]!="")&&S.pop(),g&&O==A.length&&S.push("")):(S.push(J),g=!0)}g=S.join("/")}else g=A}return d?u.h=g:d=a.i.toString()!=="",d?Qo(u,du(a.i)):d=!!a.m,d&&(u.m=a.m),u};function mt(a){return new Ht(a)}function Or(a,u,d){a.j=d?Mr(u,!0):u,a.j&&(a.j=a.j.replace(/:$/,""))}function Lr(a,u){if(u){if(u=Number(u),isNaN(u)||u<0)throw Error("Bad port number "+u);a.u=u}else a.u=null}function Qo(a,u,d){u instanceof Ur?(a.i=u,Dy(a.i,a.l)):(d||(u=Fr(u,xy)),a.i=new Ur(u,a.l))}function le(a,u,d){a.i.set(u,d)}function Gs(a){return le(a,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),a}function Mr(a,u){return a?u?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function Fr(a,u,d){return typeof a=="string"?(a=encodeURI(a).replace(u,Sy),d&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function Sy(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var au=/[#\/\?@]/g,ky=/[#\?:]/g,Py=/[#\?]/g,xy=/[#\?@]/g,Vy=/#/g;function Ur(a,u){this.h=this.g=null,this.i=a||null,this.j=!!u}function En(a){a.g||(a.g=new Map,a.h=0,a.i&&Ry(a.i,function(u,d){a.add(decodeURIComponent(u.replace(/\+/g," ")),d)}))}n=Ur.prototype,n.add=function(a,u){En(this),this.i=null,a=zn(this,a);let d=this.g.get(a);return d||this.g.set(a,d=[]),d.push(u),this.h+=1,this};function cu(a,u){En(a),u=zn(a,u),a.g.has(u)&&(a.i=null,a.h-=a.g.get(u).length,a.g.delete(u))}function lu(a,u){return En(a),u=zn(a,u),a.g.has(u)}n.forEach=function(a,u){En(this),this.g.forEach(function(d,g){d.forEach(function(A){a.call(u,A,g,this)},this)},this)};function uu(a,u){En(a);let d=[];if(typeof u=="string")lu(a,u)&&(d=d.concat(a.g.get(zn(a,u))));else for(a=Array.from(a.g.values()),u=0;u<a.length;u++)d=d.concat(a[u]);return d}n.set=function(a,u){return En(this),this.i=null,a=zn(this,a),lu(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[u]),this.h+=1,this},n.get=function(a,u){return a?(a=uu(this,a),a.length>0?String(a[0]):u):u};function hu(a,u,d){cu(a,u),d.length>0&&(a.i=null,a.g.set(zn(a,u),y(d)),a.h+=d.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],u=Array.from(this.g.keys());for(let g=0;g<u.length;g++){var d=u[g];const A=Dr(d);d=uu(this,d);for(let S=0;S<d.length;S++){let O=A;d[S]!==""&&(O+="="+Dr(d[S])),a.push(O)}}return this.i=a.join("&")};function du(a){const u=new Ur;return u.i=a.i,a.g&&(u.g=new Map(a.g),u.h=a.h),u}function zn(a,u){return u=String(u),a.j&&(u=u.toLowerCase()),u}function Dy(a,u){u&&!a.j&&(En(a),a.i=null,a.g.forEach(function(d,g){const A=g.toLowerCase();g!=A&&(cu(this,g),hu(this,A,d))},a)),a.j=u}function Ny(a,u){const d=new Vr;if(o.Image){const g=new Image;g.onload=f(qt,d,"TestLoadImage: loaded",!0,u,g),g.onerror=f(qt,d,"TestLoadImage: error",!1,u,g),g.onabort=f(qt,d,"TestLoadImage: abort",!1,u,g),g.ontimeout=f(qt,d,"TestLoadImage: timeout",!1,u,g),o.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=a}else u(!1)}function Oy(a,u){const d=new Vr,g=new AbortController,A=setTimeout(()=>{g.abort(),qt(d,"TestPingServer: timeout",!1,u)},1e4);fetch(a,{signal:g.signal}).then(S=>{clearTimeout(A),S.ok?qt(d,"TestPingServer: ok",!0,u):qt(d,"TestPingServer: server error",!1,u)}).catch(()=>{clearTimeout(A),qt(d,"TestPingServer: error",!1,u)})}function qt(a,u,d,g,A){try{A&&(A.onload=null,A.onerror=null,A.onabort=null,A.ontimeout=null),g(d)}catch{}}function Ly(){this.g=new _y}function Yo(a){this.i=a.Sb||null,this.h=a.ab||!1}p(Yo,Hl),Yo.prototype.g=function(){return new Ws(this.i,this.h)};function Ws(a,u){Oe.call(this),this.H=a,this.o=u,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}p(Ws,Oe),n=Ws.prototype,n.open=function(a,u){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=a,this.D=u,this.readyState=1,Br(this)},n.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const u={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};a&&(u.body=a),(this.H||o).fetch(new Request(this.D,u)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,jr(this)),this.readyState=0},n.Pa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,Br(this)),this.g&&(this.readyState=3,Br(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof o.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;fu(this)}else a.text().then(this.Oa.bind(this),this.ga.bind(this))};function fu(a){a.j.read().then(a.Ma.bind(a)).catch(a.ga.bind(a))}n.Ma=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var u=a.value?a.value:new Uint8Array(0);(u=this.B.decode(u,{stream:!a.done}))&&(this.response=this.responseText+=u)}a.done?jr(this):Br(this),this.readyState==3&&fu(this)}},n.Oa=function(a){this.g&&(this.response=this.responseText=a,jr(this))},n.Na=function(a){this.g&&(this.response=a,jr(this))},n.ga=function(){this.g&&jr(this)};function jr(a){a.readyState=4,a.l=null,a.j=null,a.B=null,Br(a)}n.setRequestHeader=function(a,u){this.A.append(a,u)},n.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],u=this.h.entries();for(var d=u.next();!d.done;)d=d.value,a.push(d[0]+": "+d[1]),d=u.next();return a.join(`\r
`)};function Br(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(Ws.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function pu(a){let u="";return js(a,function(d,g){u+=g,u+=":",u+=d,u+=`\r
`}),u}function Xo(a,u,d){e:{for(g in d){var g=!1;break e}g=!0}g||(d=pu(d),typeof a=="string"?d!=null&&Dr(d):le(a,u,d))}function pe(a){Oe.call(this),this.headers=new Map,this.L=a||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}p(pe,Oe);var My=/^https?$/i,Fy=["POST","PUT"];n=pe.prototype,n.Fa=function(a){this.H=a},n.ea=function(a,u,d,g){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);u=u?u.toUpperCase():"GET",this.D=a,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():Kl.g(),this.g.onreadystatechange=m(h(this.Ca,this));try{this.B=!0,this.g.open(u,String(a),!0),this.B=!1}catch(S){gu(this,S);return}if(a=d||"",d=new Map(this.headers),g)if(Object.getPrototypeOf(g)===Object.prototype)for(var A in g)d.set(A,g[A]);else if(typeof g.keys=="function"&&typeof g.get=="function")for(const S of g.keys())d.set(S,g.get(S));else throw Error("Unknown input type for opt_headers: "+String(g));g=Array.from(d.keys()).find(S=>S.toLowerCase()=="content-type"),A=o.FormData&&a instanceof o.FormData,!(Array.prototype.indexOf.call(Fy,u,void 0)>=0)||g||A||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[S,O]of d)this.g.setRequestHeader(S,O);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(a),this.v=!1}catch(S){gu(this,S)}};function gu(a,u){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=u,a.o=5,mu(a),Js(a)}function mu(a){a.A||(a.A=!0,$e(a,"complete"),$e(a,"error"))}n.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=a||7,$e(this,"complete"),$e(this,"abort"),Js(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Js(this,!0)),pe.Z.N.call(this)},n.Ca=function(){this.u||(this.B||this.v||this.j?yu(this):this.Xa())},n.Xa=function(){yu(this)};function yu(a){if(a.h&&typeof i<"u"){if(a.v&&$t(a)==4)setTimeout(a.Ca.bind(a),0);else if($e(a,"readystatechange"),$t(a)==4){a.h=!1;try{const S=a.ca();e:switch(S){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var u=!0;break e;default:u=!1}var d;if(!(d=u)){var g;if(g=S===0){let O=String(a.D).match(ou)[1]||null;!O&&o.self&&o.self.location&&(O=o.self.location.protocol.slice(0,-1)),g=!My.test(O?O.toLowerCase():"")}d=g}if(d)$e(a,"complete"),$e(a,"success");else{a.o=6;try{var A=$t(a)>2?a.g.statusText:""}catch{A=""}a.l=A+" ["+a.ca()+"]",mu(a)}}finally{Js(a)}}}}function Js(a,u){if(a.g){a.m&&(clearTimeout(a.m),a.m=null);const d=a.g;a.g=null,u||$e(a,"ready");try{d.onreadystatechange=null}catch{}}}n.isActive=function(){return!!this.g};function $t(a){return a.g?a.g.readyState:0}n.ca=function(){try{return $t(this)>2?this.g.status:-1}catch{return-1}},n.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.La=function(a){if(this.g){var u=this.g.responseText;return a&&u.indexOf(a)==0&&(u=u.substring(a.length)),yy(u)}};function _u(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.F){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function Uy(a){const u={};a=(a.g&&$t(a)>=2&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let g=0;g<a.length;g++){if(w(a[g]))continue;var d=vy(a[g]);const A=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const S=u[A]||[];u[A]=S,S.push(d)}hy(u,function(g){return g.join(", ")})}n.ya=function(){return this.o},n.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Hr(a,u,d){return d&&d.internalChannelParams&&d.internalChannelParams[a]||u}function wu(a){this.za=0,this.i=[],this.j=new Vr,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Hr("failFast",!1,a),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Hr("baseRetryDelayMs",5e3,a),this.Za=Hr("retryDelaySeedMs",1e4,a),this.Ta=Hr("forwardChannelMaxRetries",2,a),this.va=Hr("forwardChannelRequestTimeoutMs",2e4,a),this.ma=a&&a.xmlHttpFactory||void 0,this.Ua=a&&a.Rb||void 0,this.Aa=a&&a.useFetchStreams||!1,this.O=void 0,this.L=a&&a.supportsCrossDomainXhr||!1,this.M="",this.h=new tu(a&&a.concurrentRequestLimit),this.Ba=new Ly,this.S=a&&a.fastHandshake||!1,this.R=a&&a.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=a&&a.Pb||!1,a&&a.ua&&this.j.ua(),a&&a.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&a&&a.detectBufferingProxy||!1,this.ia=void 0,a&&a.longPollingTimeout&&a.longPollingTimeout>0&&(this.ia=a.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}n=wu.prototype,n.ka=8,n.I=1,n.connect=function(a,u,d,g){ze(0),this.W=a,this.H=u||{},d&&g!==void 0&&(this.H.OSID=d,this.H.OAID=g),this.F=this.X,this.J=Su(this,null,this.W),Qs(this)};function Zo(a){if(bu(a),a.I==3){var u=a.V++,d=mt(a.J);if(le(d,"SID",a.M),le(d,"RID",u),le(d,"TYPE","terminate"),qr(a,d),u=new Bt(a,a.j,u),u.M=2,u.A=Gs(mt(d)),d=!1,o.navigator&&o.navigator.sendBeacon)try{d=o.navigator.sendBeacon(u.A.toString(),"")}catch{}!d&&o.Image&&(new Image().src=u.A,d=!0),d||(u.g=ku(u.j,null),u.g.ea(u.A)),u.F=Date.now(),zs(u)}Ru(a)}function Ks(a){a.g&&(ta(a),a.g.cancel(),a.g=null)}function bu(a){Ks(a),a.v&&(o.clearTimeout(a.v),a.v=null),Ys(a),a.h.cancel(),a.m&&(typeof a.m=="number"&&o.clearTimeout(a.m),a.m=null)}function Qs(a){if(!nu(a.h)&&!a.m){a.m=!0;var u=a.Ea;Je||_(),Ne||(Je(),Ne=!0),v.add(u,a),a.D=0}}function jy(a,u){return ru(a.h)>=a.h.j-(a.m?1:0)?!1:a.m?(a.i=u.G.concat(a.i),!0):a.I==1||a.I==2||a.D>=(a.Sa?0:a.Ta)?!1:(a.m=xr(h(a.Ea,a,u),Cu(a,a.D)),a.D++,!0)}n.Ea=function(a){if(this.m)if(this.m=null,this.I==1){if(!a){this.V=Math.floor(Math.random()*1e5),a=this.V++;const A=new Bt(this,this.j,a);let S=this.o;if(this.U&&(S?(S=Vl(S),Nl(S,this.U)):S=this.U),this.u!==null||this.R||(A.J=S,S=null),this.S)e:{for(var u=0,d=0;d<this.i.length;d++){t:{var g=this.i[d];if("__data__"in g.map&&(g=g.map.__data__,typeof g=="string")){g=g.length;break t}g=void 0}if(g===void 0)break;if(u+=g,u>4096){u=d;break e}if(u===4096||d===this.i.length-1){u=d+1;break e}}u=1e3}else u=1e3;u=Eu(this,A,u),d=mt(this.J),le(d,"RID",a),le(d,"CVER",22),this.G&&le(d,"X-HTTP-Session-Id",this.G),qr(this,d),S&&(this.R?u="headers="+Dr(pu(S))+"&"+u:this.u&&Xo(d,this.u,S)),Ko(this.h,A),this.Ra&&le(d,"TYPE","init"),this.S?(le(d,"$req",u),le(d,"SID","null"),A.U=!0,zo(A,d,null)):zo(A,d,u),this.I=2}}else this.I==3&&(a?Tu(this,a):this.i.length==0||nu(this.h)||Tu(this))};function Tu(a,u){var d;u?d=u.l:d=a.V++;const g=mt(a.J);le(g,"SID",a.M),le(g,"RID",d),le(g,"AID",a.K),qr(a,g),a.u&&a.o&&Xo(g,a.u,a.o),d=new Bt(a,a.j,d,a.D+1),a.u===null&&(d.J=a.o),u&&(a.i=u.G.concat(a.i)),u=Eu(a,d,1e3),d.H=Math.round(a.va*.5)+Math.round(a.va*.5*Math.random()),Ko(a.h,d),zo(d,g,u)}function qr(a,u){a.H&&js(a.H,function(d,g){le(u,g,d)}),a.l&&js({},function(d,g){le(u,g,d)})}function Eu(a,u,d){d=Math.min(a.i.length,d);const g=a.l?h(a.l.Ka,a.l,a):null;e:{var A=a.i;let J=-1;for(;;){const Ie=["count="+d];J==-1?d>0?(J=A[0].g,Ie.push("ofs="+J)):J=0:Ie.push("ofs="+J);let ae=!0;for(let Ce=0;Ce<d;Ce++){var S=A[Ce].g;const yt=A[Ce].map;if(S-=J,S<0)J=Math.max(0,A[Ce].g-100),ae=!1;else try{S="req"+S+"_"||"";try{var O=yt instanceof Map?yt:Object.entries(yt);for(const[In,zt]of O){let Gt=zt;c(zt)&&(Gt=jo(zt)),Ie.push(S+In+"="+encodeURIComponent(Gt))}}catch(In){throw Ie.push(S+"type="+encodeURIComponent("_badmap")),In}}catch{g&&g(yt)}}if(ae){O=Ie.join("&");break e}}O=void 0}return a=a.i.splice(0,d),u.G=a,O}function vu(a){if(!a.g&&!a.v){a.Y=1;var u=a.Da;Je||_(),Ne||(Je(),Ne=!0),v.add(u,a),a.A=0}}function ea(a){return a.g||a.v||a.A>=3?!1:(a.Y++,a.v=xr(h(a.Da,a),Cu(a,a.A)),a.A++,!0)}n.Da=function(){if(this.v=null,Iu(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var a=4*this.T;this.j.info("BP detection timer enabled: "+a),this.B=xr(h(this.Wa,this),a)}},n.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,ze(10),Ks(this),Iu(this))};function ta(a){a.B!=null&&(o.clearTimeout(a.B),a.B=null)}function Iu(a){a.g=new Bt(a,a.j,"rpc",a.Y),a.u===null&&(a.g.J=a.o),a.g.P=0;var u=mt(a.na);le(u,"RID","rpc"),le(u,"SID",a.M),le(u,"AID",a.K),le(u,"CI",a.F?"0":"1"),!a.F&&a.ia&&le(u,"TO",a.ia),le(u,"TYPE","xmlhttp"),qr(a,u),a.u&&a.o&&Xo(u,a.u,a.o),a.O&&(a.g.H=a.O);var d=a.g;a=a.ba,d.M=1,d.A=Gs(mt(u)),d.u=null,d.R=!0,Xl(d,a)}n.Va=function(){this.C!=null&&(this.C=null,Ks(this),ea(this),ze(19))};function Ys(a){a.C!=null&&(o.clearTimeout(a.C),a.C=null)}function Au(a,u){var d=null;if(a.g==u){Ys(a),ta(a),a.g=null;var g=2}else if(Jo(a.h,u))d=u.G,su(a.h,u),g=1;else return;if(a.I!=0){if(u.o)if(g==1){d=u.u?u.u.length:0,u=Date.now()-u.F;var A=a.D;g=qs(),$e(g,new Wl(g,d)),Qs(a)}else vu(a);else if(A=u.m,A==3||A==0&&u.X>0||!(g==1&&jy(a,u)||g==2&&ea(a)))switch(d&&d.length>0&&(u=a.h,u.i=u.i.concat(d)),A){case 1:vn(a,5);break;case 4:vn(a,10);break;case 3:vn(a,6);break;default:vn(a,2)}}}function Cu(a,u){let d=a.Qa+Math.floor(Math.random()*a.Za);return a.isActive()||(d*=2),d*u}function vn(a,u){if(a.j.info("Error code "+u),u==2){var d=h(a.bb,a),g=a.Ua;const A=!g;g=new Ht(g||"//www.google.com/images/cleardot.gif"),o.location&&o.location.protocol=="http"||Or(g,"https"),Gs(g),A?Ny(g.toString(),d):Oy(g.toString(),d)}else ze(2);a.I=0,a.l&&a.l.pa(u),Ru(a),bu(a)}n.bb=function(a){a?(this.j.info("Successfully pinged google.com"),ze(2)):(this.j.info("Failed to ping google.com"),ze(1))};function Ru(a){if(a.I=0,a.ja=[],a.l){const u=iu(a.h);(u.length!=0||a.i.length!=0)&&(R(a.ja,u),R(a.ja,a.i),a.h.i.length=0,y(a.i),a.i.length=0),a.l.oa()}}function Su(a,u,d){var g=d instanceof Ht?mt(d):new Ht(d);if(g.g!="")u&&(g.g=u+"."+g.g),Lr(g,g.u);else{var A=o.location;g=A.protocol,u=u?u+"."+A.hostname:A.hostname,A=+A.port;const S=new Ht(null);g&&Or(S,g),u&&(S.g=u),A&&Lr(S,A),d&&(S.h=d),g=S}return d=a.G,u=a.wa,d&&u&&le(g,d,u),le(g,"VER",a.ka),qr(a,g),g}function ku(a,u,d){if(u&&!a.L)throw Error("Can't create secondary domain capable XhrIo object.");return u=a.Aa&&!a.ma?new pe(new Yo({ab:d})):new pe(a.ma),u.Fa(a.L),u}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Pu(){}n=Pu.prototype,n.ra=function(){},n.qa=function(){},n.pa=function(){},n.oa=function(){},n.isActive=function(){return!0},n.Ka=function(){};function Xs(){}Xs.prototype.g=function(a,u){return new Ke(a,u)};function Ke(a,u){Oe.call(this),this.g=new wu(u),this.l=a,this.h=u&&u.messageUrlParams||null,a=u&&u.messageHeaders||null,u&&u.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=u&&u.initMessageHeaders||null,u&&u.messageContentType&&(a?a["X-WebChannel-Content-Type"]=u.messageContentType:a={"X-WebChannel-Content-Type":u.messageContentType}),u&&u.sa&&(a?a["X-WebChannel-Client-Profile"]=u.sa:a={"X-WebChannel-Client-Profile":u.sa}),this.g.U=a,(a=u&&u.Qb)&&!w(a)&&(this.g.u=a),this.A=u&&u.supportsCrossDomainXhr||!1,this.v=u&&u.sendRawJson||!1,(u=u&&u.httpSessionIdParam)&&!w(u)&&(this.g.G=u,a=this.h,a!==null&&u in a&&(a=this.h,u in a&&delete a[u])),this.j=new Gn(this)}p(Ke,Oe),Ke.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},Ke.prototype.close=function(){Zo(this.g)},Ke.prototype.o=function(a){var u=this.g;if(typeof a=="string"){var d={};d.__data__=a,a=d}else this.v&&(d={},d.__data__=jo(a),a=d);u.i.push(new Cy(u.Ya++,a)),u.I==3&&Qs(u)},Ke.prototype.N=function(){this.g.l=null,delete this.j,Zo(this.g),delete this.g,Ke.Z.N.call(this)};function xu(a){Bo.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var u=a.__sm__;if(u){e:{for(const d in u){a=d;break e}a=void 0}(this.i=a)&&(a=this.i,u=u!==null&&a in u?u[a]:void 0),this.data=u}else this.data=a}p(xu,Bo);function Vu(){Ho.call(this),this.status=1}p(Vu,Ho);function Gn(a){this.g=a}p(Gn,Pu),Gn.prototype.ra=function(){$e(this.g,"a")},Gn.prototype.qa=function(a){$e(this.g,new xu(a))},Gn.prototype.pa=function(a){$e(this.g,new Vu)},Gn.prototype.oa=function(){$e(this.g,"b")},Xs.prototype.createWebChannel=Xs.prototype.g,Ke.prototype.send=Ke.prototype.o,Ke.prototype.open=Ke.prototype.m,Ke.prototype.close=Ke.prototype.close,sg=function(){return new Xs},rg=function(){return qs()},ng=bn,Ha={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},$s.NO_ERROR=0,$s.TIMEOUT=8,$s.HTTP_ERROR=6,pi=$s,Jl.COMPLETE="complete",tg=Jl,ql.EventType=kr,kr.OPEN="a",kr.CLOSE="b",kr.ERROR="c",kr.MESSAGE="d",Oe.prototype.listen=Oe.prototype.J,Wr=ql,pe.prototype.listenOnce=pe.prototype.K,pe.prototype.getLastError=pe.prototype.Ha,pe.prototype.getLastErrorCode=pe.prototype.ya,pe.prototype.getStatus=pe.prototype.ca,pe.prototype.getResponseJson=pe.prototype.La,pe.prototype.getResponseText=pe.prototype.la,pe.prototype.send=pe.prototype.ea,pe.prototype.setWithCredentials=pe.prototype.Fa,eg=pe}).apply(typeof ni<"u"?ni:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let vr="12.8.0";function cI(n){vr=n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nn=new Cc("@firebase/firestore");function Yn(){return Nn.logLevel}function M(n,...e){if(Nn.logLevel<=Q.DEBUG){const t=e.map(jc);Nn.debug(`Firestore (${vr}): ${n}`,...t)}}function Mt(n,...e){if(Nn.logLevel<=Q.ERROR){const t=e.map(jc);Nn.error(`Firestore (${vr}): ${n}`,...t)}}function ur(n,...e){if(Nn.logLevel<=Q.WARN){const t=e.map(jc);Nn.warn(`Firestore (${vr}): ${n}`,...t)}}function jc(n){if(typeof n=="string")return n;try{return(function(t){return JSON.stringify(t)})(n)}catch{return n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,ig(n,r,t)}function ig(n,e,t){let r=`FIRESTORE (${vr}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw Mt(r),new Error(r)}function re(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||ig(e,s,r)}function z(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ir(n){if(n.code!==k.FAILED_PRECONDITION||n.message!==vI)throw n;M("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hc=-1;function fo(n){return n==null}function Ni(n){return n===0&&1/n==-1/0}function CI(n){return typeof n=="number"&&Number.isInteger(n)&&!Ni(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lg="";function RI(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=Ph(e)),e=SI(n.get(t),e);return Ph(e)}function SI(n,e){let t=e;const r=n.length;for(let s=0;s<r;s++){const i=n.charAt(s);switch(i){case"\0":t+="";break;case lg:t+="";break;default:t+=i}}return t}function Ph(n){return n+lg+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xh(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function Un(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function ug(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $I{constructor(e,t=null,r=[],s=[],i=null,o=null,c=null){this.path=e,this.collectionGroup=t,this.orderBy=r,this.filters=s,this.limit=i,this.startAt=o,this.endAt=c,this.Te=null}}function jh(n,e=null,t=[],r=[],s=null,i=null,o=null){return new $I(n,e,t,r,s,i,o)}function zc(n){const e=z(n);if(e.Te===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map((r=>Ga(r))).join(","),t+="|ob:",t+=e.orderBy.map((r=>(function(i){return i.field.canonicalString()+i.dir})(r))).join(","),fo(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map((r=>fr(r))).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map((r=>fr(r))).join(",")),e.Te=t}return e.Te}function Gc(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!OI(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!Eg(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!Uh(n.startAt,e.startAt)&&Uh(n.endAt,e.endAt)}function Wa(n){return j.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const QI=new fe(j.comparator);function Ft(){return QI}const Sg=new fe(j.comparator);function Jr(...n){let e=Sg;for(const t of n)e=e.insert(t.key,t);return e}function kg(n){let e=Sg;return n.forEach(((t,r)=>e=e.insert(t,r.overlayedDocument))),e}function Rn(){return rs()}function Pg(){return rs()}function rs(){return new jn((n=>n.toString()),((n,e)=>n.isEqual(e)))}const YI=new fe(j.comparator),XI=new Ae(j.comparator);function X(...n){let e=XI;for(const t of n)e=e.add(t);return e}const ZI=new Ae(Y);function eA(){return ZI}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wc(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ni(e)?"-0":e}}function xg(n){return{integerValue:""+n}}function tA(n,e){return CI(e)?xg(e):Wc(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _o{constructor(){this._=void 0}}function nA(n,e,t){return n instanceof gs?(function(s,i){const o={fields:{[fg]:{stringValue:dg},[gg]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&qc(i)&&(i=po(i)),i&&(o.fields[pg]=i),{mapValue:o}})(t,e):n instanceof ms?Dg(n,e):n instanceof ys?Ng(n,e):(function(s,i){const o=Vg(s,i),c=Hh(o)+Hh(s.Ae);return za(o)&&za(s.Ae)?xg(c):Wc(s.serializer,c)})(n,e)}function rA(n,e,t){return n instanceof ms?Dg(n,e):n instanceof ys?Ng(n,e):t}function Vg(n,e){return n instanceof Ui?(function(r){return za(r)||(function(i){return!!i&&"doubleValue"in i})(r)})(e)?e:{integerValue:0}:null}class gs extends _o{}class ms extends _o{constructor(e){super(),this.elements=e}}function Dg(n,e){const t=Og(e);for(const r of n.elements)t.some((s=>It(s,r)))||t.push(r);return{arrayValue:{values:t}}}class ys extends _o{constructor(e){super(),this.elements=e}}function Ng(n,e){let t=Og(e);for(const r of n.elements)t=t.filter((s=>!It(s,r)));return{arrayValue:{values:t}}}class Ui extends _o{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function Hh(n){return ye(n.integerValue||n.doubleValue)}function Og(n){return $c(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xh="LruGarbageCollector",FA=1048576;function Zh([n,e],[t,r]){const s=Y(n,t);return s===0?Y(e,r):s}class UA{constructor(e){this.Pr=e,this.buffer=new Ae(Zh),this.Tr=0}Ir(){return++this.Tr}Er(e){const t=[e,this.Ir()];if(this.buffer.size<this.Pr)this.buffer=this.buffer.add(t);else{const r=this.buffer.last();Zh(t,r)<0&&(this.buffer=this.buffer.delete(r).add(t))}}get maxValue(){return this.buffer.last()[0]}}class jA{constructor(e,t,r){this.garbageCollector=e,this.asyncQueue=t,this.localStore=r,this.Rr=null}start(){this.garbageCollector.params.cacheSizeCollectionThreshold!==-1&&this.Ar(6e4)}stop(){this.Rr&&(this.Rr.cancel(),this.Rr=null)}get started(){return this.Rr!==null}Ar(e){M(Xh,`Garbage collection scheduled in ${e}ms`),this.Rr=this.asyncQueue.enqueueAfterDelay("lru_garbage_collection",e,(async()=>{this.Rr=null;try{await this.localStore.collectGarbage(this.garbageCollector)}catch(t){Ar(t)?M(Xh,"Ignoring IndexedDB error during garbage collection: ",t):await Ir(t)}await this.Ar(3e5)}))}}class BA{constructor(e,t){this.Vr=e,this.params=t}calculateTargetCount(e,t){return this.Vr.dr(e).next((r=>Math.floor(t/100*r)))}nthSequenceNumber(e,t){if(t===0)return P.resolve(ho.ce);const r=new UA(t);return this.Vr.forEachTarget(e,(s=>r.Er(s.sequenceNumber))).next((()=>this.Vr.mr(e,(s=>r.Er(s))))).next((()=>r.maxValue))}removeTargets(e,t,r){return this.Vr.removeTargets(e,t,r)}removeOrphanedDocuments(e,t){return this.Vr.removeOrphanedDocuments(e,t)}collect(e,t){return this.params.cacheSizeCollectionThreshold===-1?(M("LruGarbageCollector","Garbage collection skipped; disabled"),P.resolve(Yh)):this.getCacheSize(e).next((r=>r<this.params.cacheSizeCollectionThreshold?(M("LruGarbageCollector",`Garbage collection skipped; Cache size ${r} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`),Yh):this.gr(e,t)))}getCacheSize(e){return this.Vr.getCacheSize(e)}gr(e,t){let r,s,i,o,c,l,h;const f=Date.now();return this.calculateTargetCount(e,this.params.percentileToCollect).next((p=>(p>this.params.maximumSequenceNumbersToCollect?(M("LruGarbageCollector",`Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${p}`),s=this.params.maximumSequenceNumbersToCollect):s=p,o=Date.now(),this.nthSequenceNumber(e,s)))).next((p=>(r=p,c=Date.now(),this.removeTargets(e,r,t)))).next((p=>(i=p,l=Date.now(),this.removeOrphanedDocuments(e,r)))).next((p=>(h=Date.now(),Yn()<=Q.DEBUG&&M("LruGarbageCollector",`LRU Garbage Collection
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xc{constructor(){this.kr=new Ae(Re.Kr),this.qr=new Ae(Re.Ur)}isEmpty(){return this.kr.isEmpty()}addReference(e,t){const r=new Re(e,t);this.kr=this.kr.add(r),this.qr=this.qr.add(r)}$r(e,t){e.forEach((r=>this.addReference(r,t)))}removeReference(e,t){this.Wr(new Re(e,t))}Qr(e,t){e.forEach((r=>this.removeReference(r,t)))}Gr(e){const t=new j(new ce([])),r=new Re(t,e),s=new Re(t,e+1),i=[];return this.qr.forEachInRange([r,s],(o=>{this.Wr(o),i.push(o.key)})),i}zr(){this.kr.forEach((e=>this.Wr(e)))}Wr(e){this.kr=this.kr.delete(e),this.qr=this.qr.delete(e)}jr(e){const t=new j(new ce([])),r=new Re(t,e),s=new Re(t,e+1);let i=X();return this.qr.forEachInRange([r,s],(o=>{i=i.add(o.key)})),i}containsKey(e){const t=new Re(e,0),r=this.kr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class Re{constructor(e,t){this.key=e,this.Hr=t}static Kr(e,t){return j.comparator(e.key,t.key)||Y(e.Hr,t.Hr)}static Ur(e,t){return Y(e.Hr,t.Hr)||j.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class KA{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.Yn=1,this.Jr=new Ae(Re.Kr)}checkEmpty(e){return P.resolve(this.mutationQueue.length===0)}addMutationBatch(e,t,r,s){const i=this.Yn;this.Yn++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new uA(i,t,r,s);this.mutationQueue.push(o);for(const c of s)this.Jr=this.Jr.add(new Re(c.key,i)),this.indexManager.addToCollectionParentIndex(e,c.key.path.popLast());return P.resolve(o)}lookupMutationBatch(e,t){return P.resolve(this.Zr(t))}getNextMutationBatchAfterBatchId(e,t){const r=t+1,s=this.Xr(r),i=s<0?0:s;return P.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return P.resolve(this.mutationQueue.length===0?Hc:this.Yn-1)}getAllMutationBatches(e){return P.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const r=new Re(t,0),s=new Re(t,Number.POSITIVE_INFINITY),i=[];return this.Jr.forEachInRange([r,s],(o=>{const c=this.Zr(o.Hr);i.push(c)})),P.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let r=new Ae(Y);return t.forEach((s=>{const i=new Re(s,0),o=new Re(s,Number.POSITIVE_INFINITY);this.Jr.forEachInRange([i,o],(c=>{r=r.add(c.Hr)}))})),P.resolve(this.Yr(r))}getAllMutationBatchesAffectingQuery(e,t){const r=t.path,s=r.length+1;let i=r;j.isDocumentKey(i)||(i=i.child(""));const o=new Re(new j(i),0);let c=new Ae(Y);return this.Jr.forEachWhile((l=>{const h=l.key.path;return!!r.isPrefixOf(h)&&(h.length===s&&(c=c.add(l.Hr)),!0)}),o),P.resolve(this.Yr(c))}Yr(e){const t=[];return e.forEach((r=>{const s=this.Zr(r);s!==null&&t.push(s)})),t}removeMutationBatch(e,t){re(this.ei(t.batchId,"removed")===0,55003),this.mutationQueue.shift();let r=this.Jr;return P.forEach(t.mutations,(s=>{const i=new Re(s.key,t.batchId);return r=r.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,s.key)})).next((()=>{this.Jr=r}))}nr(e){}containsKey(e,t){const r=new Re(t,0),s=this.Jr.firstAfterOrEqual(r);return P.resolve(t.isEqual(s&&s.key))}performConsistencyCheck(e){return this.mutationQueue.length,P.resolve()}ei(e,t){return this.Xr(e)}Xr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Zr(e){const t=this.Xr(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nd="ConnectivityMonitor";class rd{constructor(){this.xo=()=>this.Oo(),this.No=()=>this.Bo(),this.Lo=[],this.ko()}Mo(e){this.Lo.push(e)}shutdown(){window.removeEventListener("online",this.xo),window.removeEventListener("offline",this.No)}ko(){window.addEventListener("online",this.xo),window.addEventListener("offline",this.No)}Oo(){M(nd,"Network connectivity changed: AVAILABLE");for(const e of this.Lo)e(0)}Bo(){M(nd,"Network connectivity changed: UNAVAILABLE");for(const e of this.Lo)e(1)}static v(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const On="RemoteStore";class v1{constructor(e,t,r,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.Ra=[],this.Aa=i,this.Aa.Mo((o=>{r.enqueueAndForget((async()=>{Hn(this)&&(M(On,"Restarting streams for network reachability change."),await(async function(l){const h=z(l);h.Ea.add(4),await Os(h),h.Va.set("Unknown"),h.Ea.delete(4),await Eo(h)})(this))}))})),this.Va=new E1(r,s)}}async function Eo(n){if(Hn(n))for(const e of n.Ra)await e(!0)}async function Os(n){for(const e of n.Ra)await e(!1)}function tm(n,e){const t=z(n);t.Ia.has(e.targetId)||(t.Ia.set(e.targetId,e),il(t)?sl(t):Cr(t).O_()&&rl(t,e))}function nl(n,e){const t=z(n),r=Cr(t);t.Ia.delete(e),r.O_()&&nm(t,e),t.Ia.size===0&&(r.O_()?r.L_():Hn(t)&&t.Va.set("Unknown"))}function rl(n,e){if(n.da.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo($.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Cr(n).Z_(e)}function nm(n,e){n.da.$e(e),Cr(n).X_(e)}function sl(n){n.da=new mA({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),At:e=>n.Ia.get(e)||null,ht:()=>n.datastore.serializer.databaseId}),Cr(n).start(),n.Va.ua()}function il(n){return Hn(n)&&!Cr(n).x_()&&n.Ia.size>0}function Hn(n){return z(n).Ea.size===0}function rm(n){n.da=void 0}async function I1(n){n.Va.set("Online")}async function A1(n){n.Ia.forEach(((e,t)=>{rl(n,e)}))}async function C1(n,e){rm(n),il(n)?(n.Va.ha(e),sl(n)):n.Va.set("Unknown")}async function R1(n,e,t){if(n.Va.set("Online"),e instanceof jg&&e.state===2&&e.cause)try{await(async function(s,i){const o=i.cause;for(const c of i.targetIds)s.Ia.has(c)&&(await s.remoteSyncer.rejectListen(c,o),s.Ia.delete(c),s.da.removeTarget(c))})(n,e)}catch(r){M(On,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Hi(n,r)}else if(e instanceof _i?n.da.Xe(e):e instanceof Ug?n.da.st(e):n.da.tt(e),!t.isEqual($.min()))try{const r=await Xg(n.localStore);t.compareTo(r)>=0&&await(function(i,o){const c=i.da.Tt(o);return c.targetChanges.forEach(((l,h)=>{if(l.resumeToken.approximateByteSize()>0){const f=i.Ia.get(h);f&&i.Ia.set(h,f.withResumeToken(l.resumeToken,o))}})),c.targetMismatches.forEach(((l,h)=>{const f=i.Ia.get(l);if(!f)return;i.Ia.set(l,f.withResumeToken(De.EMPTY_BYTE_STRING,f.snapshotVersion)),nm(i,l);const p=new tn(f.target,l,h,f.sequenceNumber);rl(i,p)})),i.remoteSyncer.applyRemoteEvent(c)})(n,t)}catch(r){M(On,"Failed to raise snapshot:",r),await Hi(n,r)}}async function Hi(n,e,t){if(!Ar(e))throw e;n.Ea.add(1),await Os(n),n.Va.set("Offline"),t||(t=()=>Xg(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{M(On,"Retrying IndexedDB access"),await t(),n.Ea.delete(1),await Eo(n)}))}function sm(n,e){return e().catch((t=>Hi(n,t,e)))}async function vo(n){const e=z(n),t=gn(e);let r=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:Hc;for(;S1(e);)try{const s=await c1(e.localStore,r);if(s===null){e.Ta.length===0&&t.L_();break}r=s.batchId,k1(e,s)}catch(s){await Hi(e,s)}im(e)&&om(e)}function S1(n){return Hn(n)&&n.Ta.length<10}function k1(n,e){n.Ta.push(e);const t=gn(n);t.O_()&&t.Y_&&t.ea(e.mutations)}function im(n){return Hn(n)&&!gn(n).x_()&&n.Ta.length>0}function om(n){gn(n).start()}async function P1(n){gn(n).ra()}async function x1(n){const e=gn(n);for(const t of n.Ta)e.ea(t.mutations)}async function V1(n,e,t){const r=n.Ta.shift(),s=Kc.from(r,e,t);await sm(n,(()=>n.remoteSyncer.applySuccessfulWrite(s))),await vo(n)}async function D1(n,e){e&&gn(n).Y_&&await(async function(r,s){if((function(o){return fA(o)&&o!==k.ABORTED})(s.code)){const i=r.Ta.shift();gn(r).B_(),await sm(r,(()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s))),await vo(r)}})(n,e),im(n)&&om(n)}async function id(n,e){const t=z(n);t.asyncQueue.verifyOperationInProgress(),M(On,"RemoteStore received new credentials");const r=Hn(t);t.Ea.add(3),await Os(t),r&&t.Va.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ea.delete(3),await Eo(t)}async function N1(n,e){const t=z(n);e?(t.Ea.delete(2),await Eo(t)):e||(t.Ea.add(2),await Os(t),t.Va.set("Unknown"))}function Cr(n){return n.ma||(n.ma=(function(t,r,s){const i=z(t);return i.sa(),new y1(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(n.datastore,n.asyncQueue,{Zo:I1.bind(null,n),Yo:A1.bind(null,n),t_:C1.bind(null,n),J_:R1.bind(null,n)}),n.Ra.push((async e=>{e?(n.ma.B_(),il(n)?sl(n):n.Va.set("Unknown")):(await n.ma.stop(),rm(n))}))),n.ma}function gn(n){return n.fa||(n.fa=(function(t,r,s){const i=z(t);return i.sa(),new _1(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),Yo:P1.bind(null,n),t_:D1.bind(null,n),ta:x1.bind(null,n),na:V1.bind(null,n)}),n.Ra.push((async e=>{e?(n.fa.B_(),await vo(n)):(await n.fa.stop(),n.Ta.length>0&&(M(On,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))}))),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class O1{constructor(){this.wa=void 0,this.ba=[]}Sa(){return this.ba.some((e=>e.Da()))}}class L1{constructor(){this.queries=ad(),this.onlineState="Unknown",this.Ca=new Set}terminate(){(function(t,r){const s=z(t),i=s.queries;s.queries=ad(),i.forEach(((o,c)=>{for(const l of c.ba)l.onError(r)}))})(this,new L(k.ABORTED,"Firestore shutting down"))}}function ad(){return new jn((n=>Cg(n)),mo)}async function cl(n,e){const t=z(n);let r=3;const s=e.query;let i=t.queries.get(s);i?!i.Sa()&&e.Da()&&(r=2):(i=new O1,r=e.Da()?0:1);try{switch(r){case 0:i.wa=await t.onListen(s,!0);break;case 1:i.wa=await t.onListen(s,!1);break;case 2:await t.onFirstRemoteStoreListen(s)}}catch(o){const c=al(o,`Initialization of query '${Xn(e.query)}' failed`);return void e.onError(c)}t.queries.set(s,i),i.ba.push(e),e.va(t.onlineState),i.wa&&e.Fa(i.wa)&&ul(t)}async function ll(n,e){const t=z(n),r=e.query;let s=3;const i=t.queries.get(r);if(i){const o=i.ba.indexOf(e);o>=0&&(i.ba.splice(o,1),i.ba.length===0?s=e.Da()?0:1:!i.Sa()&&e.Da()&&(s=2))}switch(s){case 0:return t.queries.delete(r),t.onUnlisten(r,!0);case 1:return t.queries.delete(r),t.onUnlisten(r,!1);case 2:return t.onLastRemoteStoreUnlisten(r);default:return}}function M1(n,e){const t=z(n);let r=!1;for(const s of e){const i=s.query,o=t.queries.get(i);if(o){for(const c of o.ba)c.Fa(s)&&(r=!0);o.wa=s}}r&&ul(t)}function F1(n,e,t){const r=z(n),s=r.queries.get(e);if(s)for(const i of s.ba)i.onError(t);r.queries.delete(e)}function ul(n){n.Ca.forEach((e=>{e.next()}))}var nc,cd;(cd=nc||(nc={})).Ma="default",cd.Cache="cache";class hl{constructor(e,t,r){this.query=e,this.xa=t,this.Oa=!1,this.Na=null,this.onlineState="Unknown",this.options=r||{}}Fa(e){if(!this.options.includeMetadataChanges){const r=[];for(const s of e.docChanges)s.type!==3&&r.push(s);e=new gr(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.Oa?this.Ba(e)&&(this.xa.next(e),t=!0):this.La(e,this.onlineState)&&(this.ka(e),t=!0),this.Na=e,t}onError(e){this.xa.error(e)}va(e){this.onlineState=e;let t=!1;return this.Na&&!this.Oa&&this.La(this.Na,e)&&(this.ka(this.Na),t=!0),t}La(e,t){if(!e.fromCache||!this.Da())return!0;const r=t!=="Offline";return(!this.options.Ka||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||t==="Offline")}Ba(e){if(e.docChanges.length>0)return!0;const t=this.Na&&this.Na.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&this.options.includeMetadataChanges===!0}ka(e){e=gr.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.Oa=!0,this.xa.next(e)}Da(){return this.options.source!==nc.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uC="ComponentProvider",dd=new Map;function hC(n,e,t,r,s){return new PI(n,e,t,s.host,s.ssl,s.experimentalForceLongPolling,s.experimentalAutoDetectLongPolling,mm(s.experimentalLongPollingOptions),s.useFetchStreams,s.isUsingEmulator,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gd="AsyncQueue";class md{constructor(e=Promise.resolve()){this.Yu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new Zg(this,"async_queue_retry"),this._c=()=>{const r=ma();r&&M(gd,"Visibility state changed to "+r.visibilityState),this.M_.w_()},this.ac=e;const t=ma();t&&typeof t.addEventListener=="function"&&t.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.uc(),this.cc(e)}enterRestrictedMode(e){if(!this.ec){this.ec=!0,this.sc=e||!1;const t=ma();t&&typeof t.removeEventListener=="function"&&t.removeEventListener("visibilitychange",this._c)}}enqueue(e){if(this.uc(),this.ec)return new Promise((()=>{}));const t=new Vt;return this.cc((()=>this.ec&&this.sc?Promise.resolve():(e().then(t.resolve,t.reject),t.promise))).then((()=>t.promise))}enqueueRetryable(e){this.enqueueAndForget((()=>(this.Yu.push(e),this.lc())))}async lc(){if(this.Yu.length!==0){try{await this.Yu[0](),this.Yu.shift(),this.M_.reset()}catch(e){if(!Ar(e))throw e;M(gd,"Operation failed with retryable error: "+e)}this.Yu.length>0&&this.M_.p_((()=>this.lc()))}}cc(e){const t=this.ac.then((()=>(this.rc=!0,e().catch((r=>{throw this.nc=r,this.rc=!1,Mt("INTERNAL UNHANDLED ERROR: ",yd(r)),r})).then((r=>(this.rc=!1,r))))));return this.ac=t,t}enqueueAfterDelay(e,t,r){this.uc(),this.oc.indexOf(e)>-1&&(t=0);const s=ol.createAndSchedule(this,e,t,r,(i=>this.hc(i)));return this.tc.push(s),s}uc(){this.nc&&B(47125,{Pc:yd(this.nc)})}verifyOperationInProgress(){}async Tc(){let e;do e=this.ac,await e;while(e!==this.ac)}Ic(e){for(const t of this.tc)if(t.timerId===e)return!0;return!1}Ec(e){return this.Tc().then((()=>{this.tc.sort(((t,r)=>t.targetTimeMs-r.targetTimeMs));for(const t of this.tc)if(t.skipDelay(),e!=="all"&&t.timerId===e)break;return this.Tc()}))}Rc(e){this.oc.push(e)}hc(e){const t=this.tc.indexOf(e);this.tc.splice(t,1)}}function yd(n){let e=n.message||"";return n.stack&&(e=n.stack.includes(n.message)?n.stack:n.message+`
`+n.stack),e}class yn extends Io{constructor(e,t,r,s){super(e,t,r,s),this.type="firestore",this._queue=new md,this._persistenceKey=(s==null?void 0:s.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new md(e),this._firestoreClient=void 0,await e}}}function fC(n,e){const t=typeof n=="object"?n:mp(),r=typeof n=="string"?n:Oi,s=Sc(t,"firestore").getImmediate({identifier:r});if(!s._initialized){const i=xb("firestore");i&&dC(s,...i)}return s}function Ao(n){if(n._terminated)throw new L(k.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||pC(n),n._firestoreClient}function pC(n){var r,s,i,o;const e=n._freezeSettings(),t=hC(n._databaseId,((r=n._app)==null?void 0:r.options.appId)||"",n._persistenceKey,(s=n._app)==null?void 0:s.options.apiKey,e);n._componentsProvider||(i=e.localCache)!=null&&i._offlineComponentProvider&&((o=e.localCache)!=null&&o._onlineComponentProvider)&&(n._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),n._firestoreClient=new rC(n._authCredentials,n._appCheckCredentials,n._queue,t,n._componentsProvider&&(function(l){const h=l==null?void 0:l._online.build();return{_offline:l==null?void 0:l._offline.build(h),_online:h}})(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bl extends EC{constructor(e){super(),this.firestore=e}convertBytes(e){return new tt(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new _e(this.firestore,null,t)}}function Dt(){return new _l("serverTimestamp")}const _d="@firebase/firestore",wd="4.10.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */kn._jsonSchemaVersion="firestore/querySnapshot/1.0",kn._jsonSchema={type:Ee("string",kn._jsonSchemaVersion),bundleSource:Ee("string","QuerySnapshot"),bundleName:Ee("string"),bundle:Ee("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function So(n){n=rt(n,_e);const e=rt(n.firestore,yn),t=Ao(e);return aC(t,n._key).then((r=>Dm(e,n,r)))}function xm(n){n=rt(n,qn);const e=rt(n.firestore,yn),t=Ao(e),r=new bl(e);return Cm(n._query),cC(t,n._query).then((s=>new kn(e,r,n,s)))}function mr(n,e,t){n=rt(n,_e);const r=rt(n.firestore,yn),s=Pm(n.converter,e,t),i=yl(r);return Il(r,[Tm(i,"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,ht.none())])}function Vm(n){return Il(rt(n.firestore,yn),[new Jc(n._key,ht.none())])}function CC(n,e){const t=rt(n.firestore,yn),r=Ms(n),s=Pm(n.converter,e),i=yl(n.firestore);return Il(t,[Tm(i,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,ht.exists(!1))]).then((()=>r))}function vl(n,...e){var h,f,p;n=qe(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||bd(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(bd(e[r])){const m=e[r];e[r]=(h=m.next)==null?void 0:h.bind(m),e[r+1]=(f=m.error)==null?void 0:f.bind(m),e[r+2]=(p=m.complete)==null?void 0:p.bind(m)}let i,o,c;if(n instanceof _e)o=rt(n.firestore,yn),c=go(n._key.path),i={next:m=>{e[r]&&e[r](Dm(o,n,m))},error:e[r+1],complete:e[r+2]};else{const m=rt(n,qn);o=rt(m.firestore,yn),c=m._query;const y=new bl(o);i={next:R=>{e[r]&&e[r](new kn(o,y,m,R))},error:e[r+1],complete:e[r+2]},Cm(n._query)}const l=Ao(o);return oC(l,c,s,i)}function Il(n,e){const t=Ao(n);return lC(t,e)}function Dm(n,e,t){const r=t.docs.get(e._key),s=new bl(n);return new Sn(n,s,e._key,r,new Qr(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){cI(br),cr(new Vn("firestore",((r,{instanceIdentifier:s,options:i})=>{const o=r.getProvider("app").getImmediate(),c=new yn(new hI(r.getProvider("auth-internal")),new pI(o,r.getProvider("app-check-internal")),xI(o,s),o);return i={useFetchStreams:t,...i},c._setSettings(i),c}),"PUBLIC").setMultipleInstances(!0)),on(_d,wd,e),on(_d,wd,"esm2020")})();const RC={apiKey:"AIzaSyCvK7ounDvKzgKGHK30uCFqDUbqZkoOGJc",authDomain:"cardy-hardy.firebaseapp.com",projectId:"cardy-hardy",storageBucket:"cardy-hardy.firebasestorage.app",messagingSenderId:"756160918063",appId:"1:756160918063:web:830975f45634054dfe8cda",measurementId:"G-MXM77YZD95"};let _a=null,wa=null,ba=null,Ta=null;const Nm=()=>(_a||(_a=gp(RC)),_a),yr=()=>(wa||(wa=oI(Nm())),wa),vd=()=>(ba||(ba=new St),ba),Rr=()=>(Ta||(Ta=fC(Nm())),Ta),Om=()=>Ms(Rr(),"admins","list"),Lm=()=>Ms(Rr(),"config","site"),Al=n=>Ms(Rr(),"users",n),Mm=()=>_m(Rr(),"users"),ko=()=>_m(Rr(),"currentGames"),Fm=n=>Ms(Rr(),"currentGames",n),ic=(n="")=>n.trim().toLowerCase(),SC=()=>typeof navigator<"u"&&/iPad|iPhone|iPod/i.test(navigator.userAgent||""),kC=async()=>{const n=[{key:"indexedDB",value:Wp},{key:"local",value:Bp},{key:"session",value:Lc}];let e=null;for(const t of n)try{return await GE(yr(),t.value),{persistence:t.key,error:null}}catch(r){e=r,console.warn(`Failed to set ${t.key} persistence`,r)}return{persistence:"none",error:e}},PC=async()=>{let n=null,e=null;try{e=await Ev(yr())}catch(r){n=r,console.error("Firebase redirect sign-in failed",r)}const t=await kC();return{redirectError:n,redirectResult:e,persistence:t}},Cl=async()=>{try{return await pv(yr(),vd())}catch(n){if(!SC())throw n;return console.warn("Popup sign-in failed on iOS, falling back to redirect",n),bv(yr(),vd())}},_r=()=>(console.log("start signout"),QE(yr()).then(()=>{console.log("signout completed")})),xC=n=>KE(yr(),n),Um=async()=>{const n=await So(Om());if(!n.exists())return[];const e=n.data();return Array.isArray(e.items)?e.items:[]},VC=async(n="")=>(await Um()).map(ic).includes(ic(n)),DC=async n=>mr(Om(),{items:n.map(ic).filter(Boolean),updatedAt:Dt()},{merge:!0}),Rl=async()=>{const n=await So(Lm());if(!n.exists())return null;const e=n.data();return typeof e.nextMeetupDate=="number"?e.nextMeetupDate:null},NC=async n=>mr(Lm(),{nextMeetupDate:n,updatedAt:Dt()},{merge:!0}),OC=async n=>{const e=Al(n.id),t=await So(e),r={email:n.email,firstName:n.firstName,lastName:n.lastName,...n.userType?{userType:n.userType}:{},updatedAt:Dt()};return t.exists()?mr(e,r,{merge:!0}):mr(e,{...r,createdAt:Dt()})},LC=async n=>{const e=n==null?void 0:n.uid;if(!e)return!1;const t=Al(e);if((await So(t)).exists())return!0;const s=(n.email||"").trim().toLowerCase();if(s&&!(await xm(Rm(Mm(),Sm("email","==",s)))).empty)return!0;const i=n.displayName||"",[o="",...c]=i.trim().split(/\s+/),l=c.join(" ");return await mr(t,{email:s,firstName:o,lastName:l,userType:"unverified",createdAt:Dt(),updatedAt:Dt()}),!0},MC=()=>{const n=new Fn([]),e=vl(Mm(),t=>{const r=t.docs.map(s=>({id:s.id,...s.data()}));r.sort((s,i)=>{var l,h,f,p,m,y,R,x,N,D;const o=(l=s==null?void 0:s.createdAt)!=null&&l.seconds?s.createdAt.seconds*1e3:((m=(p=(f=(h=s==null?void 0:s.createdAt)==null?void 0:h.toDate)==null?void 0:f.call(h))==null?void 0:p.getTime)==null?void 0:m.call(p))??0;return((y=i==null?void 0:i.createdAt)!=null&&y.seconds?i.createdAt.seconds*1e3:((D=(N=(x=(R=i==null?void 0:i.createdAt)==null?void 0:R.toDate)==null?void 0:x.call(R))==null?void 0:N.getTime)==null?void 0:D.call(N))??0)-o}),n.next(r)},t=>{console.error("Failed to listen to users",t)});return n.unsubscribe=e,n},FC=async n=>n?(await Vm(Al(n)),!0):!1,UC=()=>{const n=new Fn([]),e=vl(ko(),t=>{const r=t.docs.map(s=>({id:s.id,...s.data()}));n.next(Sl(r))},t=>{console.error("Failed to listen to current games",t)});return n.unsubscribe=e,n},jC=()=>{const n=new Fn([]),e=vl(Rm(ko(),Sm("isVisible","==",!0)),t=>{const r=t.docs.map(s=>({id:s.id,...s.data()}));n.next(Sl(r))},t=>{console.error("Failed to listen to visible current games",t)});return n.unsubscribe=e,n},BC=async()=>{const e=(await xm(ko())).docs.map(t=>({id:t.id,...t.data()}));return Sl(e)},HC=async n=>{const e=$C(n);return n.id?mr(Fm(n.id),{...e,updatedAt:Dt()},{merge:!0}):CC(ko(),{...e,createdAt:Dt(),updatedAt:Dt()})},qC=async n=>n?(await Vm(Fm(n)),!0):!1,$C=n=>{const e={title:(n.title||"").trim(),dateAddedToCollection:n.dateAddedToCollection,imageUrl:(n.imageUrl||"").trim(),manufacturer:(n.manufacturer||"").trim(),notes:(n.notes||"").trim(),isVisible:n.isVisible!==!1};return typeof n.yearReleased=="number"&&!Number.isNaN(n.yearReleased)?e.yearReleased=n.yearReleased:e.yearReleased=null,e},Id=n=>{if(!n)return 0;if(typeof n.toDate=="function")return n.toDate().getTime();if(typeof n=="number")return n;if(n.seconds)return n.seconds*1e3;const e=new Date(n).getTime();return Number.isNaN(e)?0:e},Sl=n=>[...n].sort((e,t)=>Id(t.dateAddedToCollection)-Id(e.dateAddedToCollection)),kl=({onUser:n,toast:e})=>{if(typeof n!="function")throw new Error("startAuthFlow requires an onUser callback.");PC().then(({redirectError:t,redirectResult:r,persistence:s})=>{var i,o;t&&((i=e==null?void 0:e.error)==null||i.call(e,"Sign-in failed after redirect. Try again.")),s!=null&&s.error&&((o=e==null?void 0:e.error)==null||o.call(e,"Safari blocked login storage. Check cookie settings.")),r!=null&&r.user&&n(r.user,"redirectResult")}).catch(t=>{var r;console.error("Failed to prepare auth",t),(r=e==null?void 0:e.error)==null||r.call(e,"Sign-in setup failed. Try again.")}),xC(t=>{n(t,"onAuthChanged")})},zC=async({user:n,mountSso:e,toast:t,onDenied:r,onPermissionsError:s}={})=>{var o,c;let i=!1;try{i=await VC((n==null?void 0:n.email)||"")}catch(l){return console.error("Failed to load admin list",l),s==null||s(l),(o=t==null?void 0:t.error)==null||o.call(t,"Unable to verify access. Check Firestore rules."),e==null||e("denied",(n==null?void 0:n.email)||"","auth:permissions"),!1}return i?!0:(r==null||r(),(c=t==null?void 0:t.error)==null||c.call(t,`Signed in as ${(n==null?void 0:n.email)||"unknown"} but not authorized.`),e==null||e("denied",(n==null?void 0:n.email)||"","auth:denied"),!1)},Pl=async({user:n,mountSso:e,toast:t,setCurrentUser:r,onSignedOut:s,onDenied:i,onAuthorized:o,reason:c=""}={})=>{if(!n)return r==null||r(null),s==null||s(),e==null||e("login","","auth:logged-out"),!1;try{await LC(n)}catch(h){console.warn("Failed to ensure user profile",h)}return await zC({user:n,mountSso:e,toast:t,onDenied:i,onPermissionsError:i})?(r==null||r(n),o==null||o(n,c),!0):!1},Po=F(({status:n,userEmail:e,adminEmail:t,onSignIn:r,onSignOut:s})=>(Po.inputs(i=>{[{status:n,userEmail:e,adminEmail:t,onSignIn:r,onSignOut:s}]=i,r=Te(r),s=Te(s)}),[()=>n==="loading"?ia.class`panel auth-panel`(ge("Checking login...")):n==="denied"?ia.class`panel auth-panel`(xt("Access denied"),ge.class`auth-warning`(()=>e||"This account"," is not authorized."),ge("Please be patient as we review your account to become verified status."),T.class`auth-actions`(se.type`button`.class`add-button`.onClick(s)("Sign out"))):ia.class`panel auth-panel`(xt("Sign in"),ge("Use Google to access admin tools."),T.class`auth-actions`(se.type`button`.class`add-button`.onClick(r)("Sign in with Google")))])),GC=F(()=>{let n=[];const e=ke(()=>{});F.promise=Um().then(o=>{n=Array.isArray(o)?o:[],e()}).catch(o=>{console.error("Failed to load admin list",o)});const t=(o,c)=>{n=n.map((l,h)=>h===o?c:l),e()},r=()=>{n=[...n,""],e()},s=o=>{n=n.filter((c,l)=>l!==o),e()},i=()=>DC(n).then(()=>{alert("saved")}).catch(o=>{console.error("Failed to save admin list",o)});return io.style`border:0;padding:0;margin:0;`(T.style`display:flex;flex-direction:column;gap:0.6em;`(o=>(n.length?n:[""]).map((c,l)=>T.style`display:flex;gap:0.6em;align-items:center;`(Se.type`text`.value(h=>c).onInput(h=>t(l,h.target.value)).style`width:100%`,se.onClick(()=>s(l))("remove")))),T.style`display:flex;gap:0.6em;align-items:center;margin-top:0.8em;flex-wrap:wrap;`(se.onClick(r)("add"),se.onClick(i)("save to firestore")))});function jm({startDateTime:n,message:e,subject:t}){n=new Date(n);const{year:r,month:s}=xl(n),i=("0"+(n.getDate()+1)).slice(-2),o=Gi(n),c=new Date(new Date(n).setHours(n.getHours()+2)),l=Gi(c),h=encodeURIComponent(e),f=encodeURIComponent(t);return`https://calendar.google.com/calendar/render?action=TEMPLATE&dates=${r}${s}${i}${o}%2F${r}${s}${i}${l}&details=${h}&location=&text=${f}`}function Bm({startDateTime:n,message:e,subject:t}){n=new Date(n);const{year:r,month:s,day:i,hours:o}=xl(n),l=new Date(new Date(n).setHours(n.getHours()+2)).getHours(),h=encodeURIComponent(e.replace(/\n/g,"<br>")),f=encodeURIComponent(t);return`https://outlook.live.com/calendar/0/action/compose?allday=false&body=${h}&enddt=${r}-${s}-${i}T${l}%3A00%3A00&location=&path=%2Fcalendar%2Faction%2Fcompose&rru=addevent&startdt=${r}-${s}-${i}T${o}%3A00%3A00&subject=${f}`}function Hm({startDateTime:n,message:e,subject:t}){n=new Date(n);const{year:r,month:s}=xl(n),i=("0"+(n.getDate()+1)).slice(-2),o=Gi(n),c=new Date(new Date(n).setHours(n.getHours()+2)),l=Gi(c);return`BEGIN:VCALENDAR
VERSION:2.0
PRODID:${t}
BEGIN:VEVENT
DTSTART:${r}${s}${i}${o}
...
END:VCALENDAR`}function xl(n){n=new Date(n);const e=n.getFullYear(),t=("0"+(n.getMonth()+1)).slice(-2),r=("0"+n.getDate()).slice(-2),s=n.getHours();return{year:e,month:t,day:r,hours:s}}function Gi(n){const e=String(n.getUTCHours()).padStart(2,"0"),t=String(n.getUTCMinutes()).padStart(2,"0"),r=String(n.getUTCSeconds()).padStart(2,"0");return`T${e}${t}${r}Z`}const qm=F(n=>{qm.updates(t=>[n]=t);const e=new Date(n);return T.style`text-align:center;`(T(ee("🗓️ ",e.toLocaleString("default",{weekday:"long"}),", ",e.toLocaleString("default",{month:"long"})," ",e.getDate(),$m(e))),t=>sp({date:n}),WC(e))});function WC(n){return T.style`font-size:.65em;opacity:.7`(JC(n))}function Ea(n,e){const t={hour:"numeric",minute:"numeric",hour12:!0,timeZone:e,timeZoneName:"short"};return new Intl.DateTimeFormat("en-US",t).format(n)}function JC(n){const e=Ea(n,"America/New_York"),t=Ea(n,"America/Chicago"),r=Ea(n,"America/Los_Angeles");return`${e} / ${t} / ${r}`}const Me={subject:"Cary Hardy Patreon meetup",message:`
  ...
  `))),Ym=F(({className:n="top-nav",content:e})=>(Ym.inputs(t=>{[{className:n,content:e}]=t}),T.class`${n}`(T.class`top-nav-row`(typeof e=="function"?e():e)))),jt=F(n=>(jt.inputs(e=>{[n]=e}),st(QC(),T.class`top-nav-shell top-nav-fixed`(Ym({className:"top-nav top-nav-inner",content:n})))));let kd=!1;const iR=F(()=>{let n="loading",e="",t=null;const r=ke((c,l="",h="")=>{n=c,e=l}),s=ke(c=>{t=c,console.log("currentUser",t),c||(n="login")}),i=()=>{r("login","","auth:logged-out"),n="login"},o=ke((c,l="")=>{n="authorized",e=(c==null?void 0:c.email)||""});return kd||(kd=!0,kl({onUser:(c,l)=>{Pl({user:c,mountSso:r,setCurrentUser:s,onSignedOut:i,onDenied:()=>{r("denied",(t==null?void 0:t.email)||"","auth:denied")},onAuthorized:o,reason:l})},toast:{error:c=>console.warn(c)}})),st(un(`
      .auth-panel {
        border: 1px solid rgba(255, 255, 255, 0.2);
        border-radius: 10px;
        padding: 1.5em;
    ...
    `),c=>ty(n,e,i))}),ty=F((n,e,t)=>(ty.inputs(r=>{[n,e,t]=r,t=Te(t)}),[()=>n==="authorized"?ny(t):T(Po({status:n,userEmail:e,adminEmail:"",onSignIn:()=>Cl().catch(r=>{console.error("Failed to sign in",r)}),onSignOut:()=>(n="login",_r().catch(r=>{console.error("Failed to sign out",r)}))}))])),ny=F(n=>{ny.inputs(([D])=>{n=Te(D)});const e=()=>_r().then(n).catch(D=>{console.error("Failed to sign out",D)});let t=!1,r=!1,s=!1,i="",o=null,c=null,l=null;const h=ke(()=>{}),f=D=>D?typeof D.toDate=="function"?D.toDate().toLocaleDateString():typeof D=="number"?new Date(D).toLocaleDateString():D.seconds?new Date(D.seconds*1e3).toLocaleDateString():"-":"-",p=D=>{if(!D)return"-";let V=null;return typeof D.toDate=="function"?V=D.toDate():typeof D=="number"?V=new Date(D):D.seconds&&(V=new Date(D.seconds*1e3)),V?V.toLocaleString():"-"},m=()=>{Jt&&(Jt(),Jt=null),t=!0,i="",h(),zr=MC(),Jt=(zr==null?void 0:zr.unsubscribe)||null},y=D=>{o=D.id,c=D.createdAt??null,l={...D},h()},R=()=>{o=null,c=null,l=null,h()},x=()=>{if(!o||r)return;r=!0,i="",h();const D={id:o,email:((l==null?void 0:l.email)||"").trim(),firstName:((l==null?void 0:l.firstName)||"").trim(),lastName:((l==null?void 0:l.lastName)||"").trim(),userType:(l==null?void 0:l.userType)==="verified"?"verified":"unverified"};F.promise=OC(D).then(()=>{R()}).catch(V=>{console.error("Failed to save user",V),i="Failed to save user.",h()}).finally(()=>{r=!1,h()})},N=()=>{!o||s||confirm("Delete this user?")&&(s=!0,i="",h(),F.promise=FC(o).then(()=>{R()}).catch(D=>{console.error("Failed to delete user",D),i="Failed to delete user.",h()}).finally(()=>{s=!1,h()}))};return Ia||(Ia=!0,Jt?t=!0:m()),ro(()=>{Jt&&(Jt(),Jt=null),Ia=!1}),st(jt(()=>Vo(e)),T.class`users-page`(As("Users Admin"),T.class`users-card`(T.style`margin-top:0.75em;display:grid;gap:0.5em;`(D=>i?ge.style`color:#f6c177;`(i):"",yc(zr,null,D=>D===null?te.style`opacity:0.7;`("Loading users..."):(t=!1,console.log("user items",{items:D,isLoading:t}),D.length?D.map(V=>Zm({user:V,onEdit:()=>y(V),formatCreatedAt:f}).key(V.id)):te.style`opacity:0.7;`("No users found.")))),D=>o?ey({userId:o,createdAtLabel:p(c),editUser:l,isSaving:r,isDeleting:s,onChange:V=>{l=V,h()},onSave:x,onDelete:N,onCancel:R}):"",q,T.class`users-actions`(W.href`../admin.html`("Back to Admin Tools")))))}),Aa=()=>({title:"",dateAddedToCollection:"",imageUrl:"",manufacturer:"",yearReleased:null,notes:"",isVisible:!0});let xd=!1,Ca=!1,Kn=new Fn(null),Kt=null;const aR=F(()=>{let n="loading",e="",t=null;const r=ke((c,l="",h="")=>{n=c,e=l}),s=ke(c=>{t=c,c||(n="login")}),i=()=>{r("login","","auth:logged-out"),n="login"},o=ke((c,l="")=>{n="authorized",e=(c==null?void 0:c.email)||""});return xd||(xd=!0,kl({onUser:(c,l)=>{Pl({user:c,mountSso:r,setCurrentUser:s,onSignedOut:i,onDenied:()=>{r("denied",(t==null?void 0:t.email)||"","auth:denied")},onAuthorized:o,reason:l})},toast:{error:c=>console.warn(c)}})),st(un(`
      .auth-panel {
        border: 1px solid rgba(255, 255, 255, 0.2);
        border-radius: 10px;
        padding: 1.5em;
