 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class SE{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(xE(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function xE(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Qc="@firebase/app",Sh="0.14.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yc="[DEFAULT]",s1={[Qc]:"fire-core",[PE]:"fire-core-compat",[DE]:"fire-analytics",[VE]:"fire-analytics-compat",[LE]:"fire-app-check",[NE]:"fire-app-check-compat",[ME]:"fire-auth",[OE]:"fire-auth-compat",[UE]:"fire-rtdb",[FE]:"fire-data-connect",[$E]:"fire-rtdb-compat",[BE]:"fire-fn",[jE]:"fire-fn-compat",[zE]:"fire-iid",[HE]:"fire-iid-compat",[qE]:"fire-fcm",[GE]:"fire-fcm-compat",[WE]:"fire-perf",[JE]:"fire-perf-compat",[KE]:"fire-rc",[QE]:"fire-rc-compat",[YE]:"fire-gcs",[XE]:"fire-gcs-compat",[ZE]:"fire-fst",[t1]:"fire-fst-compat",[e1]:"fire-vertex","fire-js":"fire-js",[n1]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const c1="firebase-heartbeat-database",l1=1,ii="firebase-heartbeat-store";let lc=null;function nm(){return lc||(lc=CE(c1,l1,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ii)}catch(n){console.warn(n)}}}}).catch(t=>{throw _n.create("idb-open",{originalErrorMessage:t.message})})),lc}async function u1(t){try{const n=(await nm()).transaction(ii),r=await n.objectStore(ii).get(rm(t));return await n.done,r}catch(e){if(e instanceof Qt)qt.warn(e.message);else{const n=_n.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});qt.warn(n.message)}}}async function Ph(t,e){try{const r=(await nm()).transaction(ii,"readwrite");await r.objectStore(ii).put(e,rm(t)),await r.done}catch(n){if(n instanceof Qt)qt.warn(n.message);else{const r=_n.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});qt.warn(r.message)}}}function rm(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const d1=1024,h1=30;class f1{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new g1(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,n;try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=Vh();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)==null?void 0:n.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(o=>o.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:s}),this._heartbeatsCache.heartbeats.length>h1){const o=m1(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(r){qt.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=Vh(),{heartbeatsToSend:r,unsentEntries:s}=p1(this._heartbeatsCache.heartbeats),i=Io(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=n,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}catch(n){return qt.warn(n),""}}}function Vh(){return new Date().toISOString().substring(0,10)}function p1(t,e=d1){const n=[];let r=t.slice();for(const s of t){const i=n.find(o=>o.agent===s.agent);if(i){if(i.dates.push(s.date),Dh(n)>e){i.dates.pop();break}}else if(n.push({agent:s.agent,dates:[s.date]}),Dh(n)>e){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class g1{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return tE()?nE().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await u1(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return Ph(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return Ph(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function Dh(t){return Io(JSON.stringify({version:2,heartbeats:t})).length}function m1(t){if(t.length===0)return-1;let e=0,n=t[0].date;for(let r=1;r<t.length;r++)t[r].date<n&&(n=t[r].date,e=r);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function y1(t){Wr(new ar("platform-logger",e=>new SE(e),"PRIVATE")),Wr(new ar("heartbeat",e=>new f1(e),"PRIVATE")),bn(Qc,Sh,t),bn(Qc,Sh,"esm2020"),bn("fire-js","")}y1("");var _1="firebase",b1="12.8.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vo=new Jl("@firebase/auth");function T1(t,...e){vo.logLevel<=re.WARN&&vo.warn(`Auth (${is}): ${t}`,...e)}function io(t,...e){vo.logLevel<=re.ERROR&&vo.error(`Auth (${is}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zc(){var t;return typeof self<"u"&&((t=self.location)==null?void 0:t.href)||""}function I1(){return Nh()==="http:"||Nh()==="https:"}function Nh(){var t;return typeof self<"u"&&((t=self.location)==null?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const C1=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],R1=new Ii(3e4,6e4);function eu(t,e){return t.tenantId&&!e.tenantId?{...e,tenantId:t.tenantId}:e}async function os(t,e,n,r,s={}){return cm(t,s,async()=>{let i={},o={};r&&(e==="GET"?o=r:i={body:JSON.stringify(r)});const c=Ti({key:t.config.apiKey,...o}).slice(1),l=await t._getAdditionalHeaders();l["Content-Type"]="application/json",t.languageCode&&(l["X-Firebase-Locale"]=t.languageCode);const u={method:e,headers:l,...i};return QI()||(u.referrerPolicy="no-referrer"),t.emulatorConfig&&ss(t.emulatorConfig.host)&&(u.credentials="include"),am.fetch()(await lm(t,t.config.apiHost,n,c),u)})}async function cm(t,e,n){t._canInitEmulator=!1;const r={...A1,...e};try{const s=new S1(t),i=await Promise.race([n(),s.promise]);s.clearNetworkTimeout();const o=await i.json();if("needConfirmation"in o)throw Wi(t,"account-exists-with-different-credential",o);if(i.ok&&!("errorMessage"in o))return o;{const c=i.ok?o.errorMessage:o.error.message,[l,u]=c.split(" : ");if(l==="FEDERATED_USER_ID_ALREADY_LINKED")throw Wi(t,"credential-already-in-use",o);if(l==="EMAIL_EXISTS")throw Wi(t,"email-already-in-use",o);if(l==="USER_DISABLED")throw Wi(t,"user-disabled",o);const h=r[l]||l.toLowerCase().replace(/[_\s]+/g,"-");if(u)throw Yl(t,h,u);Dt(t,h)}}catch(s){if(s instanceof Qt)throw s;Dt(t,"network-request-failed",{message:String(s)})}}async function k1(t,e,n,r,s={}){const i=await os(t,e,n,r,s);return"mfaPendingCredential"in i&&Dt(t,"multi-factor-auth-required",{_serverResponse:i}),i}async function lm(t,e,n,r){const s=`${e}${n}?${r}`,i=t,o=i.config.emulator?Zl(t.config,s):`${t.config.apiScheme}://${s}`;return C1.includes(n)&&(await i._persistenceManagerAvailable,i._getPersistenceType()==="COOKIE")?i._getPersistence()._getFinalTarget(o).toString():o}class S1{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,r)=>{this.timer=setTimeout(()=>r(mt(this.auth,"network-request-failed")),R1.get())})}}function Wi(t,e,n){const r={appName:t.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const s=mt(t,e,r);return s.customData._tokenResponse=n,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oi(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof Qt&&V1(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function V1({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uh(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(gm(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(hm(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(ym(e))return"Blackberry";if(_m(e))return"Webos";if(fm(e))return"Safari";if((e.includes("chrome/")||pm(e))&&!e.includes("edge/"))return"Chrome";if(mm(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function hm(t=Ke()){return/firefox\//i.test(t)}function fm(t=Ke()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function pm(t=Ke()){return/crios\//i.test(t)}function gm(t=Ke()){return/iemobile/i.test(t)}function mm(t=Ke()){return/android/i.test(t)}function ym(t=Ke()){return/blackberry/i.test(t)}function _m(t=Ke()){return/webos/i.test(t)}function nu(t=Ke()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function U1(t=Ke()){var e;return nu(t)&&!!((e=window.navigator)!=null&&e.standalone)}function F1(){return ZI()&&document.documentMode===10}function bm(t=Ke()){return nu(t)||mm(t)||_m(t)||ym(t)||/windows phone/i.test(t)||gm(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wm(t,e=[]){let n;switch(t){case"Browser":n=Uh(Ke());break;case"Worker":n=`${Uh(Ke())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${is}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function B1(t,e={}){return os(t,"GET","/v2/passwordPolicy",eu(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ru={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function q1(t){ru=t}function G1(t){return ru.loadJS(t)}function W1(){return ru.gapiScript}function J1(t){return`__${t}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function K1(t,e){const n=Ql(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),i=n.getOptions();if(or(i,e??{}))return s;Dt(s,"already-initialized")}return n.initialize({options:e})}function Q1(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(jt);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Y1(t,e,n){const r=as(t);Q(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=Tm(e),{host:o,port:c}=X1(e),l=c===null?"":`:${c}`,u={url:`${i}//${o}${l}/`},h=Object.freeze({host:o,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){Q(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),Q(or(u,r.config.emulator)&&or(h,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=u,r.emulatorConfig=h,r.settings.appVerificationDisabledForTesting=!0,ss(o)?(Qg(`${i}//${o}${l}`),Yg("Auth",!0)):Z1()}function Tm(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function X1(t){const e=Tm(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:$h(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:$h(o)}}}function $h(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function Z1(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hr(t,e){return k1(t,"POST","/v1/accounts:signInWithIdp",eu(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nv(t,e,n=!1){const{auth:r}=t;if(ot(r.app))return Promise.reject(wn(r));const s="reauthenticate";try{const i=await oi(t,Em(r,s,e,t),n);Q(i.idToken,r,"internal-error");const o=tu(i.idToken);Q(o,r,"internal-error");const{sub:c}=o;return Q(t.uid===c,r,"user-mismatch"),Jr._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Dt(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rt(){return window}function fv(t){Rt().location.href=t}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function km(){return typeof Rt().WorkerGlobalScope<"u"&&typeof Rt().importScripts=="function"}async function pv(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function gv(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)==null?void 0:t.controller)||null}function mv(){return km()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vv(t,e,n){return Dv(t,e,n)}async function Dv(t,e,n){if(ot(t.app))return Promise.reject(wn(t));const r=as(t);om(t,e,sa),await r._initializationPromise;const s=ou(r,n);return await xv(s,r),s._openRedirect(r,e,"signInViaRedirect")}async function Nv(t,e){return await as(t)._initializationPromise,Mm(t,e,!1)}async function Mm(t,e,n=!1){if(ot(t.app))return Promise.reject(wn(t));const r=as(t),s=ou(r,e),o=await new kv(r,s,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lv=600*1e3;class Mv{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let n=!1;return this.consumers.forEach(r=>{this.isEventForConsumer(e,r)&&(n=!0,this.sendToConsumer(e,r),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!Ov(e)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=e,n=!0)),n}sendToConsumer(e,n){var r;if(e.error&&!Om(e)){const s=((r=e.error.code)==null?void 0:r.split("auth/")[1])||"internal-error";n.onError(mt(this.auth,s))}else n.onAuthEvent(e)}isEventForConsumer(e,n){const r=n.eventId===null||!!e.eventId&&e.eventId===n.eventId;return n.filter.includes(e.type)&&r}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=Lv&&this.cachedEventUids.clear(),this.cachedEventUids.has(Hh(e))}saveEventToCache(e){this.cachedEventUids.add(Hh(e)),this.lastProcessedEventTime=Date.now()}}function Hh(t){return[t.type,t.eventId,t.sessionId,t.tenantId].filter(e=>e).join("-")}function Om({type:t,error:e}){return t==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function Ov(t){switch(t.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Om(t);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Uv(t,e={}){return os(t,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zv=new Ii(3e4,6e4);function qh(){const t=Rt().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function Hv(t){return new Promise((e,n)=>{var s,i,o;function r(){qh(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{qh(),n(mt(t,"network-request-failed"))},timeout:zv.get()})}if((i=(s=Rt().gapi)==null?void 0:s.iframes)!=null&&i.Iframe)e(gapi.iframes.getContext());else if((o=Rt().gapi)!=null&&o.load)r();else{const c=J1("iframefcb");return Rt()[c]=()=>{gapi.load?r():n(mt(t,"network-request-failed"))},G1(`${W1()}?onload=${c}`).catch(l=>n(l))}}).catch(e=>{throw co=null,e})}let co=null;function qv(t){return co=co||Hv(t),co}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gv=new Ii(5e3,15e3),Wv="__/auth/iframe",Jv="emulator/auth/iframe",Kv={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Qv=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Yv(t){const e=t.config;Q(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Zl(e,Jv):`https://${t.config.authDomain}/${Wv}`,r={apiKey:e.apiKey,appName:t.name,v:is},s=Qv.get(t.config.apiHost);s&&(r.eid=s);const i=t._getFrameworks();return i.length&&(r.fw=i.join(",")),`${n}?${Ti(r).slice(1)}`}async function Xv(t){const e=await qv(t),n=Rt().gapi;return Q(n,t,"internal-error"),e.open({where:document.body,url:Yv(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Kv,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const o=mt(t,"network-request-failed"),c=Rt().setTimeout(()=>{i(o)},Gv.get());function l(){Rt().clearTimeout(c),s(r)}r.ping(l).then(l,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oA="__/auth/handler",aA="emulator/auth/handler",cA=encodeURIComponent("fac");async function Wh(t,e,n,r,s,i){Q(t.config.authDomain,t,"auth-domain-config-required"),Q(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:is,eventId:s};if(e instanceof sa){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",oE(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[h,f]of Object.entries({}))o[h]=f}if(e instanceof Ei){const h=e.getScopes().filter(f=>f!=="");h.length>0&&(o.scopes=h.join(","))}t.tenantId&&(o.tid=t.tenantId);const c=o;for(const h of Object.keys(c))c[h]===void 0&&delete c[h];const l=await t._getAppCheckToken(),u=l?`#${cA}=${encodeURIComponent(l)}`:"";return`${lA(t)}?${Ti(c).slice(1)}${u}`}function lA({config:t}){return t.emulator?Zl(t,aA):`https://${t.authDomain}/${oA}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gA=300,mA=Kg("authIdTokenMaxAge")||gA;let Qh=null;const yA=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>mA)return;const s=n==null?void 0:n.token;Qh!==s&&(Qh=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function _A(t=tm()){const e=Ql(t,"auth");if(e.isInitialized())return e.getImmediate();const n=K1(t,{popupRedirectResolver:dA,persistence:[Vm,Cm,su]}),r=Kg("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const o=yA(i.toString());ov(n,o,()=>o(n.currentUser)),iv(n,c=>o(c))}}const s=Wg("auth");return s&&Y1(n,`http://${s}`),n}function bA(){var t;return((t=document.getElementsByTagName("head"))==null?void 0:t[0])??document}q1({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=s=>{const i=mt("internal-error");i.customData=s,n(i)},r.type="text/javascript",r.charset="UTF-8",bA().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});pA("Browser");var Yh=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
`}),d}function Ya(a,d,p){e:{for(y in p){var y=!1;break e}y=!0}y||(p=zd(p),typeof a=="string"?p!=null&&vs(p):_e(a,d,p))}function Ee(a){Be.call(this),this.headers=new Map,this.L=a||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}f(Ee,Be);var K0=/^https?$/i,Q0=["POST","PUT"];t=Ee.prototype,t.Fa=function(a){this.H=a},t.ea=function(a,d,p,y){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);d=d?d.toUpperCase():"GET",this.D=a,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():vd.g(),this.g.onreadystatechange=g(u(this.Ca,this));try{this.B=!0,this.g.open(d,String(a),!0),this.B=!1}catch(V){Hd(this,V);return}if(a=p||"",p=new Map(this.headers),y)if(Object.getPrototypeOf(y)===Object.prototype)for(var k in y)p.set(k,y[k]);else if(typeof y.keys=="function"&&typeof y.get=="function")for(const V of y.keys())p.set(V,y.get(V));else throw Error("Unknown input type for opt_headers: "+String(y));y=Array.from(p.keys()).find(V=>V.toLowerCase()=="content-type"),k=o.FormData&&a instanceof o.FormData,!(Array.prototype.indexOf.call(Q0,d,void 0)>=0)||y||k||p.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[V,$]of p)this.g.setRequestHeader(V,$);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(a),this.v=!1}catch(V){Hd(this,V)}};function Hd(a,d){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=d,a.o=5,qd(a),$i(a)}function qd(a){a.A||(a.A=!0,Xe(a,"complete"),Xe(a,"error"))}t.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=a||7,Xe(this,"complete"),Xe(this,"abort"),$i(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),$i(this,!0)),Ee.Z.N.call(this)},t.Ca=function(){this.u||(this.B||this.v||this.j?Gd(this):this.Xa())},t.Xa=function(){Gd(this)};function Gd(a){if(a.h&&typeof i<"u"){if(a.v&&nn(a)==4)setTimeout(a.Ca.bind(a),0);else if(Xe(a,"readystatechange"),nn(a)==4){a.h=!1;try{const V=a.ca();e:switch(V){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var d=!0;break e;default:d=!1}var p;if(!(p=d)){var y;if(y=V===0){let $=String(a.D).match(Ld)[1]||null;!$&&o.self&&o.self.location&&($=o.self.location.protocol.slice(0,-1)),y=!K0.test($?$.toLowerCase():"")}p=y}if(p)Xe(a,"complete"),Xe(a,"success");else{a.o=6;try{var k=nn(a)>2?a.g.statusText:""}catch{k=""}a.l=k+" ["+a.ca()+"]",qd(a)}}finally{$i(a)}}}}function $i(a,d){if(a.g){a.m&&(clearTimeout(a.m),a.m=null);const p=a.g;a.g=null,d||Xe(a,"ready");try{p.onreadystatechange=null}catch{}}}t.isActive=function(){return!!this.g};function nn(a){return a.g?a.g.readyState:0}t.ca=function(){try{return nn(this)>2?this.g.status:-1}catch{return-1}},t.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.La=function(a){if(this.g){var d=this.g.responseText;return a&&d.indexOf(a)==0&&(d=d.substring(a.length)),S0(d)}};function Wd(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.F){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function Y0(a){const d={};a=(a.g&&nn(a)>=2&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let y=0;y<a.length;y++){if(b(a[y]))continue;var p=L0(a[y]);const k=p[0];if(p=p[1],typeof p!="string")continue;p=p.trim();const V=d[k]||[];d[k]=V,V.push(p)}E0(d,function(y){return y.join(", ")})}t.ya=function(){return this.o},t.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Ds(a,d,p){return p&&p.internalChannelParams&&p.internalChannelParams[a]||d}function Jd(a){this.za=0,this.i=[],this.j=new Es,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Ds("failFast",!1,a),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Ds("baseRetryDelayMs",5e3,a),this.Za=Ds("retryDelaySeedMs",1e4,a),this.Ta=Ds("forwardChannelMaxRetries",2,a),this.va=Ds("forwardChannelRequestTimeoutMs",2e4,a),this.ma=a&&a.xmlHttpFactory||void 0,this.Ua=a&&a.Rb||void 0,this.Aa=a&&a.useFetchStreams||!1,this.O=void 0,this.L=a&&a.supportsCrossDomainXhr||!1,this.M="",this.h=new xd(a&&a.concurrentRequestLimit),this.Ba=new J0,this.S=a&&a.fastHandshake||!1,this.R=a&&a.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=a&&a.Pb||!1,a&&a.ua&&this.j.ua(),a&&a.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&a&&a.detectBufferingProxy||!1,this.ia=void 0,a&&a.longPollingTimeout&&a.longPollingTimeout>0&&(this.ia=a.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}t=Jd.prototype,t.ka=8,t.I=1,t.connect=function(a,d,p,y){Ze(0),this.W=a,this.H=d||{},p&&y!==void 0&&(this.H.OSID=p,this.H.OAID=y),this.F=this.X,this.J=rh(this,null,this.W),ji(this)};function Xa(a){if(Kd(a),a.I==3){var d=a.V++,p=vt(a.J);if(_e(p,"SID",a.M),_e(p,"RID",d),_e(p,"TYPE","terminate"),Ns(a,p),d=new Zt(a,a.j,d),d.M=2,d.A=Ui(vt(p)),p=!1,o.navigator&&o.navigator.sendBeacon)try{p=o.navigator.sendBeacon(d.A.toString(),"")}catch{}!p&&o.Image&&(new Image().src=d.A,p=!0),p||(d.g=sh(d.j,null),d.g.ea(d.A)),d.F=Date.now(),Oi(d)}nh(a)}function Bi(a){a.g&&(ec(a),a.g.cancel(),a.g=null)}function Kd(a){Bi(a),a.v&&(o.clearTimeout(a.v),a.v=null),zi(a),a.h.cancel(),a.m&&(typeof a.m=="number"&&o.clearTimeout(a.m),a.m=null)}function ji(a){if(!Pd(a.h)&&!a.m){a.m=!0;var d=a.Ea;x||_(),U||(x(),U=!0),T.add(d,a),a.D=0}}function X0(a,d){return Vd(a.h)>=a.h.j-(a.m?1:0)?!1:a.m?(a.i=d.G.concat(a.i),!0):a.I==1||a.I==2||a.D>=(a.Sa?0:a.Ta)?!1:(a.m=Is(u(a.Ea,a,d),th(a,a.D)),a.D++,!0)}t.Ea=function(a){if(this.m)if(this.m=null,this.I==1){if(!a){this.V=Math.floor(Math.random()*1e5),a=this.V++;const k=new Zt(this,this.j,a);let V=this.o;if(this.U&&(V?(V=ad(V),ld(V,this.U)):V=this.U),this.u!==null||this.R||(k.J=V,V=null),this.S)e:{for(var d=0,p=0;p<this.i.length;p++){t:{var y=this.i[p];if("__data__"in y.map&&(y=y.map.__data__,typeof y=="string")){y=y.length;break t}y=void 0}if(y===void 0)break;if(d+=y,d>4096){d=p;break e}if(d===4096||p===this.i.length-1){d=p+1;break e}}d=1e3}else d=1e3;d=Yd(this,k,d),p=vt(this.J),_e(p,"RID",a),_e(p,"CVER",22),this.G&&_e(p,"X-HTTP-Session-Id",this.G),Ns(this,p),V&&(this.R?d="headers="+vs(zd(V))+"&"+d:this.u&&Ya(p,this.u,V)),Ja(this.h,k),this.Ra&&_e(p,"TYPE","init"),this.S?(_e(p,"$req",d),_e(p,"SID","null"),k.U=!0,Ha(k,p,null)):Ha(k,p,d),this.I=2}}else this.I==3&&(a?Qd(this,a):this.i.length==0||Pd(this.h)||Qd(this))};function Qd(a,d){var p;d?p=d.l:p=a.V++;const y=vt(a.J);_e(y,"SID",a.M),_e(y,"RID",p),_e(y,"AID",a.K),Ns(a,y),a.u&&a.o&&Ya(y,a.u,a.o),p=new Zt(a,a.j,p,a.D+1),a.u===null&&(p.J=a.o),d&&(a.i=d.G.concat(a.i)),d=Yd(a,p,1e3),p.H=Math.round(a.va*.5)+Math.round(a.va*.5*Math.random()),Ja(a.h,p),Ha(p,y,d)}function Ns(a,d){a.H&&Vi(a.H,function(p,y){_e(d,y,p)}),a.l&&Vi({},function(p,y){_e(d,y,p)})}function Yd(a,d,p){p=Math.min(a.i.length,p);const y=a.l?u(a.l.Ka,a.l,a):null;e:{var k=a.i;let te=-1;for(;;){const Ve=["count="+p];te==-1?p>0?(te=k[0].g,Ve.push("ofs="+te)):te=0:Ve.push("ofs="+te);let ge=!0;for(let Ne=0;Ne<p;Ne++){var V=k[Ne].g;const At=k[Ne].map;if(V-=te,V<0)te=Math.max(0,k[Ne].g-100),ge=!1;else try{V="req"+V+"_"||"";try{var $=At instanceof Map?At:Object.entries(At);for(const[Ln,rn]of $){let sn=rn;c(rn)&&(sn=Fa(rn)),Ve.push(V+Ln+"="+encodeURIComponent(sn))}}catch(Ln){throw Ve.push(V+"type="+encodeURIComponent("_badmap")),Ln}}catch{y&&y(At)}}if(ge){$=Ve.join("&");break e}}$=void 0}return a=a.i.splice(0,p),d.G=a,$}function Xd(a){if(!a.g&&!a.v){a.Y=1;var d=a.Da;x||_(),U||(x(),U=!0),T.add(d,a),a.A=0}}function Za(a){return a.g||a.v||a.A>=3?!1:(a.Y++,a.v=Is(u(a.Da,a),th(a,a.A)),a.A++,!0)}t.Da=function(){if(this.v=null,Zd(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var a=4*this.T;this.j.info("BP detection timer enabled: "+a),this.B=Is(u(this.Wa,this),a)}},t.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,Ze(10),Bi(this),Zd(this))};function ec(a){a.B!=null&&(o.clearTimeout(a.B),a.B=null)}function Zd(a){a.g=new Zt(a,a.j,"rpc",a.Y),a.u===null&&(a.g.J=a.o),a.g.P=0;var d=vt(a.na);_e(d,"RID","rpc"),_e(d,"SID",a.M),_e(d,"AID",a.K),_e(d,"CI",a.F?"0":"1"),!a.F&&a.ia&&_e(d,"TO",a.ia),_e(d,"TYPE","xmlhttp"),Ns(a,d),a.u&&a.o&&Ya(d,a.u,a.o),a.O&&(a.g.H=a.O);var p=a.g;a=a.ba,p.M=1,p.A=Ui(vt(d)),p.u=null,p.R=!0,Rd(p,a)}t.Va=function(){this.C!=null&&(this.C=null,Bi(this),Za(this),Ze(19))};function zi(a){a.C!=null&&(o.clearTimeout(a.C),a.C=null)}function eh(a,d){var p=null;if(a.g==d){zi(a),ec(a),a.g=null;var y=2}else if(Wa(a.h,d))p=d.G,Dd(a.h,d),y=1;else return;if(a.I!=0){if(d.o)if(y==1){p=d.u?d.u.length:0,d=Date.now()-d.F;var k=a.D;y=Li(),Xe(y,new Id(y,p)),ji(a)}else Xd(a);else if(k=d.m,k==3||k==0&&d.X>0||!(y==1&&X0(a,d)||y==2&&Za(a)))switch(p&&p.length>0&&(d=a.h,d.i=d.i.concat(p)),k){case 1:Nn(a,5);break;case 4:Nn(a,10);break;case 3:Nn(a,6);break;default:Nn(a,2)}}}function th(a,d){let p=a.Qa+Math.floor(Math.random()*a.Za);return a.isActive()||(p*=2),p*d}function Nn(a,d){if(a.j.info("Error code "+d),d==2){var p=u(a.bb,a),y=a.Ua;const k=!y;y=new en(y||"//www.google.com/images/cleardot.gif"),o.location&&o.location.protocol=="http"||Cs(y,"https"),Ui(y),k?G0(y.toString(),p):W0(y.toString(),p)}else Ze(2);a.I=0,a.l&&a.l.pa(d),nh(a),Kd(a)}t.bb=function(a){a?(this.j.info("Successfully pinged google.com"),Ze(2)):(this.j.info("Failed to ping google.com"),Ze(1))};function nh(a){if(a.I=0,a.ja=[],a.l){const d=Nd(a.h);(d.length!=0||a.i.length!=0)&&(E(a.ja,d),E(a.ja,a.i),a.h.i.length=0,w(a.i),a.i.length=0),a.l.oa()}}function rh(a,d,p){var y=p instanceof en?vt(p):new en(p);if(y.g!="")d&&(y.g=d+"."+y.g),Rs(y,y.u);else{var k=o.location;y=k.protocol,d=d?d+"."+k.hostname:k.hostname,k=+k.port;const V=new en(null);y&&Cs(V,y),d&&(V.g=d),k&&Rs(V,k),p&&(V.h=p),y=V}return p=a.G,d=a.wa,p&&d&&_e(y,p,d),_e(y,"VER",a.ka),Ns(a,y),y}function sh(a,d,p){if(d&&!a.L)throw Error("Can't create secondary domain capable XhrIo object.");return d=a.Aa&&!a.ma?new Ee(new Qa({ab:p})):new Ee(a.ma),d.Fa(a.L),d}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function ih(){}t=ih.prototype,t.ra=function(){},t.qa=function(){},t.pa=function(){},t.oa=function(){},t.isActive=function(){return!0},t.Ka=function(){};function Hi(){}Hi.prototype.g=function(a,d){return new rt(a,d)};function rt(a,d){Be.call(this),this.g=new Jd(d),this.l=a,this.h=d&&d.messageUrlParams||null,a=d&&d.messageHeaders||null,d&&d.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=d&&d.initMessageHeaders||null,d&&d.messageContentType&&(a?a["X-WebChannel-Content-Type"]=d.messageContentType:a={"X-WebChannel-Content-Type":d.messageContentType}),d&&d.sa&&(a?a["X-WebChannel-Client-Profile"]=d.sa:a={"X-WebChannel-Client-Profile":d.sa}),this.g.U=a,(a=d&&d.Qb)&&!b(a)&&(this.g.u=a),this.A=d&&d.supportsCrossDomainXhr||!1,this.v=d&&d.sendRawJson||!1,(d=d&&d.httpSessionIdParam)&&!b(d)&&(this.g.G=d,a=this.h,a!==null&&d in a&&(a=this.h,d in a&&delete a[d])),this.j=new Ir(this)}f(rt,Be),rt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},rt.prototype.close=function(){Xa(this.g)},rt.prototype.o=function(a){var d=this.g;if(typeof a=="string"){var p={};p.__data__=a,a=p}else this.v&&(p={},p.__data__=Fa(a),a=p);d.i.push(new U0(d.Ya++,a)),d.I==3&&ji(d)},rt.prototype.N=function(){this.g.l=null,delete this.j,Xa(this.g),delete this.g,rt.Z.N.call(this)};function oh(a){$a.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var d=a.__sm__;if(d){e:{for(const p in d){a=p;break e}a=void 0}(this.i=a)&&(a=this.i,d=d!==null&&a in d?d[a]:void 0),this.data=d}else this.data=a}f(oh,$a);function ah(){Ba.call(this),this.status=1}f(ah,Ba);function Ir(a){this.g=a}f(Ir,ih),Ir.prototype.ra=function(){Xe(this.g,"a")},Ir.prototype.qa=function(a){Xe(this.g,new oh(a))},Ir.prototype.pa=function(a){Xe(this.g,new ah)},Ir.prototype.oa=function(){Xe(this.g,"b")},Hi.prototype.createWebChannel=Hi.prototype.g,rt.prototype.send=rt.prototype.o,rt.prototype.open=rt.prototype.m,rt.prototype.close=rt.prototype.close,zm=function(){return new Hi},jm=function(){return Li()},Bm=Pn,nl={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Mi.NO_ERROR=0,Mi.TIMEOUT=8,Mi.HTTP_ERROR=6,lo=Mi,Ed.COMPLETE="complete",$m=Ed,_d.EventType=ws,ws.OPEN="a",ws.CLOSE="b",ws.ERROR="c",ws.MESSAGE="d",Be.prototype.listen=Be.prototype.J,zs=_d,Ee.prototype.listenOnce=Ee.prototype.K,Ee.prototype.getLastError=Ee.prototype.Ha,Ee.prototype.getLastErrorCode=Ee.prototype.ya,Ee.prototype.getStatus=Ee.prototype.ca,Ee.prototype.getResponseJson=Ee.prototype.La,Ee.prototype.getResponseText=Ee.prototype.la,Ee.prototype.send=Ee.prototype.ea,Ee.prototype.setWithCredentials=Ee.prototype.Fa,Fm=Ee}).apply(typeof Ji<"u"?Ji:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let cs="12.8.0";function wA(t){cs=t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xe(t,e){const n={typeString:t};return e&&(n.value=e),n}function Ai(t,e){if(!Wm(t))throw new B(L.INVALID_ARGUMENT,"JSON must be an object");let n;for(const r in e)if(e[r]){const s=e[r].typeString,i="value"in e[r]?{value:e[r].value}:void 0;if(!(r in t)){n=`JSON missing required field: '${r}'`;break}const o=t[r];if(s&&typeof o!==s){n=`JSON field '${r}' must be a ${s}.`;break}if(i!==void 0&&o!==i.value){n=`Expected '${r}' field to equal '${i.value}'`;break}}if(n)throw new B(L.INVALID_ARGUMENT,n);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ai=-1;function VA(t,e){const n=t.toTimestamp().seconds,r=t.toTimestamp().nanoseconds+1,s=X.fromTimestamp(r===1e9?new be(n+1,0):new be(n,r));return new En(s,W.empty(),e)}function DA(t){return new En(t.readTime,t.key,ai)}class En{constructor(e,n,r){this.readTime=e,this.documentKey=n,this.largestBatchId=r}static min(){return new En(X.min(),W.empty(),ai)}static max(){return new En(X.max(),W.empty(),ai)}}function NA(t,e){let n=t.readTime.compareTo(e.readTime);return n!==0?n:(n=W.comparator(t.documentKey,e.documentKey),n!==0?n:se(t.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ls(t){if(t.code!==L.FAILED_PRECONDITION||t.message!==LA)throw t;j("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uu=-1;function la(t){return t==null}function xo(t){return t===0&&1/t==-1/0}function UA(t){return typeof t=="number"&&Number.isInteger(t)&&!xo(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jm="";function FA(t){let e="";for(let n=0;n<t.length;n++)e.length>0&&(e=sf(e)),e=$A(t.get(n),e);return sf(e)}function $A(t,e){let n=e;const r=t.length;for(let s=0;s<r;s++){const i=t.charAt(s);switch(i){case"\0":n+="";break;case Jm:n+="";break;default:n+=i}}return n}function sf(t){return t+Jm+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jA{constructor(e,n,r,s,i,o,c,l,u,h,f){this.databaseId=e,this.appId=n,this.persistenceKey=r,this.host=s,this.ssl=i,this.forceLongPolling=o,this.autoDetectLongPolling=c,this.longPollingOptions=l,this.useFetchStreams=u,this.isUsingEmulator=h,this.apiKey=f}}const Po="(default)";class li{constructor(e,n){this.projectId=e,this.database=n||Po}static empty(){return new li("","")}get isDefaultDatabase(){return this.database===Po}isEqual(e){return e instanceof li&&e.projectId===this.projectId&&e.database===this.database}}function zA(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new B(L.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new li(t.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class at{constructor(e){this.value=e}static empty(){return new at({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let n=this.value;for(let r=0;r<e.length-1;++r)if(n=(n.mapValue.fields||{})[e.get(r)],!ho(n))return null;return n=(n.mapValue.fields||{})[e.lastSegment()],n||null}}set(e,n){this.getFieldsMap(e.popLast())[e.lastSegment()]=Ys(n)}setAll(e){let n=Ue.emptyPath(),r={},s=[];e.forEach(((o,c)=>{if(!n.isImmediateParentOf(c)){const l=this.getFieldsMap(n);this.applyChanges(l,r,s),r={},s=[],n=c.popLast()}o?r[c.lastSegment()]=Ys(o):s.push(c.lastSegment())}));const i=this.getFieldsMap(n);this.applyChanges(i,r,s)}delete(e){const n=this.field(e.popLast());ho(n)&&n.mapValue.fields&&delete n.mapValue.fields[e.lastSegment()]}isEqual(e){return Nt(this.value,e.value)}getFieldsMap(e){let n=this.value;n.mapValue.fields||(n.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=n.mapValue.fields[e.get(r)];ho(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},n.mapValue.fields[e.get(r)]=s),n=s}return n.mapValue.fields}applyChanges(e,n,r){pr(n,((s,i)=>e[s]=i));for(const s of r)delete e[s]}clone(){return new at(Ys(this.value))}}function ry(t){const e=[];return pr(t.fields,((n,r)=>{const s=new Ue([n]);if(ho(r)){const i=ry(r.mapValue).fields;if(i.length===0)e.push(s);else for(const o of i)e.push(s.child(o))}else e.push(s)})),new pt(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cC=new Ie(W.comparator);function Jt(){return cC}const fy=new Ie(W.comparator);function Hs(...t){let e=fy;for(const n of t)e=e.insert(n.key,n);return e}function py(t){let e=fy;return t.forEach(((n,r)=>e=e.insert(n,r.overlayedDocument))),e}function tr(){return Zs()}function gy(){return Zs()}function Zs(){return new gr((t=>t.toString()),((t,e)=>t.isEqual(e)))}const lC=new Ie(W.comparator),uC=new De(W.comparator);function ie(...t){let e=uC;for(const n of t)e=e.add(n);return e}const dC=new De(se);function hC(){return dC}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gu(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:xo(e)?"-0":e}}function my(t){return{integerValue:""+t}}function fC(t,e){return UA(e)?my(e):gu(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o2{constructor(){this.sessionToken=Fe.EMPTY_BYTE_STRING}getSessionToken(e){return M.resolve(this.sessionToken)}setSessionToken(e,n){return this.sessionToken=n,M.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class f2{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=(function(){return eE()?8:OA(Ke())>0?6:4})()}initialize(e,n){this.fs=e,this.indexManager=n,this.Rs=!0}getDocumentsMatchingQuery(e,n,r,s){const i={result:null};return this.gs(e,n).next((o=>{i.result=o})).next((()=>{if(!i.result)return this.ps(e,n,s,r).next((o=>{i.result=o}))})).next((()=>{if(i.result)return;const o=new h2;return this.ys(e,n,o).next((c=>{if(i.result=c,this.As)return this.ws(e,n,o,c.size)}))})).next((()=>i.result))}ws(e,n,r,s){return r.documentReadCount<this.Vs?(Mr()<=re.DEBUG&&j("QueryEngine","SDK will not create cache indexes for query:",Or(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),M.resolve()):(Mr()<=re.DEBUG&&j("QueryEngine","Query:",Or(n),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.ds*s?(Mr()<=re.DEBUG&&j("QueryEngine","The SDK decides to create cache indexes for query:",Or(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,kt(n))):M.resolve())}gs(e,n){if(mf(n))return M.resolve(null);let r=kt(n);return this.indexManager.getIndexType(e,r).next((s=>s===0?null:(n.limit!==null&&s===1&&(n=ll(n,null,"F"),r=kt(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next((i=>{const o=ie(...i);return this.fs.getDocuments(e,o).next((c=>this.indexManager.getMinOffset(e,r).next((l=>{const u=this.bs(n,c);return this.Ss(n,u,o,l.readTime)?this.gs(e,ll(n,null,"F")):this.Ds(e,u,n,l)}))))})))))}ps(e,n,r,s){return mf(n)||s.isEqual(X.min())?M.resolve(null):this.fs.getDocuments(e,r).next((i=>{const o=this.bs(n,i);return this.Ss(n,o,r,s)?M.resolve(null):(Mr()<=re.DEBUG&&j("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Or(n)),this.Ds(e,o,n,VA(s,ai)).next((c=>c)))}))}bs(e,n){let r=new De(hy(e));return n.forEach(((s,i)=>{fa(e,i)&&(r=r.add(i))})),r}Ss(e,n,r,s){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}ys(e,n,r){return Mr()<=re.DEBUG&&j("QueryEngine","Using full collection scan to execute query:",Or(n)),this.fs.getDocumentsMatchingQuery(e,n,En.min(),r)}Ds(e,n,r,s){return this.fs.getDocumentsMatchingQuery(e,r,s).next((i=>(n.forEach((o=>{i=i.insert(o.key,o)})),i)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pf="ConnectivityMonitor";class Vf{constructor(){this.xo=()=>this.Oo(),this.No=()=>this.Bo(),this.Lo=[],this.ko()}Mo(e){this.Lo.push(e)}shutdown(){window.removeEventListener("online",this.xo),window.removeEventListener("offline",this.No)}ko(){window.addEventListener("online",this.xo),window.addEventListener("offline",this.No)}Oo(){j(Pf,"Network connectivity changed: AVAILABLE");for(const e of this.Lo)e(0)}Bo(){j(Pf,"Network connectivity changed: UNAVAILABLE");for(const e of this.Lo)e(1)}static v(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const je="WebChannelConnection",Ls=(t,e,n)=>{t.listen(e,(r=>{try{n(r)}catch(s){setTimeout((()=>{throw s}),0)}}))};class qr extends C2{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!qr.c_){const e=jm();Ls(e,Bm.STAT_EVENT,(n=>{n.stat===nl.PROXY?j(je,"STAT_EVENT: detected buffering proxy"):n.stat===nl.NOPROXY&&j(je,"STAT_EVENT: detected no buffering proxy")})),qr.c_=!0}}zo(e,n,r,s,i){const o=gl();return new Promise(((c,l)=>{const u=new Fm;u.setWithCredentials(!0),u.listenOnce($m.COMPLETE,(()=>{try{switch(u.getLastErrorCode()){case lo.NO_ERROR:const f=u.getResponseJson();j(je,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(f)),c(f);break;case lo.TIMEOUT:j(je,`RPC '${e}' ${o} timed out`),l(new B(L.DEADLINE_EXCEEDED,"Request time out"));break;case lo.HTTP_ERROR:const g=u.getStatus();if(j(je,`RPC '${e}' ${o} failed with status:`,g,"response text:",u.getResponseText()),g>0){let w=u.getResponseJson();Array.isArray(w)&&(w=w[0]);const E=w==null?void 0:w.error;if(E&&E.status&&E.message){const v=(function(D){const P=D.toLowerCase().replace(/_/g,"-");return Object.values(L).indexOf(P)>=0?P:L.UNKNOWN})(E.status);l(new B(v,E.message))}else l(new B(L.UNKNOWN,"Server responded with status "+u.getStatus()))}else l(new B(L.UNAVAILABLE,"Connection failed."));break;default:J(9055,{l_:e,streamId:o,h_:u.getLastErrorCode(),P_:u.getLastError()})}}finally{j(je,`RPC '${e}' ${o} completed.`)}}));const h=JSON.stringify(s);j(je,`RPC '${e}' ${o} sending request:`,s),u.send(n,"POST",h,r,15)}))}T_(e,n,r){const s=gl(),i=[this.qo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=this.createWebChannelTransport(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},l=this.longPollingOptions.timeoutSeconds;l!==void 0&&(c.longPollingTimeout=Math.round(1e3*l)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Go(c.initMessageHeaders,n,r),c.encodeInitMessageHeaders=!0;const u=i.join("");j(je,`Creating RPC '${e}' stream ${s}: ${u}`,c);const h=o.createWebChannel(u,c);this.I_(h);let f=!1,g=!1;const w=new R2({Ho:E=>{g?j(je,`Not sending because RPC '${e}' stream ${s} is closed:`,E):(f||(j(je,`Opening RPC '${e}' stream ${s} transport.`),h.open(),f=!0),j(je,`RPC '${e}' stream ${s} sending:`,E),h.send(E))},Jo:()=>h.close()});return Ls(h,zs.EventType.OPEN,(()=>{g||(j(je,`RPC '${e}' stream ${s} transport opened.`),w.i_())})),Ls(h,zs.EventType.CLOSE,(()=>{g||(g=!0,j(je,`RPC '${e}' stream ${s} transport closed`),w.o_(),this.E_(h))})),Ls(h,zs.EventType.ERROR,(E=>{g||(g=!0,Kr(je,`RPC '${e}' stream ${s} transport errored. Name:`,E.name,"Message:",E.message),w.o_(new B(L.UNAVAILABLE,"The operation could not be completed")))})),Ls(h,zs.EventType.MESSAGE,(E=>{var v;if(!g){const N=E.data[0];de(!!N,16349);const D=N,P=(D==null?void 0:D.error)||((v=D[0])==null?void 0:v.error);if(P){j(je,`RPC '${e}' stream ${s} received error:`,P);const R=P.status;let F=(function(T){const _=ke[T];if(_!==void 0)return Ey(_)})(R),x=P.message;F===void 0&&(F=L.INTERNAL,x="Unknown error status: "+R+" with message "+P.message),g=!0,w.o_(new B(F,x)),h.close()}else j(je,`RPC '${e}' stream ${s} received:`,N),w.__(N)}})),qr.u_(),setTimeout((()=>{w.s_()}),0),w}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}I_(e){this.a_.push(e)}E_(e){this.a_=this.a_.filter((n=>n===e))}Go(e,n,r){super.Go(e,n,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return zm()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IR="ComponentProvider",Bf=new Map;function ER(t,e,n,r,s){return new jA(t,e,n,s.host,s.ssl,s.experimentalForceLongPolling,s.experimentalAutoDetectLongPolling,t_(s.experimentalLongPollingOptions),s.useFetchStreams,s.isUsingEmulator,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ct{constructor(e){this._byteString=e}static fromBase64String(e){try{return new ct(Fe.fromBase64String(e))}catch(n){throw new B(L.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new ct(Fe.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:ct._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(Ai(e,ct._jsonSchema))return ct.fromBase64String(e.bytes)}}ct._jsonSchemaVersion="firestore/bytes/1.0",ct._jsonSchema={type:xe("string",ct._jsonSchemaVersion),bytes:xe("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r_{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new B(L.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ue(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xt{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new B(L.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new B(L.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return se(this._lat,e._lat)||se(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:xt._jsonSchemaVersion}}static fromJSON(e){if(Ai(e,xt._jsonSchema))return new xt(e.latitude,e.longitude)}}xt._jsonSchemaVersion="firestore/geoPoint/1.0",xt._jsonSchema={type:xe("string",xt._jsonSchemaVersion),latitude:xe("number"),longitude:xe("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const RR=/^__.*__$/;class kR{constructor(e,n,r){this.data=e,this.fieldMask=n,this.fieldTransforms=r}toMutation(e,n){return this.fieldMask!==null?new mr(e,this.data,this.fieldMask,n,this.fieldTransforms):new Ri(e,this.data,n,this.fieldTransforms)}}function s_(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw J(40011,{dataSource:t})}}class Uu{constructor(e,n,r,s,i,o){this.settings=e,this.databaseId=n,this.serializer=r,this.ignoreUndefinedProperties=s,i===void 0&&this.validatePath(),this.fieldTransforms=i||[],this.fieldMask=o||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}contextWith(e){return new Uu({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}childContextForField(e){var s;const n=(s=this.path)==null?void 0:s.child(e),r=this.contextWith({path:n,arrayElement:!1});return r.validatePathSegment(e),r}childContextForFieldPath(e){var s;const n=(s=this.path)==null?void 0:s.child(e),r=this.contextWith({path:n,arrayElement:!1});return r.validatePath(),r}childContextForArray(e){return this.contextWith({path:void 0,arrayElement:!0})}createError(e){return Bo(e,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(e){return this.fieldMask.find((n=>e.isPrefixOf(n)))!==void 0||this.fieldTransforms.find((n=>e.isPrefixOf(n.field)))!==void 0}validatePath(){if(this.path)for(let e=0;e<this.path.length;e++)this.validatePathSegment(this.path.get(e))}validatePathSegment(e){if(e.length===0)throw this.createError("Document fields must not be empty");if(s_(this.dataSource)&&RR.test(e))throw this.createError('Document fields cannot begin and end with "__"')}}class SR{constructor(e,n,r){this.databaseId=e,this.ignoreUndefinedProperties=n,this.serializer=r||ya(e)}createContext(e,n,r,s=!1){return new Uu({dataSource:e,methodName:n,targetDoc:r,path:Ue.emptyPath(),arrayElement:!1,hasConverter:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Fu(t){const e=t._freezeSettings(),n=ya(t._databaseId);return new SR(t._databaseId,!!e.ignoreUndefinedProperties,n)}function i_(t,e,n,r,s,i={}){const o=t.createContext(i.merge||i.mergeFields?2:0,e,n,s);c_("Data must be an object, but it was:",o,r);const c=o_(r,o);let l,u;if(i.merge)l=new pt(o.fieldMask),u=o.fieldTransforms;else if(i.mergeFields){const h=[];for(const f of i.mergeFields){const g=Ia(e,f,n);if(!o.contains(g))throw new B(L.INVALID_ARGUMENT,`Field '${g}' is specified in your field mask but missing from your input data.`);DR(h,g)||h.push(g)}l=new pt(h),u=o.fieldTransforms.filter((f=>l.covers(f.field)))}else l=null,u=o.fieldTransforms;return new kR(new at(c),l,u)}class $u extends Ou{_toFieldTransform(e){return new mC(e.path,new di)}isEqual(e){return e instanceof $u}}function xR(t,e,n,r=!1){return Bu(n,t.createContext(r?4:3,e))}function Bu(t,e){if(a_(t=Qe(t)))return c_("Unsupported field value:",e,t),o_(t,e);if(t instanceof Ou)return(function(r,s){if(!s_(s.dataSource))throw s.createError(`${r._methodName}() can only be used with update() and set()`);if(!s.path)throw s.createError(`${r._methodName}() is not currently supported inside arrays`);const i=r._toFieldTransform(s);i&&s.fieldTransforms.push(i)})(t,e),null;if(t===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.arrayElement&&e.dataSource!==4)throw e.createError("Nested arrays are not supported");return(function(r,s){const i=[];let o=0;for(const c of r){let l=Bu(c,s.childContextForArray(o));l==null&&(l={nullValue:"NULL_VALUE"}),i.push(l),o++}return{arrayValue:{values:i}}})(t,e)}return(function(r,s){if((r=Qe(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return fC(s.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const i=be.fromDate(r);return{timestampValue:Mo(s.serializer,i)}}if(r instanceof be){const i=new be(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:Mo(s.serializer,i)}}if(r instanceof xt)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof ct)return{bytesValue:Cy(s.serializer,r._byteString)};if(r instanceof Re){const i=s.databaseId,o=r.firestore._databaseId;if(!o.isEqual(i))throw s.createError(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${i.projectId}/${i.database}`);return{referenceValue:bu(r.firestore._databaseId||s.databaseId,r._key.path)}}if(r instanceof _t)return(function(o,c){const l=o instanceof _t?o.toArray():o;return{mapValue:{fields:{[ty]:{stringValue:ny},[Vo]:{arrayValue:{values:l.map((h=>{if(typeof h!="number")throw c.createError("VectorValues must only contain numeric values.");return gu(c.serializer,h)}))}}}}}})(r,s);if(Dy(r))return r._toProto(s.serializer);throw s.createError(`Unsupported field value: ${aa(r)}`)})(t,e)}function o_(t,e){const n={};return Km(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):pr(t,((r,s)=>{const i=Bu(s,e.childContextForField(r));i!=null&&(n[r]=i)})),{mapValue:{fields:n}}}function a_(t){return!(typeof t!="object"||t===null||t instanceof Array||t instanceof Date||t instanceof be||t instanceof xt||t instanceof ct||t instanceof Re||t instanceof Ou||t instanceof _t||Dy(t))}function c_(t,e,n){if(!a_(n)||!Wm(n)){const r=aa(n);throw r==="an object"?e.createError(t+" a custom object"):e.createError(t+" "+r)}}function Ia(t,e,n){if((e=Qe(e))instanceof r_)return e._internalPath;if(typeof e=="string")return VR(t,e);throw Bo("Field path arguments must be of type string or ",t,!1,void 0,n)}const PR=new RegExp("[~\\*/\\[\\]]");function VR(t,e,n){if(e.search(PR)>=0)throw Bo(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new r_(...e.split("."))._internalPath}catch{throw Bo(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function Bo(t,e,n,r,s){const i=r&&!r.isEmpty(),o=s!==void 0;let c=`Function ${e}() called with invalid data`;n&&(c+=" (via `toFirestore()`)"),c+=". ";let l="";return(i||o)&&(l+=" (found",i&&(l+=` in field ${r}`),o&&(l+=` in document ${s}`),l+=")"),new B(L.INVALID_ARGUMENT,c+t+l)}function DR(t,e){return t.some((n=>n.isEqual(e)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ju extends NR{constructor(e){super(),this.firestore=e}convertBytes(e){return new ct(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Re(this.firestore,null,n)}}function Pe(){return new $u("serverTimestamp")}const Wf="@firebase/firestore",Jf="4.10.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${e}`),h=>H_(r,s,l,t))})},H_=O((t,e,n,r)=>(H_.inputs(s=>{[t,e,n,r]=s,n=K(n)}),[()=>t==="authorized"?r(n):m(Sa({status:t,userEmail:e,adminEmail:"",onSignIn:()=>Qu().catch(s=>console.error("Failed to sign in",s)),onSignOut:()=>(t="login",dt().catch(s=>console.error("Failed to sign out",s)))}))])),Pa=O(({value:t,games:e,isLoaded:n,fieldError:r,onChange:s})=>{Pa.inputs(o=>{[{value:t,games:e,isLoaded:n,fieldError:r,onChange:s}]=o,s=K(s)});const i=()=>r?"#f87171":"rgba(255,255,255,0.2)";return m.class`admin-field-with-link`(Gl.value(o=>t||"").onChange(o=>{var c;s(((c=o==null?void 0:o.target)==null?void 0:c.value)||"")}).attr("aria-invalid",o=>r?"true":"false").attr("title",o=>r||"").attr("style.borderColor",o=>i())(o=>Rk(t,e,n)),q.href`/admin/games.html`.class`admin-inline-edit-link`("edit games"))}),Rk=(t,e,n)=>{const r=Sk(e),s=!t||e.some(i=>i.id===t);return[nr.value``(i=>kk(e,n)),s?"":nr.value`${t}`(`Missing game: ${t}`),r.map(({manufacturer:i,items:o})=>SI.label(i)(o.map(c=>nr.value`${c.id}`(xk(c)))))]},kk=(t,e)=>e?t.length?"Select a game":"Add games first":"Loading games...",Sk=t=>{const e=new Map;return t.forEach(n=>{const r=String(n.manufacturer||"Unknown Manufacturer").trim()||"Unknown Manufacturer";e.set(r,[...e.get(r)||[],n])}),[...e.entries()].sort(([n],[r])=>n.localeCompare(r,void 0,{sensitivity:"base"})).map(([n,r])=>({manufacturer:n,items:[...r].sort((s,i)=>String(s.title||"").localeCompare(String(i.title||""),void 0,{sensitivity:"base"}))}))},xk=t=>[t.title||"Untitled game",t.yearReleased?String(t.yearReleased):""].filter(Boolean).join(" - "),vc=()=>({gameId:"",dateAddedToCollection:"",notes:"",isVisible:!0});let Ac=!1,Os=null,cn=null,Mn=null,Zi=null,ln=null,On=null;const AS=br(t=>q_(t)),q_=O(t=>{q_.inputs(([x])=>{t=K(x)});const e=()=>dt().then(t).catch(x=>{console.error("Failed to sign out",x)});let n=!1,r=!1,s="",i={},o=!1,c=null,l=vc(),u=Os,h=Zi;const f=me(()=>{}),g=()=>{cn&&(cn(),cn=null),Mn&&(Mn(),Mn=null),u=null,Os=null,s="",f();const x=rk();cn=(x==null?void 0:x.unsubscribe)||null;const U=x.subscribe(T=>{u=T,Os=T,console.debug("Current games list updated",{count:(T==null?void 0:T.length)||0,items:T}),f()});Mn=()=>U.unsubscribe()},w=()=>{ln&&(ln(),ln=null),On&&(On(),On=null),h=null,Zi=null,f();const x=ms();ln=(x==null?void 0:x.unsubscribe)||null;const U=x.subscribe(T=>{h=T,Zi=T,console.debug("Game library updated",{count:(T==null?void 0:T.length)||0,items:T}),f()});On=()=>U.unsubscribe()},E=()=>ik().then(x=>{console.debug("Current games list refreshed",{count:x.length,items:x}),u=x,Os=x,f()}).catch(x=>{console.error("Failed to refresh current games list",x),s="Saved, but failed to refresh the game list. Reload the page to confirm.",f()}),v=()=>{c=null,l=vc(),s="",i={},o=!0,f()},N=x=>{c=x.id,l={id:x.id,gameId:x.gameId||"",title:x.title||"",dateAddedToCollection:J_(x.dateAddedToCollection),imageUrl:x.imageUrl||"",manufacturer:x.manufacturer||"",yearReleased:cp(x.yearReleased),notes:x.notes||"",isVisible:x.isVisible!==!1},s="",i={},o=!0,f()},D=()=>{n||r||(c=null,l=vc(),s="",i={},o=!1,f())},P=()=>{const x={};!l.gameId&&!(l.title||"").trim()&&(x.gameId="Game is required."),l.dateAddedToCollection||(x.dateAddedToCollection="Date Added to Collection is required."),l.yearReleased!==null&&typeof l.yearReleased<"u"&&Number.isNaN(Number(l.yearReleased))&&(x.yearReleased="Year Released must be numeric."),i=x;const U=Object.values(x);return U.length?U[0]:""},R=()=>{if(n){console.debug("Current game save ignored because a save is already running");return}const x=P();if(x){s=x,console.warn("Current game save blocked by validation",{fieldErrors:i,game:l}),f();return}n=!0,s="",i={},f(),console.debug("Saving current game",{id:c||null,game:l}),O.promise=ok({...l,id:c||void 0,gameId:(l.gameId||"").trim(),title:(l.title||"").trim(),imageUrl:(l.imageUrl||"").trim(),manufacturer:(l.manufacturer||"").trim(),notes:(l.notes||"").trim(),yearReleased:cp(l.yearReleased),isVisible:l.isVisible!==!1}).then(()=>(console.debug("Current game saved",{id:c||null}),n=!1,D(),E())).catch(U=>{console.error("Failed to save current game",U),s="Failed to save game. Check the fields and try again.",f()}).finally(()=>{n=!1,f()})},F=()=>{!c||r||confirm("Delete this game from the current lineup?")&&(r=!0,s="",f(),O.promise=ak(c).then(()=>(r=!1,D(),E())).catch(x=>{console.error("Failed to delete current game",x),s="Failed to delete game.",f()}).finally(()=>{r=!1,f()}))};return Ac||(Ac=!0,cn||g(),ln||w()),Kt(()=>{cn&&(cn(),cn=null),Mn&&(Mn(),Mn=null),ln&&(ln(),ln=null),On&&(On(),On=null),Ac=!1,Os=null,Zi=null}),ve(Ye(()=>Lt(e)),m.class`admin-crud-page`(m.class`admin-crud-header`(et("⚪️ Current Game Lineup"),G.type`button`.class`admin-pill-button`.onClick(v)("Add")),m.class`admin-crud-card`(oe.style`margin-top:0;opacity:0.78;`("Manage the Firestore currentGames collection used by the public lineup page."),x=>s&&!o?oe.style`color:#f6c177;`(s):"",m.class`admin-crud-list`(x=>u===null?z.style`opacity:0.7;`("Loading games..."):u.length?u.map(U=>G_({game:Pk(U,h||[]),onClick:N}).key(U.id)):z.style`opacity:0.7;`("No games found. Use Add Game to create the first one.")),m.style`margin-top:1em;display:flex;gap:0.75em;flex-wrap:wrap;`(q.href`../lineup.html`.class`admin-secondary-button`("View Public Lineup"))),x=>o?W_({isEditing:!!c,editGame:l,gameLibrary:h||[],isGameLibraryLoaded:h!==null,errorMessage:s,fieldErrors:i,isSaving:n,isDeleting:r,onChange:U=>{var T;l=U,i={...i,gameId:U.gameId||(T=U.title)!=null&&T.trim()?"":i.gameId,dateAddedToCollection:U.dateAddedToCollection?"":i.dateAddedToCollection,yearReleased:U.yearReleased===null||!Number.isNaN(Number(U.yearReleased))?"":i.yearReleased},f()},onSave:R,onDelete:F,onCancel:D}):""))}),G_=O(({game:t,onClick:e})=>(G_.inputs(n=>{[{game:t,onClick:e}]=n,e=K(e)}),G.type`button`.class`admin-crud-row`.onClick(()=>e(t))(n=>t.imageUrl?Y.class`admin-crud-thumb`.src`${t.imageUrl}`.attr("alt",r=>t.title||"Game image"):m.class`admin-crud-thumb admin-crud-thumb-placeholder`("PB"),m(fr(n=>t.title||"Untitled game"),m.style`margin-top:0.15em;opacity:0.74;`(z(n=>[t.manufacturer||"",t.yearReleased?String(t.yearReleased):""].filter(Boolean).join(" · ")||"No manufacturer/year"))),z.style`opacity:0.62;text-align:right;display:grid;gap:0.1em;`(Z.style`font-size:0.78em;text-transform:uppercase;`("Collected Date"),Z(n=>[Vk(t.dateAddedToCollection),t.isVisible===!1?" · Hidden":""].join("")))))),Pk=(t,e)=>{const n=e.find(r=>r.id===t.gameId);return{...t,title:(n==null?void 0:n.title)||t.title||"",imageUrl:(n==null?void 0:n.imageUrl)||t.imageUrl||"",manufacturer:(n==null?void 0:n.manufacturer)||t.manufacturer||"",yearReleased:(n==null?void 0:n.yearReleased)??t.yearReleased??null}},W_=O(({isEditing:t,editGame:e,gameLibrary:n,isGameLibraryLoaded:r,errorMessage:s,fieldErrors:i,isSaving:o,isDeleting:c,onChange:l,onSave:u,onDelete:h,onCancel:f})=>{W_.inputs(v=>{[{isEditing:t,editGame:e,gameLibrary:n,isGameLibraryLoaded:r,errorMessage:s,fieldErrors:i,isSaving:o,isDeleting:c,onChange:l,onSave:u,onDelete:h,onCancel:f}]=v,l=K(l),u=K(u),h=K(h),f=K(f)});const g=v=>{l({...e,...v})},w=v=>i[v]?"#f87171":"rgba(255,255,255,0.2)",E=v=>i[v]?"#fca5a5":"inherit";return m.class`admin-crud-modal-backdrop`(m.class`admin-crud-modal`(m.style`display:flex;justify-content:space-between;gap:1em;align-items:flex-start;`(m(et.style`margin:0;`(t?"Edit Game":"Add Game"),z.style`opacity:0.72;`(t?"Update this current lineup entry.":"Create a new current lineup entry.")),G.type`button`.class`admin-secondary-button`.onClick(f)("Cancel")),v=>s?oe.style`color:#f6c177;`(s):"",v=>Object.values(i).filter(Boolean).length?m.style`border:1px solid rgba(248,113,113,0.5);background:rgba(127,29,29,0.25);border-radius:0.55em;padding:0.6em;margin-top:0.75em;color:#fecaca;display:grid;gap:0.2em;`(Object.values(i).filter(Boolean).map(N=>z(N))):"",m.class`admin-crud-form-grid`.style`margin-top:1em;`(ce.attr("style.color",v=>E("gameId"))("Game"),v=>Pa({value:e.gameId||"",games:n,isLoaded:r,fieldError:i.gameId,onChange:N=>g({gameId:N})}).key(`${r?"loaded":"loading"}-${n.length}`),ce.attr("style.color",v=>E("dateAddedToCollection"))("Date Added to Collection"),ue.type`date`.value(v=>e.dateAddedToCollection||"").onInput(v=>{var N;g({dateAddedToCollection:((N=v==null?void 0:v.target)==null?void 0:N.value)||""})}).attr("aria-invalid",v=>i.dateAddedToCollection?"true":"false").attr("title",v=>i.dateAddedToCollection||"").attr("style.borderColor",v=>w("dateAddedToCollection"))(),ce("Notes"),rs.value(v=>e.notes||"").onInput(v=>{var N;g({notes:((N=v==null?void 0:v.target)==null?void 0:N.value)||""})})(),ce("Visible on public page"),ce.style`display:flex;gap:0.5em;align-items:center;`(ue.type`checkbox`.attr("checked",v=>e.isVisible!==!1?"checked":null).onChange(v=>{var N;g({isVisible:!!((N=v==null?void 0:v.target)!=null&&N.checked)})})(),Z(v=>e.isVisible!==!1?"Visible":"Hidden"))),m.class`admin-crud-modal-actions`(m.style`display:flex;gap:0.7em;flex-wrap:wrap;`(G.type`button`.class`admin-pill-button`.attr("disabled",v=>o?"disabled":null).onClick(u)(v=>o?"Saving...":"Save"),G.type`button`.class`admin-secondary-button`.attr("disabled",v=>o?"disabled":null).onClick(f)("Cancel")),v=>t?G.type`button`.class`admin-danger-button`.attr("disabled",N=>c?"disabled":null).onClick(h)(N=>c?"🗑️ Deleting...":"🗑️ Delete"):"")))}),cp=t=>{if(typeof t=="number"&&!Number.isNaN(t))return t;if(t===""||t===null||typeof t>"u")return null;const e=Number(t);return Number.isNaN(e)?null:e},J_=t=>t?typeof t=="string"?t.slice(0,10):typeof t.toDate=="function"?t.toDate().toISOString().slice(0,10):t.seconds?new Date(t.seconds*1e3).toISOString().slice(0,10):"":"",Vk=t=>{const e=J_(t);if(!e)return"No date";const n=new Date(`${e}T12:00:00`);return Number.isNaN(n.getTime())?e:n.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})},Cc=()=>({title:"",imageUrl:"",manufacturerId:"",manufacturer:"",yearReleased:null,notes:"",dataLinks:[]});let Rc=!1,Us=null,Un=null,Ar=null,eo=null,Fn=null,Cr=null;const CS=br(t=>K_(t)),K_=O(t=>{K_.inputs(([x])=>{t=K(x)});const e=()=>dt().then(t).catch(x=>console.error("Failed to sign out",x));let n=Us,r=eo,s=!1,i=null,o=Cc(),c=!1,l=!1,u="",h={};const f=me(()=>{}),g=()=>{Un&&Un(),Ar&&Ar(),n=null,Us=null,f();const x=ms();Un=(x==null?void 0:x.unsubscribe)||null;const U=x.subscribe(T=>{n=T,Us=T,f()});Ar=()=>U.unsubscribe()},w=()=>Yu().then(x=>{n=x,Us=x,f()}).catch(x=>{console.error("Failed to refresh games",x),u="Saved, but failed to refresh games. Reload the page to confirm.",f()}),E=()=>{Fn&&Fn(),Cr&&Cr(),r=null,eo=null,f();const x=E_();Fn=(x==null?void 0:x.unsubscribe)||null;const U=x.subscribe(T=>{r=T,eo=T,f()});Cr=()=>U.unsubscribe()},v=()=>{i=null,o=Cc(),u="",h={},s=!0,f()},N=x=>{i=x.id,o={id:x.id,title:x.title||"",imageUrl:x.imageUrl||"",manufacturerId:x.manufacturerId||"",manufacturer:x.manufacturer||"",yearReleased:up(x.yearReleased),notes:x.notes||"",dataLinks:Zn(x.dataLinks)},u="",h={},s=!0,f()},D=()=>{c||l||(i=null,o=Cc(),u="",h={},s=!1,f())},P=()=>{const x={},U=(o.id||"").trim();i&&!U&&(x.id="Game ID is required."),i&&U.includes("/")&&(x.id="Game ID cannot include /."),i&&U!==i&&(n||[]).some(_=>_.id===U)&&(x.id="A game with this ID already exists."),o.title.trim()||(x.title="Game Title is required."),o.yearReleased!==null&&Number.isNaN(Number(o.yearReleased))&&(x.yearReleased="Year Released must be numeric."),h=x;const T=Object.values(x);return T.length?T[0]:""},R=()=>{if(c)return;const x=P();if(x){u=x,f();return}c=!0,u="",h={},f();const U=(r||[]).find(_=>_.id===o.manufacturerId),T=i?(o.id||"").trim():void 0;O.promise=v_({...o,id:T||void 0,title:o.title.trim(),imageUrl:(o.imageUrl||"").trim(),manufacturerId:(o.manufacturerId||"").trim(),manufacturer:((U==null?void 0:U.name)||o.manufacturer||"").trim(),yearReleased:up(o.yearReleased),notes:(o.notes||"").trim(),dataLinks:Zn(o.dataLinks)}).then(()=>{if(i&&T&&T!==i)return ep(i)}).then(()=>(c=!1,D(),w())).catch(_=>{console.error("Failed to save game",_),u="Failed to save game. Check the fields and try again.",f()}).finally(()=>{c=!1,f()})},F=()=>{!i||l||confirm("Delete this game from the games collection? Existing lineup entries or ratings may still reference it.")&&(l=!0,u="",f(),O.promise=ep(i).then(()=>(l=!1,D(),w())).catch(x=>{console.error("Failed to delete game",x),u="Failed to delete game.",f()}).finally(()=>{l=!1,f()}))};return Rc||(Rc=!0,Un||g(),Fn||E()),Kt(()=>{Un&&Un(),Ar&&Ar(),Fn&&Fn(),Cr&&Cr(),Un=null,Ar=null,Fn=null,Cr=null,Us=null,eo=null,Rc=!1}),ve(Ye(()=>Lt(e)),m.class`admin-crud-page`(m.class`admin-crud-header`(et("🕹️ Games Database"),G.type`button`.class`admin-pill-button`.onClick(v)("Add")),m.class`admin-crud-card`(oe.style`margin-top:0;opacity:0.78;`("Manage canonical games used by lineup and ratings."),x=>u&&!s?oe.style`color:#f6c177;`(u):"",m.class`admin-crud-list`(x=>{if(r===null)return z.style`opacity:0.7;`("Loading manufacturers...");if(!r.length)return z.style`opacity:0.7;`("No manufacturers found. Add a manufacturer first.");if(n===null)return z.style`opacity:0.7;`("Loading games...");const U=n.filter(T=>!r.some(_=>Q_(T,_)));return[...r.map(T=>Il({manufacturer:T,games:Dk(T,n||[]),onGameClick:N}).key(T.id)),U.length?Il({manufacturer:{id:"unmatched",name:"Unmatched Games",logoUrl:"",opinions:"Games without a matching manufacturer link."},games:U,onGameClick:N}).key("unmatched"):""]}),m.style`margin-top:1em;display:flex;gap:0.75em;flex-wrap:wrap;`(q.href`../admin/current-games.html`.class`admin-secondary-button`("Lineup Admin"),q.href`../admin/manufacturers.html`.class`admin-secondary-button`("Manufacturers Admin"),q.href`../admin/game-ratings.html`.class`admin-secondary-button`("Ratings Admin"))),x=>s?Z_({isEditing:!!i,originalGameId:i||"",editGame:o,manufacturers:r||[],errorMessage:u,fieldErrors:h,isSaving:c,isDeleting:l,onChange:U=>{var T,_,I;o=U,h={...h,id:(T=U.id)!=null&&T.trim()?"":h.id,title:(_=U.title)!=null&&_.trim()?"":h.title,manufacturerId:U.manufacturerId||(I=U.manufacturer)!=null&&I.trim()?"":h.manufacturerId,yearReleased:U.yearReleased===null||!Number.isNaN(Number(U.yearReleased))?"":h.yearReleased},f()},onSave:R,onDelete:F,onCancel:D}):""))}),Il=O(({manufacturer:t,games:e,onGameClick:n})=>(Il.inputs(r=>{[{manufacturer:t,games:e,onGameClick:n}]=r,n=K(n)}),m.style`display:grid;gap:0.55em;padding:0.85em 0;border-top:1px solid rgba(255,255,255,0.12);`(m.style`display:flex;align-items:center;justify-content:space-between;gap:1em;flex-wrap:wrap;`(m.style`display:flex;align-items:center;gap:0.75em;min-width:0;`(r=>t.logoUrl?Y.class`admin-crud-thumb`.style`width:46px;height:46px;`.src`${t.logoUrl}`.attr("alt",s=>t.name||"Manufacturer logo"):m.class`admin-crud-thumb admin-crud-thumb-placeholder`.style`width:46px;height:46px;font-size:1em;`(s=>(t.name||"?").slice(0,2).toUpperCase()),m.style`min-width:0;`(fr(r=>t.name||"Untitled manufacturer"),m.style`margin-top:0.12em;opacity:0.66;`(z(r=>`${e.length} game${e.length===1?"":"s"}`))))),r=>e.length?m.style`display:grid;gap:0.55em;`(e.map(s=>Y_({game:s,manufacturers:[t],onClick:n}).key(s.id))):z.style`opacity:0.7;`("No games for this manufacturer yet.")))),Dk=(t,e)=>e.filter(n=>Q_(n,t)),Q_=(t,e)=>t.manufacturerId===e.id||lp(t.manufacturer)===lp(e.name),Y_=O(({game:t,manufacturers:e,onClick:n})=>(Y_.inputs(r=>{[{game:t,manufacturers:e,onClick:n}]=r,n=K(n)}),G.type`button`.class`admin-crud-row`.onClick(()=>n(t))(r=>t.imageUrl?Y.class`admin-crud-thumb`.src`${t.imageUrl}`.attr("alt",s=>t.title||"Game image"):m.class`admin-crud-thumb admin-crud-thumb-placeholder`("PB"),m(fr(r=>t.title||"Untitled game"),m.style`margin-top:0.15em;opacity:0.74;`(z(r=>[Nk(t,e),t.yearReleased?String(t.yearReleased):""].filter(Boolean).join(" - ")||"No manufacturer/year"))),z.style`opacity:0.62;text-align:right;display:grid;gap:0.1em;`(Z.style`font-size:0.78em;text-transform:uppercase;`("Game ID"),Z(r=>t.id))))),Nk=(t,e)=>{const n=e.find(r=>r.id===t.manufacturerId);return(n==null?void 0:n.name)||t.manufacturer||""},lp=t=>String(t||"").trim().toLowerCase(),X_=t=>`${t} pinball machine backglass`,Lk=t=>`https://www.google.com/search?tbm=isch&q=${encodeURIComponent(X_(t))}`,Mk=t=>`https://pinside.com/pinball/machine/${encodeURIComponent(t)}`,Z_=O(({isEditing:t,originalGameId:e,editGame:n,manufacturers:r,errorMessage:s,fieldErrors:i,isSaving:o,isDeleting:c,onChange:l,onSave:u,onDelete:h,onCancel:f})=>{Z_.inputs(R=>{[{isEditing:t,originalGameId:e,editGame:n,manufacturers:r,errorMessage:s,fieldErrors:i,isSaving:o,isDeleting:c,onChange:l,onSave:u,onDelete:h,onCancel:f}]=R,l=K(l),u=K(u),h=K(h),f=K(f)});const g=R=>l({...n,...R}),w=(R,F)=>{var U,T;const x=Zn(n.dataLinks,!0);x[R]={title:((U=x[R])==null?void 0:U.title)||"",url:((T=x[R])==null?void 0:T.url)||"",...F},g({dataLinks:x})},E=()=>{g({dataLinks:[...Zn(n.dataLinks,!0),{title:"",url:""}]})},v=R=>{g({dataLinks:Zn(n.dataLinks,!0).filter((F,x)=>x!==R)})},N=R=>i[R]?"#f87171":"rgba(255,255,255,0.2)",D=R=>i[R]?"#fca5a5":"inherit",P=R=>{var F;R.key!=="Enter"||R.shiftKey||R.metaKey||R.ctrlKey||R.altKey||String(((F=R.target)==null?void 0:F.tagName)||"").toLowerCase()!=="textarea"&&(R.preventDefault(),u())};return m.class`admin-crud-modal-backdrop`(m.class`admin-crud-modal`.onKeyDown(P)(m.style`display:flex;justify-content:space-between;gap:1em;align-items:flex-start;`(m(et.style`margin:0;`(t?"Edit Game":"Add Game"),z.style`opacity:0.72;`("Manage the canonical machine record.")),G.type`button`.class`admin-secondary-button`.onClick(f)("Cancel")),R=>s?oe.style`color:#f6c177;`(s):"",R=>Object.values(i).filter(Boolean).length?m.style`border:1px solid rgba(248,113,113,0.5);background:rgba(127,29,29,0.25);border-radius:0.55em;padding:0.6em;margin-top:0.75em;color:#fecaca;display:grid;gap:0.2em;`(Object.values(i).filter(Boolean).map(F=>z(F))):"",m.class`admin-crud-form-grid`.style`margin-top:1em;`(R=>t?[ce.attr("style.color",F=>D("id"))("Game ID"),m.style`display:grid;gap:0.28em;`(ue.type`text`.value(F=>n.id||"").onInput(F=>{var x;g({id:((x=F==null?void 0:F.target)==null?void 0:x.value)||""})}).attr("aria-invalid",F=>i.id?"true":"false").attr("title",F=>i.id||"").attr("style.borderColor",F=>N("id"))(),F=>(n.id||"").trim()!==e?z.style`color:#f6c177;line-height:1.35;`("Changing this value can change or break links to this game."):"",F=>(n.id||"").trim()?z(q.href`${Mk((n.id||"").trim())}`.class`admin-inline-edit-link`.attr("target","_blank").attr("rel","noopener noreferrer").style`justify-self:start;`("pinside link")):"")]:"",ce.attr("style.color",R=>D("title"))("Game Title"),ue.type`text`.value(R=>n.title||"").onInput(R=>{var F;g({title:((F=R==null?void 0:R.target)==null?void 0:F.value)||""})}).attr("aria-invalid",R=>i.title?"true":"false").attr("title",R=>i.title||"").attr("style.borderColor",R=>N("title"))(),ce("Image URL"),m.style`display:grid;gap:0.5em;`(m.style`display:grid;grid-template-columns:minmax(0,1fr) auto;gap:0.5em;align-items:stretch;`(ue.type`url`.value(R=>n.imageUrl||"").onInput(R=>{var F;g({imageUrl:((F=R==null?void 0:R.target)==null?void 0:F.value)||""})})(),R=>n.imageUrl?Y.src`${n.imageUrl}`.attr("alt",F=>`${n.title||"Game"} image preview`).style`width:64px;height:42px;object-fit:cover;border:1px solid rgba(255,255,255,0.2);border-radius:0.5em;background:#101010;`:""),R=>(n.title||"").trim()?q.href`${Lk(n.title||"")}`.class`admin-inline-edit-link`.attr("target","_blank").attr("rel","noopener noreferrer").style`justify-self:start;`.attr("title",F=>X_(n.title||""))("view google images"):z.style`opacity:0.72;`("Add a game title to view Google Images.")),ce.attr("style.color",R=>D("manufacturerId"))("Manufacturer"),m.class`admin-field-with-link`(Gl.value(R=>n.manufacturerId||"").onChange(R=>{var F;g({manufacturerId:((F=R==null?void 0:R.target)==null?void 0:F.value)||""})}).attr("aria-invalid",R=>i.manufacturerId?"true":"false").attr("title",R=>i.manufacturerId||"").attr("style.borderColor",R=>N("manufacturerId"))([nr.value``(r.length?"Select a manufacturer":"Add a manufacturer first"),...r.map(R=>nr.value`${R.id}`(R.name||"Untitled manufacturer"))]),q.href`/admin/manufacturers.html`.class`admin-inline-edit-link`("edit manufacturers")),ce.attr("style.color",R=>D("yearReleased"))("Year Released"),ue.type`number`.value(R=>n.yearReleased??"").onInput(R=>{var F;g({yearReleased:Ok((F=R==null?void 0:R.target)==null?void 0:F.value)})}).attr("aria-invalid",R=>i.yearReleased?"true":"false").attr("title",R=>i.yearReleased||"").attr("style.borderColor",R=>N("yearReleased"))(),ce("Notes"),rs.value(R=>n.notes||"").onInput(R=>{var F;g({notes:((F=R==null?void 0:R.target)==null?void 0:F.value)||""})})(),ce("Data Links"),m.style`display:grid;gap:0.55em;`(R=>Zn(n.dataLinks,!0).length?Zn(n.dataLinks,!0).map((F,x)=>m.style`display:grid;grid-template-columns:1fr 1fr auto;gap:0.45em;align-items:center;`(ue.type`text`.placeholder`Title`.value(U=>F.title||"").onInput(U=>{var T;w(x,{title:((T=U==null?void 0:U.target)==null?void 0:T.value)||""})})(),ue.type`url`.placeholder`URL`.value(U=>F.url||"").onInput(U=>{var T;w(x,{url:((T=U==null?void 0:U.target)==null?void 0:T.value)||""})})(),G.type`button`.class`admin-danger-button`.onClick(()=>v(x))("🗑️ Delete")).key(`data-link-${x}`)):z.style`opacity:0.72;`("No data links added."),m(G.type`button`.class`admin-secondary-button`.onClick(E)("Add Data Link")))),m.class`admin-crud-modal-actions`(m.style`display:flex;gap:0.7em;flex-wrap:wrap;`(G.type`button`.class`admin-pill-button`.attr("disabled",R=>o?"disabled":null).onClick(u)(R=>o?"Saving...":"Save"),G.type`button`.class`admin-secondary-button`.attr("disabled",R=>o?"disabled":null).onClick(f)("Cancel")),R=>t?G.type`button`.class`admin-danger-button`.attr("disabled",F=>c?"disabled":null).onClick(h)(F=>c?"🗑️ Deleting...":"🗑️ Delete"):"")))}),Ok=t=>{if(t===""||t===null||typeof t>"u")return null;const e=Number(t);return Number.isNaN(e)?null:e},up=t=>{if(typeof t=="number"&&!Number.isNaN(t))return t;if(t===""||t===null||typeof t>"u")return null;const e=Number(t);return Number.isNaN(e)?null:e},Zn=(t,e=!1)=>Array.isArray(t)?t.map(n=>({title:((n==null?void 0:n.title)||"").trim(),url:((n==null?void 0:n.url)||"").trim()})).filter(n=>e||n.title||n.url):[],Uk=new URL(""+new URL("rating-badge-CCDAE7Ja.png",import.meta.url).href,import.meta.url).href,id=O(({rating:t,size:e=82})=>{id.inputs(r=>{[{rating:t,size:e=82}]=r});const n=Fk(t);return m.class`rating-badge`.attr("aria-label",r=>n?`Rating ${n} out of 10`:"Not rated").attr("title",r=>n?`${n}/10`:"Not rated").style`
    ...
    `(Y.src`${Uk}`.attr("alt","").attr("aria-hidden","true").style`
        ...
        `(),n?Z.style`
          ...
          `(n):"")}),Fk=t=>typeof t!="number"||Number.isNaN(t)?"":t.toFixed(1).replace(/\.0$/,""),kc=()=>({gameId:"",rating:null,review:"",videos:[],isVisible:!0});let Sc=!1,Fs=null,$s=null,$n=null,Rr=null,Bn=null,kr=null;const RS=br(t=>e0(t)),e0=O(t=>{e0.inputs(([_])=>{t=K(_)});const e=()=>dt().then(t).catch(_=>console.error("Failed to sign out",_));let n=Fs,r=$s,s=!1,i=null,o=kc(),c=!1,l=!1,u="",h={};const f=me(()=>{}),g=()=>{$n&&$n(),Rr&&Rr(),r=null,$s=null,f();const _=XR();$n=(_==null?void 0:_.unsubscribe)||null;const I=_.subscribe(me(C=>{r=C,$s=C}));Rr=()=>I.unsubscribe()},w=()=>{Bn&&Bn(),kr&&kr(),n=null,Fs=null,f();const _=ms();Bn=(_==null?void 0:_.unsubscribe)||null;const I=_.subscribe(me(C=>{n=C,Fs=C}));kr=()=>I.unsubscribe()},E=()=>ek().then(_=>{r=_,$s=_,f()}).catch(_=>{console.error("Failed to refresh game ratings",_),u="Saved, but failed to refresh ratings. Reload the page to confirm.",f()}),v=()=>Yu().then(_=>{n=_,Fs=_,f()}).catch(_=>{console.error("Failed to refresh games",_)}),N=()=>n!==null?Promise.resolve(n):(f(),v().then(()=>n||[])),D=()=>{i=null,o={...kc()},u="",h={},s=!0,f(),O.promise=N()},P=_=>{const I=_.id||_.gameId;i=I||null,o={id:I,gameId:_.gameId||_.id||"",rating:typeof _.rating=="number"?_.rating:null,review:_.review||"",videos:Array.isArray(_.videos)?_.videos:[],isVisible:_.isVisible!==!1},u="",h={},s=!0,f(),O.promise=N()},R=()=>{c||l||(i=null,o=kc(),h={},u="",s=!1,f())},F=()=>{const _={};o.gameId||(_.gameId="Game is required."),o.rating===null||Number.isNaN(Number(o.rating))?_.rating="Rating is required.":(Number(o.rating)<0||Number(o.rating)>10)&&(_.rating="Rating must be between 0 and 10."),h=_;const I=Object.values(_);return I.length?I[0]:""},x=()=>{if(c)return;const _=F();if(_){u=_,f();return}c=!0,u="",f(),O.promise=tk({...o,id:o.gameId,rating:Number(o.rating),review:(o.review||"").trim(),videos:Bk(o.videos),isVisible:o.isVisible!==!1}).then(()=>(c=!1,R(),E())).catch(I=>{console.error("Failed to save game rating",I),u="Failed to save rating. Check the fields and try again.",f()}).finally(()=>{c=!1,f()})},U=()=>{!i||l||confirm("Delete this game rating?")&&(l=!0,u="",f(),O.promise=nk(i).then(()=>(l=!1,R(),E())).catch(_=>{console.error("Failed to delete game rating",_),u="Failed to delete rating.",f()}).finally(()=>{l=!1,f()}))};Sc||(Sc=!0,$n||g(),Bn||w()),Kt(()=>{$n&&$n(),Rr&&Rr(),Bn&&Bn(),kr&&kr(),$n=null,Rr=null,Bn=null,kr=null,Fs=null,$s=null,Sc=!1});const T=()=>r===null?z.style`opacity:0.7;`("Loading ratings..."):r.length?r.map(_=>t0({rating:_,game:$k(_,n||[]),onClick:P}).key(_.id||_.gameId)):"";return ve(Ye(()=>Lt(e)),m.class`admin-crud-page`(m.class`admin-crud-header`(et("⭐ Game Ratings"),G.type`button`.class`admin-pill-button`.onClick(D)("Add")),m.class`admin-crud-card`(_=>u&&!s?oe.style`color:#f6c177;`(u):"",m.class`admin-crud-list`(_=>T()),m.style`margin-top:1em;display:flex;gap:0.75em;flex-wrap:wrap;`(q.href`../ratings.html`.class`admin-secondary-button`("View Public Ratings"))),_=>s?n0({isEditing:!!i,editRating:o,games:n||[],isGamesLoaded:n!==null,errorMessage:u,fieldErrors:h,isSaving:c,isDeleting:l,onChange:I=>{o=I,h={...h,gameId:I.gameId?"":h.gameId,rating:I.rating!==null&&!Number.isNaN(Number(I.rating))?"":h.rating},f()},onSave:x,onDelete:U,onCancel:R}):""))}),t0=O(({game:t,rating:e,onClick:n})=>(t0.inputs(r=>{[{game:t,rating:e,onClick:n}]=r,n=K(n)}),G.type`button`.class`admin-crud-row`.onClick(()=>n(e))(r=>t!=null&&t.imageUrl?Y.class`admin-crud-thumb`.src`${t.imageUrl}`.attr("alt",s=>t.title||"Game image"):m.class`admin-crud-thumb admin-crud-thumb-placeholder`("PB"),m(fr(r=>(t==null?void 0:t.title)||e.gameId||e.id||"Untitled game"),m.style`margin-top:0.15em;opacity:0.74;`(z(r=>[(t==null?void 0:t.manufacturer)||"",t!=null&&t.yearReleased?String(t.yearReleased):""].filter(Boolean).join(" - ")||"No manufacturer/year"))),m.class`admin-rating-badge-cell`.style`display:grid;justify-items:end;gap:0.25em;`(r=>typeof(e==null?void 0:e.rating)=="number"&&!Number.isNaN(e.rating)?id({rating:e.rating}):z.style`opacity:0.72;`("Not rated"),r=>(e==null?void 0:e.isVisible)===!1?z.style`opacity:0.72;`("Hidden"):"")))),n0=O(({isEditing:t,editRating:e,games:n,isGamesLoaded:r,errorMessage:s,fieldErrors:i,isSaving:o,isDeleting:c,onChange:l,onSave:u,onDelete:h,onCancel:f})=>{n0.inputs(P=>{[{isEditing:t,editRating:e,games:n,isGamesLoaded:r,errorMessage:s,fieldErrors:i,isSaving:o,isDeleting:c,onChange:l,onSave:u,onDelete:h,onCancel:f}]=P,l=K(l),u=K(u),h=K(h),f=K(f)});const g=P=>{l({...e,...P})},w=(P,R)=>{var x,U;const F=[...e.videos||[]];F[P]={url:((x=F[P])==null?void 0:x.url)||"",description:((U=F[P])==null?void 0:U.description)||"",...R},g({videos:F})},E=()=>{g({videos:[...e.videos||[],{url:"",description:""}]})},v=P=>{g({videos:(e.videos||[]).filter((R,F)=>F!==P)})},N=P=>i[P]?"#f87171":"rgba(255,255,255,0.2)",D=P=>i[P]?"#fca5a5":"inherit";return m.class`admin-crud-modal-backdrop`(m.class`admin-crud-modal`(m.style`display:flex;justify-content:space-between;gap:1em;align-items:flex-start;`(m(et.style`margin:0;`(P=>t?"Edit Rating":"Add Rating"),z.style`opacity:0.72;`("Create or update the public rating for this game.")),G.type`button`.class`admin-secondary-button`.onClick(f)("Cancel")),P=>s?oe.style`color:#f6c177;`(s):"",P=>Object.values(i).filter(Boolean).length?m.style`border:1px solid rgba(248,113,113,0.5);background:rgba(127,29,29,0.25);border-radius:0.55em;padding:0.6em;margin-top:0.75em;color:#fecaca;display:grid;gap:0.2em;`(Object.values(i).filter(Boolean).map(R=>z(R))):"",m.class`admin-crud-form-grid`.style`margin-top:1em;`(ce.attr("style.color",P=>D("gameId"))("Game"),P=>Pa({value:e.gameId||"",games:n,isLoaded:r,fieldError:i.gameId,onChange:R=>g({gameId:R})}).key(`${r?"loaded":"loading"}-${n.length}`),ce.attr("style.color",P=>D("rating"))("Rating"),ue.type`number`.attr("min","0").attr("max","10").attr("step","0.1").value(P=>e.rating??"").onInput(P=>{var R;g({rating:jk((R=P==null?void 0:P.target)==null?void 0:R.value)})}).attr("aria-invalid",P=>i.rating?"true":"false").attr("title",P=>i.rating||"").attr("style.borderColor",P=>N("rating"))(),ce("Review"),rs.value(P=>e.review||"").onInput(P=>{var R;g({review:((R=P==null?void 0:P.target)==null?void 0:R.value)||""})})(),ce("Videos"),m.style`display:grid;gap:0.6em;`(P=>(e.videos||[]).length?(e.videos||[]).map((R,F)=>m.style`display:grid;gap:0.45em;border:1px solid rgba(255,255,255,0.12);border-radius:0.55em;padding:0.65em;background:rgba(0,0,0,0.18);`(m.style`display:grid;grid-template-columns:1fr auto;gap:0.45em;align-items:center;`(ue.type`url`.style`width:100%;`.value(x=>R.url||"").attr("placeholder","YouTube video URL").onInput(x=>{var U;w(F,{url:((U=x==null?void 0:x.target)==null?void 0:U.value)||""})})(),x=>R.url?q.href`${R.url}`.class`admin-secondary-button`.style`text-decoration:none;`.attr("target","_blank").attr("rel","noopener noreferrer").attr("title","Open video link")("🔗"):""),ue.type`text`.style`width:100%;`.value(x=>R.description||"").attr("placeholder","Description").onInput(x=>{var U;w(F,{description:((U=x==null?void 0:x.target)==null?void 0:U.value)||""})})(),m.style`display:flex;justify-content:flex-end;`(G.type`button`.class`admin-secondary-button`.onClick(()=>v(F))("🗑️ Remove")))):z.style`opacity:0.72;`("No videos linked."),G.type`button`.class`admin-secondary-button`.onClick(E)("Add Video")),ce("Visible on public page"),ce.style`display:flex;gap:0.5em;align-items:center;`(ue.type`checkbox`.attr("checked",P=>e.isVisible!==!1?"checked":null).onChange(P=>{var R;g({isVisible:!!((R=P==null?void 0:P.target)!=null&&R.checked)})})(),Z(P=>e.isVisible!==!1?"Visible":"Hidden"))),m.class`admin-crud-modal-actions`(m.style`display:flex;gap:0.7em;flex-wrap:wrap;`(G.type`button`.class`admin-pill-button`.attr("disabled",P=>o?"disabled":null).onClick(u)(P=>o?"Saving...":"Save"),G.type`button`.class`admin-secondary-button`.attr("disabled",P=>o?"disabled":null).onClick(f)("Cancel")),P=>t?G.type`button`.class`admin-danger-button`.attr("disabled",R=>c?"disabled":null).onClick(h)(R=>c?"🗑️ Deleting...":"🗑️ Delete"):"")))}),$k=(t,e)=>{const n=t.gameId||t.id;return e.find(r=>r.id===n)||null},Bk=t=>Array.isArray(t)?t.map(e=>({url:((e==null?void 0:e.url)||"").trim(),description:((e==null?void 0:e.description)||"").trim()})).filter(e=>e.url||e.description):[],jk=t=>{if(t===""||t===null||typeof t>"u")return null;const e=Number(t);return Number.isNaN(e)?null:e},xc=()=>({name:"",logoUrl:"",opinions:""});let Pc=!1,jn=null,zn=null,Sr=null;const kS=br(t=>r0(t)),r0=O(t=>{r0.inputs(([R])=>{t=K(R)});const e=()=>dt().then(t).catch(R=>console.error("Failed to sign out",R));let n=jn,r=!1,s=null,i=xc(),o=!1,c=!1,l="",u={};const h=()=>{zn&&zn(),Sr&&Sr(),n=null,jn=null;const R=E_();zn=(R==null?void 0:R.unsubscribe)||null;const F=R.subscribe(x=>{n=x,jn=x});Sr=()=>F.unsubscribe()},f=()=>QR().then(R=>{n=R,jn=R}).catch(R=>{console.error("Failed to refresh manufacturers",R),l="Saved, but failed to refresh manufacturers. Reload the page to confirm."});O.promise=f();const g=(R,F)=>{const x=n||jn||[],U={...x.find(I=>I.id===R)||{},...F,id:R},T=x.some(I=>I.id===R),_=zk(T?x.map(I=>I.id===R?U:I):[...x,U]);n=_,jn=_},w=()=>{s=null,i=xc(),l="",u={},r=!0},E=R=>{s=R.id,i={id:R.id,name:R.name||"",logoUrl:R.logoUrl||"",opinions:R.opinions||""},l="",u={},r=!0},v=()=>{o||c||(s=null,i=xc(),l="",u={},r=!1)},N=()=>{const R={},F=(i.id||"").trim();s&&!F&&(R.id="Manufacturer ID is required."),s&&F.includes("/")&&(R.id="Manufacturer ID cannot include /."),s&&F!==s&&(n||[]).some(U=>U.id===F)&&(R.id="A manufacturer with this ID already exists."),i.name.trim()||(R.name="Manufacturer Name is required."),u=R;const x=Object.values(R);return x.length?x[0]:""},D=()=>{if(o)return;const R=N();if(R){l=R;return}o=!0,l="",u={};const F={...i,id:s?(i.id||"").trim():void 0,name:i.name.trim(),logoUrl:(i.logoUrl||"").trim(),opinions:(i.opinions||"").trim()},x=s;return YR(F).then(U=>{const T=F.id||x||(U==null?void 0:U.id);if(T&&g(T,F),x&&T&&T!==x)return Zf(x)}).then(()=>(o=!1,v(),f())).catch(U=>{console.error("Failed to save manufacturer",U),l="Failed to save manufacturer. Check the fields and try again."}).finally(()=>{o=!1})},P=()=>{!s||c||confirm("Delete this manufacturer? Existing games may still reference it.")&&(c=!0,l="",O.promise=Zf(s).then(()=>(c=!1,v(),f())).catch(R=>{console.error("Failed to delete manufacturer",R),l="Failed to delete manufacturer."}).finally(()=>{c=!1}))};return Pc||(Pc=!0,zn||h()),Kt(()=>{zn&&zn(),Sr&&Sr(),zn=null,Sr=null,jn=null,Pc=!1}),ve(Ye(()=>Lt(e)),m.class`admin-crud-page`(m.class`admin-crud-header`(et("🏭 Manufacturers Database"),G.type`button`.class`admin-pill-button`.onClick(w)("Add")),m.class`admin-crud-card`(R=>l&&!r?oe.style`color:#f6c177;`(l):"",m.class`admin-crud-list`(R=>n===null?z.style`opacity:0.7;`("Loading manufacturers..."):n.length?n.map(F=>s0({manufacturer:F,onClick:E}).key(F.id)):z.style`opacity:0.7;`("No manufacturers found. Use Add Manufacturer to create the first one.")),m.style`margin-top:1em;display:flex;gap:0.75em;flex-wrap:wrap;`(q.href`../admin/games.html`.class`admin-secondary-button`("Games Admin"))),R=>r?o0({isEditing:!!s,editManufacturer:i,errorMessage:l,fieldErrors:u,isSaving:o,isDeleting:c,onChange:F=>{var x,U;i=F,u={...u,id:(x=F.id)!=null&&x.trim()?"":u.id,name:(U=F.name)!=null&&U.trim()?"":u.name}},onSave:D,onDelete:P,onCancel:v}):""))}),zk=t=>[...t].sort((e,n)=>String(e.name||"").localeCompare(String(n.name||""),void 0,{sensitivity:"base"})),s0=O(({manufacturer:t,onClick:e})=>(s0.inputs(n=>{[{manufacturer:t,onClick:e}]=n,e=K(e)}),G.type`button`.class`admin-crud-row`.onClick(()=>e(t))(n=>t.logoUrl?Y.class`admin-crud-thumb`.src`${t.logoUrl}`.attr("alt",r=>t.name||"Manufacturer logo"):m.class`admin-crud-thumb admin-crud-thumb-placeholder`(r=>Hk(t.name)),m(fr(n=>t.name||"Untitled manufacturer"),m.style`margin-top:0.15em;opacity:0.74;`(z(n=>t.opinions||"No opinions"))),z.style`opacity:0.62;text-align:right;display:grid;gap:0.1em;`(Z.style`font-size:0.78em;text-transform:uppercase;`("Manufacturer ID"),Z(n=>t.id))))),Hk=(t="")=>(t.trim().charAt(0)||"M").toUpperCase(),i0=t=>`${t} manufacturer logo`,qk=t=>`https://www.google.com/search?tbm=isch&q=${encodeURIComponent(i0(t))}`,o0=O(({isEditing:t,editManufacturer:e,errorMessage:n,fieldErrors:r,isSaving:s,isDeleting:i,onChange:o,onSave:c,onDelete:l,onCancel:u})=>{o0.inputs(E=>{[{isEditing:t,editManufacturer:e,errorMessage:n,fieldErrors:r,isSaving:s,isDeleting:i,onChange:o,onSave:c,onDelete:l,onCancel:u}]=E,o=K(o),c=K(c),l=K(l),u=K(u)});const h=E=>o({...e,...E}),f=E=>r[E]?"#f87171":"rgba(255,255,255,0.2)",g=E=>r[E]?"#fca5a5":"inherit",w=E=>{var v;E.key!=="Enter"||E.shiftKey||E.metaKey||E.ctrlKey||E.altKey||String(((v=E.target)==null?void 0:v.tagName)||"").toLowerCase()!=="textarea"&&(E.preventDefault(),c())};return m.class`admin-crud-modal-backdrop`(m.class`admin-crud-modal`.onKeyDown(w)(m.style`display:flex;justify-content:space-between;gap:1em;align-items:flex-start;`(m(et.style`margin:0;`(t?"Edit Manufacturer":"Add Manufacturer"),z.style`opacity:0.72;`("Manage the canonical manufacturer record.")),G.type`button`.class`admin-secondary-button`.onClick(u)("Cancel")),E=>n?oe.style`color:#f6c177;`(n):"",E=>Object.values(r).filter(Boolean).length?m.style`border:1px solid rgba(248,113,113,0.5);background:rgba(127,29,29,0.25);border-radius:0.55em;padding:0.6em;margin-top:0.75em;color:#fecaca;display:grid;gap:0.2em;`(Object.values(r).filter(Boolean).map(v=>z(v))):"",m.class`admin-crud-form-grid`.style`margin-top:1em;`(E=>t?[ce.attr("style.color",v=>g("id"))("Manufacturer ID"),m.style`display:grid;gap:0.28em;`(ue.type`text`.value(v=>e.id||"").onInput(v=>{var N;h({id:((N=v==null?void 0:v.target)==null?void 0:N.value)||""})}).attr("aria-invalid",v=>r.id?"true":"false").attr("title",v=>r.id||"").attr("style.borderColor",v=>f("id"))(),z.style`color:#f6c177;line-height:1.35;`("Changing this value can change or break links to this manufacturer."))]:"",ce.attr("style.color",E=>g("name"))("Manufacturer Name"),ue.type`text`.value(E=>e.name||"").onInput(E=>{var v;h({name:((v=E==null?void 0:E.target)==null?void 0:v.value)||""})}).attr("aria-invalid",E=>r.name?"true":"false").attr("title",E=>r.name||"").attr("style.borderColor",E=>f("name"))(),ce("Logo URL"),m.style`display:grid;gap:0.5em;`(ue.type`url`.value(E=>e.logoUrl||"").onInput(E=>{var v;h({logoUrl:((v=E==null?void 0:E.target)==null?void 0:v.value)||""})})(),E=>(e.name||"").trim()?q.href`${qk(e.name||"")}`.class`admin-inline-edit-link`.attr("target","_blank").attr("rel","noopener noreferrer").style`justify-self:start;`.attr("title",v=>i0(e.name||""))("google images"):z.style`opacity:0.72;`("Add a manufacturer name to view Google Images.")),ce("Opinions"),rs.value(E=>e.opinions||"").onInput(E=>{var v;h({opinions:((v=E==null?void 0:E.target)==null?void 0:v.value)||""})})()),m.class`admin-crud-modal-actions`(m.style`display:flex;gap:0.7em;flex-wrap:wrap;`(G.type`button`.class`admin-pill-button`.attr("disabled",E=>s?"disabled":null).onClick(c)(E=>s?"Saving...":"Save"),G.type`button`.class`admin-secondary-button`.attr("disabled",E=>s?"disabled":null).onClick(u)("Cancel")),E=>t?G.type`button`.class`admin-danger-button`.attr("disabled",v=>i?"disabled":null).onClick(l)(v=>i?"🗑️ Deleting...":"🗑️ Delete"):"")))});let dp=!1,to=null;const SS=br(t=>a0(t)),a0=O(t=>{let e=to||Date.now(),{date:n,time:r}=ip(Number(e));a0.inputs(([c])=>{t=K(c)});function s(){const c=ip(Number(e));n=c.date,r=c.time}dp||(dp=!0,O.promise=ka().then(c=>{typeof c=="number"&&(e=c,to=c,s(),console.log("nextMeetupDate",{nextMeetupDate:e}))}).catch(c=>{console.error("Failed to load next meetup date",c)}));const i=()=>dt().then(t).catch(c=>{console.error("Failed to sign out",c)}),o=()=>qR(Number(e)).then(()=>{to=Number(e),alert("saved")}).catch(c=>{console.error("Failed to save meetup date",c)});return ve(Ye(()=>Lt(i)),m.class`admin-crud-page`(m.class`admin-crud-header`(et(Y.src`../assets/media/icon.png`.style`width:40px;margin-right:10px;`,"📅 Meeting Tools")),m.class`admin-crud-card`(c=>O_({nextMeetupDate:e,date:n,time:r,onDate:l=>{e=l,to=l,s()},onSave:o}))))}),Gk="https://pinside.com/pinball/community/pinsiders/thecapn/collection/history",Vc=()=>({gameId:"",title:"",dateAddedToCollection:"",dateRemovedFromCollection:"",notes:"",isVisible:!0,pinsideUrl:"",pinsideId:"",source:""});let Dc=!1,Bs=null,Hn=null,xr=null,js=null,qn=null,Pr=null;const xS=br(t=>c0(t)),c0=O(t=>{c0.inputs(([b])=>{t=K(b)});const e=()=>dt().then(t).catch(b=>console.error("Failed to sign out",b));let n=!1,r=!1,s=!1,i="",o="",c="",l=!1,u={},h=!1,f=null,g=Vc(),w=Bs,E=js;const v=me(()=>{}),N=()=>{Hn&&Hn(),xr&&xr(),w=null,Bs=null,i="",v();const b=ck();Hn=(b==null?void 0:b.unsubscribe)||null;const ne=b.subscribe($e=>{w=$e,Bs=$e,v()});xr=()=>ne.unsubscribe()},D=()=>{qn&&qn(),Pr&&Pr(),E=null,js=null,v();const b=ms();qn=(b==null?void 0:b.unsubscribe)||null;const ne=b.subscribe($e=>{E=$e,js=$e,v()});Pr=()=>ne.unsubscribe()},P=()=>A_().then(b=>{w=b,Bs=b,v()}).catch(b=>{console.error("Failed to refresh past owned games list",b),i="Saved, but failed to refresh the game list. Reload the page to confirm.",v()}),R=()=>Yu().then(b=>{E=b,js=b,v()}).catch(b=>{console.error("Failed to refresh games library",b),i="Saved, but failed to refresh the games library. Reload the page to confirm.",v()}),F=()=>{f=null,g=Vc(),i="",u={},h=!0,v()},x=b=>{f=b.id,g={id:b.id,gameId:b.gameId||"",title:"",dateAddedToCollection:vl(b.dateAddedToCollection),dateRemovedFromCollection:vl(b.dateRemovedFromCollection),imageUrl:b.imageUrl||"",manufacturer:b.manufacturer||"",yearReleased:pp(b.yearReleased),notes:b.notes||"",isVisible:b.isVisible!==!1,pinsideUrl:b.pinsideUrl||"",pinsideId:b.pinsideId||"",source:b.source||""},i="",u={},h=!0,v()},U=()=>{n||r||(f=null,g=Vc(),i="",u={},h=!1,v())},T=()=>{const b={};return g.gameId||(b.gameId="Game is required."),g.yearReleased!==null&&typeof g.yearReleased<"u"&&Number.isNaN(Number(g.yearReleased))&&(b.yearReleased="Year must be numeric."),u=b,Object.values(b)[0]||""},_=()=>{if(n)return;const b=T();if(b){i=b,v();return}n=!0,i="",u={},v(),O.promise=C_({...g,id:f||void 0,gameId:(g.gameId||"").trim(),title:"",imageUrl:(g.imageUrl||"").trim(),manufacturer:(g.manufacturer||"").trim(),notes:(g.notes||"").trim(),pinsideUrl:(g.pinsideUrl||"").trim(),pinsideId:(g.pinsideId||"").trim(),source:(g.source||"").trim(),yearReleased:pp(g.yearReleased),isVisible:g.isVisible!==!1}).then(()=>(n=!1,U(),P())).catch(ne=>{console.error("Failed to save past owned game",ne),i="Failed to save game. Check the fields and try again.",v()}).finally(()=>{n=!1,v()})},I=()=>{!f||r||confirm("Delete this past owned game?")&&(r=!0,i="",v(),O.promise=uk(f).then(()=>(r=!1,U(),P())).catch(b=>{console.error("Failed to delete past owned game",b),i="Failed to delete game.",v()}).finally(()=>{r=!1,v()}))},C=b=>{if(!b.length){o="No Pinside games were found. Paste the copied Pinside history text and try again.",v();return}s=!0,o=`Found ${b.length} Pinside game${b.length===1?"":"s"}. Syncing new items only...`,v(),O.promise=dk(b,E||[]).then(ne=>(o=`Sync complete. Added ${ne.added}; skipped ${ne.skipped} already-present item${ne.skipped===1?"":"s"}.`,R().then(P))).catch(ne=>{console.error("Failed to sync Pinside games",ne),o="Sync failed while writing to Firestore. Check permissions and try again.",v()}).finally(()=>{s=!1,v()})},A=()=>{const b=Yk(c);C(b)},S=()=>{l=!l,v()};return Dc||(Dc=!0,Hn||N(),qn||D()),Kt(()=>{Hn&&Hn(),xr&&xr(),qn&&qn(),Pr&&Pr(),Hn=null,xr=null,qn=null,Pr=null,Dc=!1,Bs=null,js=null}),ve(Ye(()=>Lt(e)),m.class`admin-crud-page`(m.class`admin-crud-header`(et("📜 Past Games Owned"),m.style`display:flex;gap:0.75em;align-items:center;flex-wrap:wrap;`(z.style`opacity:0.72;`(b=>w===null?"Loading count...":`${w.length} past game${w.length===1?"":"s"}`),G.type`button`.class`admin-pill-button`.onClick(F)("Add"))),m.class`admin-crud-card`.style`margin-bottom:1em;`(m.style`display:flex;gap:0.75em;flex-wrap:wrap;align-items:center;`(G.type`button`.class`admin-secondary-button`.attr("aria-expanded",b=>l?"true":"false").onClick(S)("Pinside Sync")),b=>l?m.style`margin-top:0.9em;`(oe.style`margin-top:0;opacity:0.78;`("Paste copied Pinside history text to add missing past-owned games. Imported games are created in the games database and linked here."),m.style`display:flex;gap:0.75em;flex-wrap:wrap;align-items:center;`(q.href`${Gk}`.class`admin-secondary-button`.attr("target","_blank").attr("rel","noopener noreferrer")("Open Pinside History"),G.type`button`.class`admin-pill-button`.attr("disabled",ne=>s?"disabled":null).onClick(A)("Sync Pasted Text")),ne=>o?oe.style`color:#f6c177;`(o):"",rs.placeholder`Paste copied Pinside history text here.`.value(ne=>c).onInput(ne=>{var $e;c=(($e=ne==null?void 0:ne.target)==null?void 0:$e.value)||"",v()}).style`margin-top:0.8em;width:100%;min-height:120px;`()):""),m.class`admin-crud-card`(oe.style`margin-top:0;opacity:0.78;`("Manage the Firestore pastOwnedGames collection."),b=>i&&!h?oe.style`color:#f6c177;`(i):"",m.class`admin-crud-list`(b=>w===null?z.style`opacity:0.7;`("Loading games..."):w.length?Qk(w).map(ne=>l0({game:Wk(ne,E||[]),onClick:x}).key(ne.id)):z.style`opacity:0.7;`("No past owned games found. Use Add or paste Pinside history text."))),b=>h?u0({isEditing:!!f,editGame:g,gameLibrary:E||[],isGameLibraryLoaded:E!==null,errorMessage:i,fieldErrors:u,isSaving:n,isDeleting:r,onChange:ne=>{g=ne,u={...u,gameId:ne.gameId?"":u.gameId},v()},onSave:_,onDelete:I,onCancel:U}):""))}),l0=O(({game:t,onClick:e})=>(l0.inputs(n=>{[{game:t,onClick:e}]=n,e=K(e)}),G.type`button`.class`admin-crud-row`.onClick(()=>e(t))(n=>t.imageUrl?Y.class`admin-crud-thumb`.src`${t.imageUrl}`.attr("alt",r=>t.title||"Game image"):m.class`admin-crud-thumb admin-crud-thumb-placeholder`("PB"),m(fr(n=>t.title||"Untitled game"),m.style`margin-top:0.15em;opacity:0.74;`(z(n=>[t.manufacturer||"",t.yearReleased?String(t.yearReleased):""].filter(Boolean).join(" · ")||"No manufacturer/year",n=>t.gameId&&t.isMissingGame?Z.style`color:#f87171;font-weight:700;`(` · Missing game: ${t.gameId}`):"",n=>t.source==="pinside"?" · Pinside":""))),z.style`opacity:0.62;text-align:right;display:grid;gap:0.1em;`(Z.style`font-size:0.78em;text-transform:uppercase;`("Past Owned"),Z(n=>[gp(t.dateAddedToCollection),t.dateRemovedFromCollection?` to ${gp(t.dateRemovedFromCollection)}`:"",t.isVisible===!1?" · Hidden":""].join("")))))),Wk=(t,e)=>{const n=Jk(e,t);return{...t,title:(n==null?void 0:n.title)||t.title||t.sourceTitle||"",imageUrl:Kk(n,t),manufacturer:(n==null?void 0:n.manufacturer)||t.manufacturer||"",yearReleased:(n==null?void 0:n.yearReleased)??t.yearReleased??null,isMissingGame:!!(t.gameId&&!n)}},Jk=(t,e)=>Nc(t,e.gameId)||Nc(t,e.title)||Nc(t,e.sourceTitle)||null,Nc=(t,e)=>{const n=El(e),r=Lc(e);return n&&(t.find(s=>s.id===e)||t.find(s=>El(s.id)===n)||t.find(s=>Lc(s.id)===r)||t.find(s=>Lc(s.title)===r))||null},El=t=>String(t||"").trim().toLowerCase(),Lc=t=>El(t).replace(/['’]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,""),Kk=(t,e)=>String((t==null?void 0:t.imageUrl)||(t==null?void 0:t.gameImageUrl)||(t==null?void 0:t.backglassUrl)||(t==null?void 0:t.image)||e.imageUrl||e.gameImageUrl||e.backglassUrl||e.image||"").trim(),Qk=t=>[...t].sort((e,n)=>{const r=(e.gameId||"").localeCompare(n.gameId||"",void 0,{sensitivity:"base"});return r||(e.id||"").localeCompare(n.id||"",void 0,{sensitivity:"base"})}),u0=O(({isEditing:t,editGame:e,gameLibrary:n,isGameLibraryLoaded:r,errorMessage:s,fieldErrors:i,isSaving:o,isDeleting:c,onChange:l,onSave:u,onDelete:h,onCancel:f})=>{u0.inputs(w=>{[{isEditing:t,editGame:e,gameLibrary:n,isGameLibraryLoaded:r,errorMessage:s,fieldErrors:i,isSaving:o,isDeleting:c,onChange:l,onSave:u,onDelete:h,onCancel:f}]=w,l=K(l),u=K(u),h=K(h),f=K(f)});const g=w=>{l({...e,...w})};return m.class`admin-crud-modal-backdrop`(m.class`admin-crud-modal`(m.style`display:flex;justify-content:space-between;gap:1em;align-items:flex-start;`(m(et.style`margin:0;`(t?"Edit Past Game":"Add Past Game"),z.style`opacity:0.72;`(t?"Update this past owned entry.":"Create a new past owned entry.")),G.type`button`.class`admin-secondary-button`.onClick(f)("Cancel")),w=>s?oe.style`color:#f6c177;`(s):"",m.class`admin-crud-form-grid`.style`margin-top:1em;`(ce("Game"),w=>Pa({value:e.gameId||"",games:n,isLoaded:r,fieldError:i.gameId,onChange:E=>g({gameId:E})}).key(`${r?"loaded":"loading"}-${n.length}`),ce("Date Added to Collection"),ue.type`date`.value(w=>e.dateAddedToCollection||"").onInput(w=>{var E;g({dateAddedToCollection:((E=w==null?void 0:w.target)==null?void 0:E.value)||""})})(),ce("Date Removed from Collection"),ue.type`date`.value(w=>e.dateRemovedFromCollection||"").onInput(w=>{var E;g({dateRemovedFromCollection:((E=w==null?void 0:w.target)==null?void 0:E.value)||""})})(),ce("Pinside URL"),ue.type`url`.value(w=>e.pinsideUrl||"").onInput(w=>{var E;g({pinsideUrl:((E=w==null?void 0:w.target)==null?void 0:E.value)||""})})(),ce("Notes"),rs.value(w=>e.notes||"").onInput(w=>{var E;g({notes:((E=w==null?void 0:w.target)==null?void 0:E.value)||""})})(),ce("Visible on public page"),ce.style`display:flex;gap:0.5em;align-items:center;`(ue.type`checkbox`.attr("checked",w=>e.isVisible!==!1?"checked":null).onChange(w=>{var E;g({isVisible:!!((E=w==null?void 0:w.target)!=null&&E.checked)})})(),Z(w=>e.isVisible!==!1?"Visible":"Hidden"))),m.class`admin-crud-modal-actions`(m.style`display:flex;gap:0.7em;flex-wrap:wrap;`(G.type`button`.class`admin-pill-button`.attr("disabled",w=>o?"disabled":null).onClick(u)(w=>o?"Saving...":"Save"),G.type`button`.class`admin-secondary-button`.attr("disabled",w=>o?"disabled":null).onClick(f)("Cancel")),w=>t?G.type`button`.class`admin-danger-button`.attr("disabled",E=>c?"disabled":null).onClick(h)(E=>c?"🗑️ Deleting...":"🗑️ Delete"):"")))}),Yk=t=>{if(!t.trim())return[];const e=Xk(t);return e.length?e:Zk(t)},Xk=t=>{const e=new DOMParser().parseFromString(t,"text/html"),n=Array.from(e.querySelectorAll('a[href*="/pinball/machine/"]')),r=new Map;return n.forEach(s=>{var E;const i=d0(s.textContent||s.getAttribute("title")||"");if(!i||i.length<2)return;const o=s.getAttribute("href")||"",c=o.startsWith("http")?o:`https://pinside.com${o}`,l=s.closest("tr, li, article, .game, .machine, .collection-item")||s.parentElement,u=l==null?void 0:l.querySelector("img"),h=(u==null?void 0:u.getAttribute("src"))||(u==null?void 0:u.getAttribute("data-src"))||"",g=((l==null?void 0:l.textContent)||"").match(/\b(19\d{2}|20\d{2})\b/),w=((E=c.split("/pinball/machine/")[1])==null?void 0:E.split(/[/?#]/)[0])||"";r.set(c,{title:i,pinsideUrl:c,pinsideId:w,imageUrl:h.startsWith("//")?`https:${h}`:h,yearReleased:g?Number(g[1]):null})}),[...r.values()].sort((s,i)=>s.title.localeCompare(i.title,void 0,{sensitivity:"base"}))},Zk=t=>{const e=t.split(/\r?\n/).map(s=>s.trim()).filter(Boolean),n=[];let r=0;for(;r<e.length;){const s=d0(e[r]||""),i=e[r+1]||"",o=hp(i);if(!s||!o){r+=1;continue}const c={title:s,manufacturer:o.manufacturer,yearReleased:o.yearReleased};for(r+=2;r<e.length;){const l=e[r];if(hp(e[r+1]||"")&&!eS(l))break;const h=fp(l,"Purchased"),f=fp(l,"Sold");h?c.dateAddedToCollection=h:f&&(c.dateRemovedFromCollection=f),r+=1}n.push(c)}return n},hp=t=>{const e=t.match(/^(.+),\s*(19\d{2}|20\d{2})$/);return e?{manufacturer:e[1].trim(),yearReleased:Number(e[2])}:null},eS=t=>/^(Purchased|Sold)\s+[A-Za-z]+\s+\d{4}$/i.test(t),fp=(t,e)=>{const n=t.match(new RegExp(`^${e}\\s+([A-Za-z]+)\\s+(\\d{4})$`,"i"));if(!n)return"";const r=tS.findIndex(s=>s.toLowerCase()===n[1].toLowerCase());return r<0?"":`${n[2]}-${String(r+1).padStart(2,"0")}-01`},tS=["January","February","March","April","May","June","July","August","September","October","November","December"],d0=t=>t.replace(/\s+/g," ").replace(/\b(details|machine|view)\b/gi,"").trim(),pp=t=>{if(typeof t=="number"&&!Number.isNaN(t))return t;if(t===""||t===null||typeof t>"u")return null;const e=Number(t);return Number.isNaN(e)?null:e},vl=t=>t?typeof t=="string"?t.slice(0,10):typeof t.toDate=="function"?t.toDate().toISOString().slice(0,10):t.seconds?new Date(t.seconds*1e3).toISOString().slice(0,10):"":"",gp=t=>{const e=vl(t);if(!e)return"No date";const n=new Date(`${e}T12:00:00`);return Number.isNaN(n.getTime())?e:n.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})};let no=null;const nS=()=>window.QRCode?Promise.resolve():no||(no=new Promise((t,e)=>{const n=document.createElement("script");n.type="text/javascript",n.src="https://cdnjs.cloudflare.com/ajax/libs/qrcodejs/1.0.0/qrcode.min.js",n.onload=()=>t(),n.onerror=()=>e(new Error("Failed to load QRCode library")),document.head.appendChild(n)}),no),h0=O(t=>{const e=`qr-code-${Math.random().toString(36).slice(2,12)}`,n=()=>{window.requestAnimationFrame(s)},r=()=>{const i=window.QRCode;if(!i||!t)return;const o=document.getElementById(e);o&&(o.innerHTML="",new i(o,{text:t,width:300,height:300,colorDark:"#000000",colorLight:"#ffffff",correctLevel:i.CorrectLevel.L}))},s=()=>{nS().then(r).catch(i=>{console.error("Failed to render QR code",i)})};return h0.updates(i=>{i[0]!==t&&([t]=i,n())}),_g([t],n),m.id`${e}`.attr("oninit",n).style`display:flex;justify-content:center;align-items:center;margin-top:1em;min-height:300px;`()}),f0=O(({qrUrl:t,onQrUrlChange:e})=>{f0.inputs(r=>{[{qrUrl:t,onQrUrlChange:e}]=r,e=K(e)});const n=r=>{t=r,e(r)};return na.style`border:0;padding:0;margin:0;`(ue.type`text`.placeholder`paste website address`.value(r=>t).maxLength`1000`.onInput(r=>{n(r.target.value)}),m.style`display:flex;flex-direction:column;align-items:center;gap:0.5em;`(r=>(console.log("qrUrl check display",{qrUrl:t}),t&&h0(t)),r=>t&&z.style`max-width:300px;overflow-wrap:anywhere;text-align:center;opacity:0.75;line-height:1.3;`(s=>t)))}),PS=br(t=>p0(t)),p0=O(t=>{let e=new URLSearchParams(window.location.search).get("url")||"";p0.inputs(([r])=>{t=K(r)});const n=()=>dt().then(t).catch(r=>{console.error("Failed to sign out",r)});return ve(Ye(()=>Lt(n)),m.class`admin-crud-page`(m.class`admin-crud-header`(et(Y.src`../assets/media/icon.png`.style`width:40px;margin-right:10px;`,"🔗 QR Maker")),m.class`admin-crud-card`(r=>f0({qrUrl:e,onQrUrlChange:s=>{e=s,console.log("set qrUrl",{qrUrl:e})}}))))}),ys=O(()=>[q.href`/index.html`.class`top-nav-pill`("🏠"),q.href`/meetup.html`.class`top-nav-pill`("🗓️ meetups"),q.href`/lineup.html`.class`top-nav-pill`("⚪️ games"),q.href`/ratings.html`.class`top-nav-pill`("⭐ ratings"),q.href`/index.html#links`.class`top-nav-pill`("🔗 links"),q.href`/index.html#merch`.class`top-nav-pill`("👕 merch & more"),q.href`/index.html#youtube`.class`top-nav-pill`("📺 youtube"),q.href`/index.html#awards`.class`top-nav-pill`("🏆 awards"),q.href`/admin.html`.class`top-nav-pill`("👤")]);let mp=!1;const rS=O(()=>mp?"":(mp=!0,Vt(`
    .public-footer {
      width: 100%;
      box-sizing: border-box;
      margin-top: 3em;
