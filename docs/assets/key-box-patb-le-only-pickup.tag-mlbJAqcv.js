 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ut=new fl("@firebase/app"),IE="@firebase/app-compat",AE="@firebase/analytics-compat",CE="@firebase/analytics",RE="@firebase/app-check-compat",SE="@firebase/app-check",kE="@firebase/auth",PE="@firebase/auth-compat",xE="@firebase/database",VE="@firebase/data-connect",NE="@firebase/database-compat",DE="@firebase/functions",OE="@firebase/functions-compat",LE="@firebase/installations",ME="@firebase/installations-compat",FE="@firebase/messaging",UE="@firebase/messaging-compat",jE="@firebase/performance",BE="@firebase/performance-compat",HE="@firebase/remote-config",$E="@firebase/remote-config-compat",qE="@firebase/storage",zE="@firebase/storage-compat",GE="@firebase/firestore",WE="@firebase/ai",JE="@firebase/firestore-compat",KE="firebase",QE="12.8.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ec="[DEFAULT]",YE={[Tc]:"fire-core",[IE]:"fire-core-compat",[CE]:"fire-analytics",[AE]:"fire-analytics-compat",[SE]:"fire-app-check",[RE]:"fire-app-check-compat",[kE]:"fire-auth",[PE]:"fire-auth-compat",[xE]:"fire-rtdb",[VE]:"fire-data-connect",[NE]:"fire-rtdb-compat",[DE]:"fire-fn",[OE]:"fire-fn-compat",[LE]:"fire-iid",[ME]:"fire-iid-compat",[FE]:"fire-fcm",[UE]:"fire-fcm-compat",[jE]:"fire-perf",[BE]:"fire-perf-compat",[HE]:"fire-rc",[$E]:"fire-rc-compat",[qE]:"fire-gcs",[zE]:"fire-gcs-compat",[GE]:"fire-fst",[JE]:"fire-fst-compat",[WE]:"fire-vertex","fire-js":"fire-js",[KE]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ao(n){var p;const e=n.auth,t=await n.getIdToken(),r=await Fs(n,oo(e,{idToken:t}));J(r==null?void 0:r.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const i=(p=s.providerUserInfo)!=null&&p.length?_g(s.providerUserInfo):[],o=Sv(n.providerData,i),c=n.isAnonymous,l=!(n.email&&s.passwordHash)&&!(o!=null&&o.length),u=c?l:!1,d={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:o,metadata:new Ac(s.createdAt,s.lastLoginAt),isAnonymous:u};Object.assign(n,d)}async function Rv(n){const e=We(n);await ao(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Sv(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function _g(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kv(n,e){const t=await mg(n,{},async()=>{const r=ei({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=n.config,o=await yg(n,s,"/v1/token",`key=${i}`),c=await n._getAdditionalHeaders();c["Content-Type"]="application/x-www-form-urlencoded";const l={method:"POST",headers:c,body:r};return n.emulatorConfig&&zr(n.emulatorConfig.host)&&(l.credentials="include"),gg.fetch()(o,l)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function Pv(n,e){return Wr(n,"POST","/v2/accounts:revokeToken",bl(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sg(n,e=[]){let t;switch(n){case"Browser":t=rd(Ge());break;case"Worker":t=`${rd(Ge())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Gr}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hv(n,e){const t=gl(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(Yn(i,e??{}))return s;St(s,"already-initialized")}return t.initialize({options:e})}function $v(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(Ot);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function qv(n,e,t){const r=Jr(n);J(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=kg(e),{host:o,port:c}=zv(e),l=c===null?"":`:${c}`,u={url:`${i}//${o}${l}/`},d=Object.freeze({host:o,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){J(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),J(Yn(u,r.config.emulator)&&Yn(d,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=u,r.emulatorConfig=d,r.settings.appVerificationDisabledForTesting=!0,zr(o)?(sg(`${i}//${o}${l}`),ig("Auth",!0)):Gv()}function kg(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function zv(n){const e=kg(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:id(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:id(o)}}}function id(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Gv(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bg{constructor(e,t,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:i,error:o,type:c}=e;if(o){this.reject(o);return}const l={auth:this.auth,requestUri:t,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(c)(l))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return gI;case"linkViaPopup":case"linkViaRedirect":return yI;case"reauthViaPopup":case"reauthViaRedirect":return mI;default:St(this.auth,"internal-error")}}resolve(e){jt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){jt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $a="webStorageSupport";class r1{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=vl,this._completeRedirectFn=qg,this._overrideRedirectResult=II}async _openPopup(e,t,r,s){var o;jt((o=this.eventManagers[e._key()])==null?void 0:o.manager,"_initialize() not called before _openPopup()");const i=await dd(e,t,r,Ic(),s);return YI(e,i,Il())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await dd(e,t,r,Ic(),s);return oI(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(jt(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await zI(e),r=new kI(e);return t.register("authEvent",s=>(J(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send($a,{type:$a},s=>{var o;const i=(o=s==null?void 0:s[0])==null?void 0:o[$a];i!==void 0&&t(!!i),St(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=DI(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Rg()||Tg()||Tl()}}const s1=r1;var fd="@firebase/auth",pd="1.12.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var gn,Gg;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(_,b){function w(){}w.prototype=b.prototype,_.F=b.prototype,_.prototype=new w,_.prototype.constructor=_,_.D=function(A,I,S){for(var T=Array(arguments.length-2),Qe=2;Qe<arguments.length;Qe++)T[Qe-2]=arguments[Qe];return b.prototype[I].apply(A,T)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,t),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(_,b,w){w||(w=0);const A=Array(16);if(typeof b=="string")for(var I=0;I<16;++I)A[I]=b.charCodeAt(w++)|b.charCodeAt(w++)<<8|b.charCodeAt(w++)<<16|b.charCodeAt(w++)<<24;else for(I=0;I<16;++I)A[I]=b[w++]|b[w++]<<8|b[w++]<<16|b[w++]<<24;b=_.g[0],w=_.g[1],I=_.g[2];let S=_.g[3],T;T=b+(S^w&(I^S))+A[0]+3614090360&4294967295,b=w+(T<<7&4294967295|T>>>25),T=S+(I^b&(w^I))+A[1]+3905402710&4294967295,S=b+(T<<12&4294967295|T>>>20),T=I+(w^S&(b^w))+A[2]+606105819&4294967295,I=S+(T<<17&4294967295|T>>>15),T=w+(b^I&(S^b))+A[3]+3250441966&4294967295,w=I+(T<<22&4294967295|T>>>10),T=b+(S^w&(I^S))+A[4]+4118548399&4294967295,b=w+(T<<7&4294967295|T>>>25),T=S+(I^b&(w^I))+A[5]+1200080426&4294967295,S=b+(T<<12&4294967295|T>>>20),T=I+(w^S&(b^w))+A[6]+2821735955&4294967295,I=S+(T<<17&4294967295|T>>>15),T=w+(b^I&(S^b))+A[7]+4249261313&4294967295,w=I+(T<<22&4294967295|T>>>10),T=b+(S^w&(I^S))+A[8]+1770035416&4294967295,b=w+(T<<7&4294967295|T>>>25),T=S+(I^b&(w^I))+A[9]+2336552879&4294967295,S=b+(T<<12&4294967295|T>>>20),T=I+(w^S&(b^w))+A[10]+4294925233&4294967295,I=S+(T<<17&4294967295|T>>>15),T=w+(b^I&(S^b))+A[11]+2304563134&4294967295,w=I+(T<<22&4294967295|T>>>10),T=b+(S^w&(I^S))+A[12]+1804603682&4294967295,b=w+(T<<7&4294967295|T>>>25),T=S+(I^b&(w^I))+A[13]+4254626195&4294967295,S=b+(T<<12&4294967295|T>>>20),T=I+(w^S&(b^w))+A[14]+2792965006&4294967295,I=S+(T<<17&4294967295|T>>>15),T=w+(b^I&(S^b))+A[15]+1236535329&4294967295,w=I+(T<<22&4294967295|T>>>10),T=b+(I^S&(w^I))+A[1]+4129170786&4294967295,b=w+(T<<5&4294967295|T>>>27),T=S+(w^I&(b^w))+A[6]+3225465664&4294967295,S=b+(T<<9&4294967295|T>>>23),T=I+(b^w&(S^b))+A[11]+643717713&4294967295,I=S+(T<<14&4294967295|T>>>18),T=w+(S^b&(I^S))+A[0]+3921069994&4294967295,w=I+(T<<20&4294967295|T>>>12),T=b+(I^S&(w^I))+A[5]+3593408605&4294967295,b=w+(T<<5&4294967295|T>>>27),T=S+(w^I&(b^w))+A[10]+38016083&4294967295,S=b+(T<<9&4294967295|T>>>23),T=I+(b^w&(S^b))+A[15]+3634488961&4294967295,I=S+(T<<14&4294967295|T>>>18),T=w+(S^b&(I^S))+A[4]+3889429448&4294967295,w=I+(T<<20&4294967295|T>>>12),T=b+(I^S&(w^I))+A[9]+568446438&4294967295,b=w+(T<<5&4294967295|T>>>27),T=S+(w^I&(b^w))+A[14]+3275163606&4294967295,S=b+(T<<9&4294967295|T>>>23),T=I+(b^w&(S^b))+A[3]+4107603335&4294967295,I=S+(T<<14&4294967295|T>>>18),T=w+(S^b&(I^S))+A[8]+1163531501&4294967295,w=I+(T<<20&4294967295|T>>>12),T=b+(I^S&(w^I))+A[13]+2850285829&4294967295,b=w+(T<<5&4294967295|T>>>27),T=S+(w^I&(b^w))+A[2]+4243563512&4294967295,S=b+(T<<9&4294967295|T>>>23),T=I+(b^w&(S^b))+A[7]+1735328473&4294967295,I=S+(T<<14&4294967295|T>>>18),T=w+(S^b&(I^S))+A[12]+2368359562&4294967295,w=I+(T<<20&4294967295|T>>>12),T=b+(w^I^S)+A[5]+4294588738&4294967295,b=w+(T<<4&4294967295|T>>>28),T=S+(b^w^I)+A[8]+2272392833&4294967295,S=b+(T<<11&4294967295|T>>>21),T=I+(S^b^w)+A[11]+1839030562&4294967295,I=S+(T<<16&4294967295|T>>>16),T=w+(I^S^b)+A[14]+4259657740&4294967295,w=I+(T<<23&4294967295|T>>>9),T=b+(w^I^S)+A[1]+2763975236&4294967295,b=w+(T<<4&4294967295|T>>>28),T=S+(b^w^I)+A[4]+1272893353&4294967295,S=b+(T<<11&4294967295|T>>>21),T=I+(S^b^w)+A[7]+4139469664&4294967295,I=S+(T<<16&4294967295|T>>>16),T=w+(I^S^b)+A[10]+3200236656&4294967295,w=I+(T<<23&4294967295|T>>>9),T=b+(w^I^S)+A[13]+681279174&4294967295,b=w+(T<<4&4294967295|T>>>28),T=S+(b^w^I)+A[0]+3936430074&4294967295,S=b+(T<<11&4294967295|T>>>21),T=I+(S^b^w)+A[3]+3572445317&4294967295,I=S+(T<<16&4294967295|T>>>16),T=w+(I^S^b)+A[6]+76029189&4294967295,w=I+(T<<23&4294967295|T>>>9),T=b+(w^I^S)+A[9]+3654602809&4294967295,b=w+(T<<4&4294967295|T>>>28),T=S+(b^w^I)+A[12]+3873151461&4294967295,S=b+(T<<11&4294967295|T>>>21),T=I+(S^b^w)+A[15]+530742520&4294967295,I=S+(T<<16&4294967295|T>>>16),T=w+(I^S^b)+A[2]+3299628645&4294967295,w=I+(T<<23&4294967295|T>>>9),T=b+(I^(w|~S))+A[0]+4096336452&4294967295,b=w+(T<<6&4294967295|T>>>26),T=S+(w^(b|~I))+A[7]+1126891415&4294967295,S=b+(T<<10&4294967295|T>>>22),T=I+(b^(S|~w))+A[14]+2878612391&4294967295,I=S+(T<<15&4294967295|T>>>17),T=w+(S^(I|~b))+A[5]+4237533241&4294967295,w=I+(T<<21&4294967295|T>>>11),T=b+(I^(w|~S))+A[12]+1700485571&4294967295,b=w+(T<<6&4294967295|T>>>26),T=S+(w^(b|~I))+A[3]+2399980690&4294967295,S=b+(T<<10&4294967295|T>>>22),T=I+(b^(S|~w))+A[10]+4293915773&4294967295,I=S+(T<<15&4294967295|T>>>17),T=w+(S^(I|~b))+A[1]+2240044497&4294967295,w=I+(T<<21&4294967295|T>>>11),T=b+(I^(w|~S))+A[8]+1873313359&4294967295,b=w+(T<<6&4294967295|T>>>26),T=S+(w^(b|~I))+A[15]+4264355552&4294967295,S=b+(T<<10&4294967295|T>>>22),T=I+(b^(S|~w))+A[6]+2734768916&4294967295,I=S+(T<<15&4294967295|T>>>17),T=w+(S^(I|~b))+A[13]+1309151649&4294967295,w=I+(T<<21&4294967295|T>>>11),T=b+(I^(w|~S))+A[4]+4149444226&4294967295,b=w+(T<<6&4294967295|T>>>26),T=S+(w^(b|~I))+A[11]+3174756917&4294967295,S=b+(T<<10&4294967295|T>>>22),T=I+(b^(S|~w))+A[2]+718787259&4294967295,I=S+(T<<15&4294967295|T>>>17),T=w+(S^(I|~b))+A[9]+3951481745&4294967295,_.g[0]=_.g[0]+b&4294967295,_.g[1]=_.g[1]+(I+(T<<21&4294967295|T>>>11))&4294967295,_.g[2]=_.g[2]+I&4294967295,_.g[3]=_.g[3]+S&4294967295}r.prototype.v=function(_,b){b===void 0&&(b=_.length);const w=b-this.blockSize,A=this.C;let I=this.h,S=0;for(;S<b;){if(I==0)for(;S<=w;)s(this,_,S),S+=this.blockSize;if(typeof _=="string"){for(;S<b;)if(A[I++]=_.charCodeAt(S++),I==this.blockSize){s(this,A),I=0;break}}else for(;S<b;)if(A[I++]=_[S++],I==this.blockSize){s(this,A),I=0;break}}this.h=I,this.o+=b},r.prototype.A=function(){var _=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);_[0]=128;for(var b=1;b<_.length-8;++b)_[b]=0;b=this.o*8;for(var w=_.length-8;w<_.length;++w)_[w]=b&255,b/=256;for(this.v(_),_=Array(16),b=0,w=0;w<4;++w)for(let A=0;A<32;A+=8)_[b++]=this.g[w]>>>A&255;return _};function i(_,b){var w=c;return Object.prototype.hasOwnProperty.call(w,_)?w[_]:w[_]=b(_)}function o(_,b){this.h=b;const w=[];let A=!0;for(let I=_.length-1;I>=0;I--){const S=_[I]|0;A&&S==b||(w[I]=S,A=!1)}this.g=w}var c={};function l(_){return-128<=_&&_<128?i(_,function(b){return new o([b|0],b<0?-1:0)}):new o([_|0],_<0?-1:0)}function u(_){if(isNaN(_)||!isFinite(_))return p;if(_<0)return D(u(-_));const b=[];let w=1;for(let A=0;_>=w;A++)b[A]=_/w|0,w*=4294967296;return new o(b,0)}function d(_,b){if(_.length==0)throw Error("number format error: empty string");if(b=b||10,b<2||36<b)throw Error("radix out of range: "+b);if(_.charAt(0)=="-")return D(d(_.substring(1),b));if(_.indexOf("-")>=0)throw Error('number format error: interior "-" character');const w=u(Math.pow(b,8));let A=p;for(let S=0;S<_.length;S+=8){var I=Math.min(8,_.length-S);const T=parseInt(_.substring(S,S+I),b);I<8?(I=u(Math.pow(b,I)),A=A.j(I).add(u(T))):(A=A.j(w),A=A.add(u(T)))}return A}var p=l(0),m=l(1),E=l(16777216);n=o.prototype,n.m=function(){if(C(this))return-D(this).m();let _=0,b=1;for(let w=0;w<this.g.length;w++){const A=this.i(w);_+=(A>=0?A:4294967296+A)*b,b*=4294967296}return _},n.toString=function(_){if(_=_||10,_<2||36<_)throw Error("radix out of range: "+_);if(v(this))return"0";if(C(this))return"-"+D(this).toString(_);const b=u(Math.pow(_,6));var w=this;let A="";for(;;){const I=G(w,b).g;w=O(w,I.j(b));let S=((w.g.length>0?w.g[0]:w.h)>>>0).toString(_);if(w=I,v(w))return S+A;for(;S.length<6;)S="0"+S;A=S+A}},n.i=function(_){return _<0?0:_<this.g.length?this.g[_]:this.h};function v(_){if(_.h!=0)return!1;for(let b=0;b<_.g.length;b++)if(_.g[b]!=0)return!1;return!0}function C(_){return _.h==-1}n.l=function(_){return _=O(this,_),C(_)?-1:v(_)?0:1};function D(_){const b=_.g.length,w=[];for(let A=0;A<b;A++)w[A]=~_.g[A];return new o(w,~_.h).add(m)}n.abs=function(){return C(this)?D(this):this},n.add=function(_){const b=Math.max(this.g.length,_.g.length),w=[];let A=0;for(let I=0;I<=b;I++){let S=A+(this.i(I)&65535)+(_.i(I)&65535),T=(S>>>16)+(this.i(I)>>>16)+(_.i(I)>>>16);A=T>>>16,S&=65535,T&=65535,w[I]=T<<16|S}return new o(w,w[w.length-1]&-2147483648?-1:0)};function O(_,b){return _.add(D(b))}n.j=function(_){if(v(this)||v(_))return p;if(C(this))return C(_)?D(this).j(D(_)):D(D(this).j(_));if(C(_))return D(this.j(D(_)));if(this.l(E)<0&&_.l(E)<0)return u(this.m()*_.m());const b=this.g.length+_.g.length,w=[];for(var A=0;A<2*b;A++)w[A]=0;for(A=0;A<this.g.length;A++)for(let I=0;I<_.g.length;I++){const S=this.i(A)>>>16,T=this.i(A)&65535,Qe=_.i(I)>>>16,Rn=_.i(I)&65535;w[2*A+2*I]+=T*Rn,x(w,2*A+2*I),w[2*A+2*I+1]+=S*Rn,x(w,2*A+2*I+1),w[2*A+2*I+1]+=T*Qe,x(w,2*A+2*I+1),w[2*A+2*I+2]+=S*Qe,x(w,2*A+2*I+2)}for(_=0;_<b;_++)w[_]=w[2*_+1]<<16|w[2*_];for(_=b;_<2*b;_++)w[_]=0;return new o(w,0)};function x(_,b){for(;(_[b]&65535)!=_[b];)_[b+1]+=_[b]>>>16,_[b]&=65535,b++}function L(_,b){this.g=_,this.h=b}function G(_,b){if(v(b))throw Error("division by zero");if(v(_))return new L(p,p);if(C(_))return b=G(D(_),b),new L(D(b.g),D(b.h));if(C(b))return b=G(_,D(b)),new L(D(b.g),b.h);if(_.g.length>30){if(C(_)||C(b))throw Error("slowDivide_ only works with positive integers.");for(var w=m,A=b;A.l(_)<=0;)w=P(w),A=P(A);var I=U(w,1),S=U(A,1);for(A=U(A,2),w=U(w,2);!v(A);){var T=S.add(A);T.l(_)<=0&&(I=I.add(w),S=T),A=U(A,1),w=U(w,1)}return b=O(_,I.j(b)),new L(I,b)}for(I=p;_.l(b)>=0;){for(w=Math.max(1,Math.floor(_.m()/b.m())),A=Math.ceil(Math.log(w)/Math.LN2),A=A<=48?1:Math.pow(2,A-48),S=u(w),T=S.j(b);C(T)||T.l(_)>0;)w-=A,S=u(w),T=S.j(b);v(S)&&(S=m),I=I.add(S),_=O(_,T)}return new L(I,_)}n.B=function(_){return G(this,_).h},n.and=function(_){const b=Math.max(this.g.length,_.g.length),w=[];for(let A=0;A<b;A++)w[A]=this.i(A)&_.i(A);return new o(w,this.h&_.h)},n.or=function(_){const b=Math.max(this.g.length,_.g.length),w=[];for(let A=0;A<b;A++)w[A]=this.i(A)|_.i(A);return new o(w,this.h|_.h)},n.xor=function(_){const b=Math.max(this.g.length,_.g.length),w=[];for(let A=0;A<b;A++)w[A]=this.i(A)^_.i(A);return new o(w,this.h^_.h)};function P(_){const b=_.g.length+1,w=[];for(let A=0;A<b;A++)w[A]=_.i(A)<<1|_.i(A-1)>>>31;return new o(w,_.h)}function U(_,b){const w=b>>5;b%=32;const A=_.g.length-w,I=[];for(let S=0;S<A;S++)I[S]=b>0?_.i(S+w)>>>b|_.i(S+w+1)<<32-b:_.i(S+w);return new o(I,_.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,Gg=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=u,o.fromString=d,gn=o}).apply(typeof md<"u"?md:typeof self<"u"?self:typeof window<"u"?window:{});var xi=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Wg,Ts,Jg,zi,Rc,Kg,Qg,Yg;(function(){var n,e=Object.defineProperty;function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof xi=="object"&&xi];for(var h=0;h<a.length;++h){var f=a[h];if(f&&f.Math==Math)return f}throw Error("Cannot find global object")}var r=t(this);function s(a,h){if(h)e:{var f=r;a=a.split(".");for(var g=0;g<a.length-1;g++){var R=a[g];if(!(R in f))break e;f=f[R]}a=a[a.length-1],g=f[a],h=h(g),h!=g&&h!=null&&e(f,a,{configurable:!0,writable:!0,value:h})}}s("Symbol.dispose",function(a){return a||Symbol("Symbol.dispose")}),s("Array.prototype.values",function(a){return a||function(){return this[Symbol.iterator]()}}),s("Object.entries",function(a){return a||function(h){var f=[],g;for(g in h)Object.prototype.hasOwnProperty.call(h,g)&&f.push([g,h[g]]);return f}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var i=i||{},o=this||self;function c(a){var h=typeof a;return h=="object"&&a!=null||h=="function"}function l(a,h,f){return a.call.apply(a.bind,arguments)}function u(a,h,f){return u=l,u.apply(null,arguments)}function d(a,h){var f=Array.prototype.slice.call(arguments,1);return function(){var g=f.slice();return g.push.apply(g,arguments),a.apply(this,g)}}function p(a,h){function f(){}f.prototype=h.prototype,a.Z=h.prototype,a.prototype=new f,a.prototype.constructor=a,a.Ob=function(g,R,k){for(var F=Array(arguments.length-2),te=2;te<arguments.length;te++)F[te-2]=arguments[te];return h.prototype[R].apply(g,F)}}var m=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?a=>a&&AsyncContext.Snapshot.wrap(a):a=>a;function E(a){const h=a.length;if(h>0){const f=Array(h);for(let g=0;g<h;g++)f[g]=a[g];return f}return[]}function v(a,h){for(let g=1;g<arguments.length;g++){const R=arguments[g];var f=typeof R;if(f=f!="object"?f:R?Array.isArray(R)?"array":f:"null",f=="array"||f=="object"&&typeof R.length=="number"){f=a.length||0;const k=R.length||0;a.length=f+k;for(let F=0;F<k;F++)a[f+F]=R[F]}else a.push(R)}}class C{constructor(h,f){this.i=h,this.j=f,this.h=0,this.g=null}get(){let h;return this.h>0?(this.h--,h=this.g,this.g=h.next,h.next=null):h=this.i(),h}}function D(a){o.setTimeout(()=>{throw a},0)}function O(){var a=_;let h=null;return a.g&&(h=a.g,a.g=a.g.next,a.g||(a.h=null),h.next=null),h}class x{constructor(){this.h=this.g=null}add(h,f){const g=L.get();g.set(h,f),this.h?this.h.next=g:this.g=g,this.h=g}}var L=new C(()=>new G,a=>a.reset());class G{constructor(){this.next=this.g=this.h=null}set(h,f){this.h=h,this.g=f,this.next=null}reset(){this.next=this.g=this.h=null}}let P,U=!1,_=new x,b=()=>{const a=Promise.resolve(void 0);P=()=>{a.then(w)}};function w(){for(var a;a=O();){try{a.h.call(a.g)}catch(f){D(f)}var h=L;h.j(a),h.h<100&&(h.h++,a.next=h.g,h.g=a)}U=!1}function A(){this.u=this.u,this.C=this.C}A.prototype.u=!1,A.prototype.dispose=function(){this.u||(this.u=!0,this.N())},A.prototype[Symbol.dispose]=function(){this.dispose()},A.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function I(a,h){this.type=a,this.g=this.target=h,this.defaultPrevented=!1}I.prototype.h=function(){this.defaultPrevented=!0};var S=(function(){if(!o.addEventListener||!Object.defineProperty)return!1;var a=!1,h=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const f=()=>{};o.addEventListener("test",f,h),o.removeEventListener("test",f,h)}catch{}return a})();function T(a){return/^[\s\xa0]*$/.test(a)}function Qe(a,h){I.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a&&this.init(a,h)}p(Qe,I),Qe.prototype.init=function(a,h){const f=this.type=a.type,g=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement,this.g=h,h=a.relatedTarget,h||(f=="mouseover"?h=a.fromElement:f=="mouseout"&&(h=a.toElement)),this.relatedTarget=h,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=a.pointerType,this.state=a.state,this.i=a,a.defaultPrevented&&Qe.Z.h.call(this)},Qe.prototype.h=function(){Qe.Z.h.call(this);const a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var Rn="closure_listenable_"+(Math.random()*1e6|0),p_=0;function g_(a,h,f,g,R){this.listener=a,this.proxy=null,this.src=h,this.type=f,this.capture=!!g,this.ha=R,this.key=++p_,this.da=this.fa=!1}function pi(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function gi(a,h,f){for(const g in a)h.call(f,a[g],g,a)}function m_(a,h){for(const f in a)h.call(void 0,a[f],f,a)}function Cu(a){const h={};for(const f in a)h[f]=a[f];return h}const Ru="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Su(a,h){let f,g;for(let R=1;R<arguments.length;R++){g=arguments[R];for(f in g)a[f]=g[f];for(let k=0;k<Ru.length;k++)f=Ru[k],Object.prototype.hasOwnProperty.call(g,f)&&(a[f]=g[f])}}function mi(a){this.src=a,this.g={},this.h=0}mi.prototype.add=function(a,h,f,g,R){const k=a.toString();a=this.g[k],a||(a=this.g[k]=[],this.h++);const F=ha(a,h,g,R);return F>-1?(h=a[F],f||(h.fa=!1)):(h=new g_(h,this.src,k,!!g,R),h.fa=f,a.push(h)),h};function ua(a,h){const f=h.type;if(f in a.g){var g=a.g[f],R=Array.prototype.indexOf.call(g,h,void 0),k;(k=R>=0)&&Array.prototype.splice.call(g,R,1),k&&(pi(h),a.g[f].length==0&&(delete a.g[f],a.h--))}}function ha(a,h,f,g){for(let R=0;R<a.length;++R){const k=a[R];if(!k.da&&k.listener==h&&k.capture==!!f&&k.ha==g)return R}return-1}var da="closure_lm_"+(Math.random()*1e6|0),fa={};function ku(a,h,f,g,R){if(Array.isArray(h)){for(let k=0;k<h.length;k++)ku(a,h[k],f,g,R);return null}return f=Vu(f),a&&a[Rn]?a.J(h,f,c(g)?!!g.capture:!1,R):y_(a,h,f,!1,g,R)}function y_(a,h,f,g,R,k){if(!h)throw Error("Invalid event type");const F=c(R)?!!R.capture:!!R;let te=ga(a);if(te||(a[da]=te=new mi(a)),f=te.add(h,f,g,F,k),f.proxy)return f;if(g=__(),f.proxy=g,g.src=a,g.listener=f,a.addEventListener)S||(R=F),R===void 0&&(R=!1),a.addEventListener(h.toString(),g,R);else if(a.attachEvent)a.attachEvent(xu(h.toString()),g);else if(a.addListener&&a.removeListener)a.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return f}function __(){function a(f){return h.call(a.src,a.listener,f)}const h=b_;return a}function Pu(a,h,f,g,R){if(Array.isArray(h))for(var k=0;k<h.length;k++)Pu(a,h[k],f,g,R);else g=c(g)?!!g.capture:!!g,f=Vu(f),a&&a[Rn]?(a=a.i,k=String(h).toString(),k in a.g&&(h=a.g[k],f=ha(h,f,g,R),f>-1&&(pi(h[f]),Array.prototype.splice.call(h,f,1),h.length==0&&(delete a.g[k],a.h--)))):a&&(a=ga(a))&&(h=a.g[h.toString()],a=-1,h&&(a=ha(h,f,g,R)),(f=a>-1?h[a]:null)&&pa(f))}function pa(a){if(typeof a!="number"&&a&&!a.da){var h=a.src;if(h&&h[Rn])ua(h.i,a);else{var f=a.type,g=a.proxy;h.removeEventListener?h.removeEventListener(f,g,a.capture):h.detachEvent?h.detachEvent(xu(f),g):h.addListener&&h.removeListener&&h.removeListener(g),(f=ga(h))?(ua(f,a),f.h==0&&(f.src=null,h[da]=null)):pi(a)}}}function xu(a){return a in fa?fa[a]:fa[a]="on"+a}function b_(a,h){if(a.da)a=!0;else{h=new Qe(h,this);const f=a.listener,g=a.ha||a.src;a.fa&&pa(a),a=f.call(g,h)}return a}function ga(a){return a=a[da],a instanceof mi?a:null}var ma="__closure_events_fn_"+(Math.random()*1e9>>>0);function Vu(a){return typeof a=="function"?a:(a[ma]||(a[ma]=function(h){return a.handleEvent(h)}),a[ma])}function Ue(){A.call(this),this.i=new mi(this),this.M=this,this.G=null}p(Ue,A),Ue.prototype[Rn]=!0,Ue.prototype.removeEventListener=function(a,h,f,g){Pu(this,a,h,f,g)};function Je(a,h){var f,g=a.G;if(g)for(f=[];g;g=g.G)f.push(g);if(a=a.M,g=h.type||h,typeof h=="string")h=new I(h,a);else if(h instanceof I)h.target=h.target||a;else{var R=h;h=new I(g,a),Su(h,R)}R=!0;let k,F;if(f)for(F=f.length-1;F>=0;F--)k=h.g=f[F],R=yi(k,g,!0,h)&&R;if(k=h.g=a,R=yi(k,g,!0,h)&&R,R=yi(k,g,!1,h)&&R,f)for(F=0;F<f.length;F++)k=h.g=f[F],R=yi(k,g,!1,h)&&R}Ue.prototype.N=function(){if(Ue.Z.N.call(this),this.i){var a=this.i;for(const h in a.g){const f=a.g[h];for(let g=0;g<f.length;g++)pi(f[g]);delete a.g[h],a.h--}}this.G=null},Ue.prototype.J=function(a,h,f,g){return this.i.add(String(a),h,!1,f,g)},Ue.prototype.K=function(a,h,f,g){return this.i.add(String(a),h,!0,f,g)};function yi(a,h,f,g){if(h=a.i.g[String(h)],!h)return!0;h=h.concat();let R=!0;for(let k=0;k<h.length;++k){const F=h[k];if(F&&!F.da&&F.capture==f){const te=F.listener,ke=F.ha||F.src;F.fa&&ua(a.i,F),R=te.call(ke,g)!==!1&&R}}return R&&!g.defaultPrevented}function w_(a,h){if(typeof a!="function")if(a&&typeof a.handleEvent=="function")a=u(a.handleEvent,a);else throw Error("Invalid listener argument");return Number(h)>2147483647?-1:o.setTimeout(a,h||0)}function Nu(a){a.g=w_(()=>{a.g=null,a.i&&(a.i=!1,Nu(a))},a.l);const h=a.h;a.h=null,a.m.apply(null,h)}class T_ extends A{constructor(h,f){super(),this.m=h,this.l=f,this.h=null,this.i=!1,this.g=null}j(h){this.h=arguments,this.g?this.i=!0:Nu(this)}N(){super.N(),this.g&&(o.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function es(a){A.call(this),this.h=a,this.g={}}p(es,A);var Du=[];function Ou(a){gi(a.g,function(h,f){this.g.hasOwnProperty(f)&&pa(h)},a),a.g={}}es.prototype.N=function(){es.Z.N.call(this),Ou(this)},es.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ya=o.JSON.stringify,E_=o.JSON.parse,v_=class{stringify(a){return o.JSON.stringify(a,void 0)}parse(a){return o.JSON.parse(a,void 0)}};function Lu(){}function Mu(){}var ts={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function _a(){I.call(this,"d")}p(_a,I);function ba(){I.call(this,"c")}p(ba,I);var Sn={},Fu=null;function _i(){return Fu=Fu||new Ue}Sn.Ia="serverreachability";function Uu(a){I.call(this,Sn.Ia,a)}p(Uu,I);function ns(a){const h=_i();Je(h,new Uu(h))}Sn.STAT_EVENT="statevent";function ju(a,h){I.call(this,Sn.STAT_EVENT,a),this.stat=h}p(ju,I);function Ke(a){const h=_i();Je(h,new ju(h,a))}Sn.Ja="timingevent";function Bu(a,h){I.call(this,Sn.Ja,a),this.size=h}p(Bu,I);function rs(a,h){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return o.setTimeout(function(){a()},h)}function ss(){this.g=!0}ss.prototype.ua=function(){this.g=!1};function I_(a,h,f,g,R,k){a.info(function(){if(a.g)if(k){var F="",te=k.split("&");for(let de=0;de<te.length;de++){var ke=te[de].split("=");if(ke.length>1){const xe=ke[0];ke=ke[1];const Tt=xe.split("_");F=Tt.length>=2&&Tt[1]=="type"?F+(xe+"="+ke+"&"):F+(xe+"=redacted&")}}}else F=null;else F=k;return"XMLHTTP REQ ("+g+") [attempt "+R+"]: "+h+`
`+f+`
`+F})}function A_(a,h,f,g,R,k,F){a.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+R+"]: "+h+`
`+f+`
`+k+" "+F})}function dr(a,h,f,g){a.info(function(){return"XMLHTTP TEXT ("+h+"): "+R_(a,f)+(g?" "+g:"")})}function C_(a,h){a.info(function(){return"TIMEOUT: "+h})}ss.prototype.info=function(){};function R_(a,h){if(!a.g)return h;if(!h)return null;try{const k=JSON.parse(h);if(k){for(a=0;a<k.length;a++)if(Array.isArray(k[a])){var f=k[a];if(!(f.length<2)){var g=f[1];if(Array.isArray(g)&&!(g.length<1)){var R=g[0];if(R!="noop"&&R!="stop"&&R!="close")for(let F=1;F<g.length;F++)g[F]=""}}}}return ya(k)}catch{return h}}var bi={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Hu={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},$u;function wa(){}p(wa,Lu),wa.prototype.g=function(){return new XMLHttpRequest},$u=new wa;function is(a){return encodeURIComponent(String(a))}function S_(a){var h=1;a=a.split(":");const f=[];for(;h>0&&a.length;)f.push(a.shift()),h--;return a.length&&f.push(a.join(":")),f}function Wt(a,h,f,g){this.j=a,this.i=h,this.l=f,this.S=g||1,this.V=new es(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new qu}function qu(){this.i=null,this.g="",this.h=!1}var zu={},Ta={};function Ea(a,h,f){a.M=1,a.A=Ti(wt(h)),a.u=f,a.R=!0,Gu(a,null)}function Gu(a,h){a.F=Date.now(),wi(a),a.B=wt(a.A);var f=a.B,g=a.S;Array.isArray(g)||(g=[String(g)]),ih(f.i,"t",g),a.C=0,f=a.j.L,a.h=new qu,a.g=vh(a.j,f?h:null,!a.u),a.P>0&&(a.O=new T_(u(a.Y,a,a.g),a.P)),h=a.V,f=a.g,g=a.ba;var R="readystatechange";Array.isArray(R)||(R&&(Du[0]=R.toString()),R=Du);for(let k=0;k<R.length;k++){const F=ku(f,R[k],g||h.handleEvent,!1,h.h||h);if(!F)break;h.g[F.key]=F}h=a.J?Cu(a.J):{},a.u?(a.v||(a.v="POST"),h["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.B,a.v,a.u,h)):(a.v="GET",a.g.ea(a.B,a.v,null,h)),ns(),I_(a.i,a.v,a.B,a.l,a.S,a.u)}Wt.prototype.ba=function(a){a=a.target;const h=this.O;h&&Qt(a)==3?h.j():this.Y(a)},Wt.prototype.Y=function(a){try{if(a==this.g)e:{const te=Qt(this.g),ke=this.g.ya(),de=this.g.ca();if(!(te<3)&&(te!=3||this.g&&(this.h.h||this.g.la()||dh(this.g)))){this.K||te!=4||ke==7||(ke==8||de<=0?ns(3):ns(2)),va(this);var h=this.g.ca();this.X=h;var f=k_(this);if(this.o=h==200,A_(this.i,this.v,this.B,this.l,this.S,te,h),this.o){if(this.U&&!this.L){t:{if(this.g){var g,R=this.g;if((g=R.g?R.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!T(g)){var k=g;break t}}k=null}if(a=k)dr(this.i,this.l,a,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Ia(this,a);else{this.o=!1,this.m=3,Ke(12),kn(this),os(this);break e}}if(this.R){a=!0;let xe;for(;!this.K&&this.C<f.length;)if(xe=P_(this,f),xe==Ta){te==4&&(this.m=4,Ke(14),a=!1),dr(this.i,this.l,null,"[Incomplete Response]");break}else if(xe==zu){this.m=4,Ke(15),dr(this.i,this.l,f,"[Invalid Chunk]"),a=!1;break}else dr(this.i,this.l,xe,null),Ia(this,xe);if(Wu(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),te!=4||f.length!=0||this.h.h||(this.m=1,Ke(16),a=!1),this.o=this.o&&a,!a)dr(this.i,this.l,f,"[Invalid Chunked Response]"),kn(this),os(this);else if(f.length>0&&!this.W){this.W=!0;var F=this.j;F.g==this&&F.aa&&!F.P&&(F.j.info("Great, no buffering proxy detected. Bytes received: "+f.length),Va(F),F.P=!0,Ke(11))}}else dr(this.i,this.l,f,null),Ia(this,f);te==4&&kn(this),this.o&&!this.K&&(te==4?bh(this.j,this):(this.o=!1,wi(this)))}else q_(this.g),h==400&&f.indexOf("Unknown SID")>0?(this.m=3,Ke(12)):(this.m=0,Ke(13)),kn(this),os(this)}}}catch{}finally{}};function k_(a){if(!Wu(a))return a.g.la();const h=dh(a.g);if(h==="")return"";let f="";const g=h.length,R=Qt(a.g)==4;if(!a.h.i){if(typeof TextDecoder>"u")return kn(a),os(a),"";a.h.i=new o.TextDecoder}for(let k=0;k<g;k++)a.h.h=!0,f+=a.h.i.decode(h[k],{stream:!(R&&k==g-1)});return h.length=0,a.h.g+=f,a.C=0,a.h.g}function Wu(a){return a.g?a.v=="GET"&&a.M!=2&&a.j.Aa:!1}function P_(a,h){var f=a.C,g=h.indexOf(`
`,f);return g==-1?Ta:(f=Number(h.substring(f,g)),isNaN(f)?zu:(g+=1,g+f>h.length?Ta:(h=h.slice(g,g+f),a.C=g+f,h)))}Wt.prototype.cancel=function(){this.K=!0,kn(this)};function wi(a){a.T=Date.now()+a.H,Ju(a,a.H)}function Ju(a,h){if(a.D!=null)throw Error("WatchDog timer not null");a.D=rs(u(a.aa,a),h)}function va(a){a.D&&(o.clearTimeout(a.D),a.D=null)}Wt.prototype.aa=function(){this.D=null;const a=Date.now();a-this.T>=0?(C_(this.i,this.B),this.M!=2&&(ns(),Ke(17)),kn(this),this.m=2,os(this)):Ju(this,this.T-a)};function os(a){a.j.I==0||a.K||bh(a.j,a)}function kn(a){va(a);var h=a.O;h&&typeof h.dispose=="function"&&h.dispose(),a.O=null,Ou(a.V),a.g&&(h=a.g,a.g=null,h.abort(),h.dispose())}function Ia(a,h){try{var f=a.j;if(f.I!=0&&(f.g==a||Aa(f.h,a))){if(!a.L&&Aa(f.h,a)&&f.I==3){try{var g=f.Ba.g.parse(h)}catch{g=null}if(Array.isArray(g)&&g.length==3){var R=g;if(R[0]==0){e:if(!f.v){if(f.g)if(f.g.F+3e3<a.F)Ci(f),Ii(f);else break e;xa(f),Ke(18)}}else f.xa=R[1],0<f.xa-f.K&&R[2]<37500&&f.F&&f.A==0&&!f.C&&(f.C=rs(u(f.Va,f),6e3));Yu(f.h)<=1&&f.ta&&(f.ta=void 0)}else xn(f,11)}else if((a.L||f.g==a)&&Ci(f),!T(h))for(R=f.Ba.g.parse(h),h=0;h<R.length;h++){let de=R[h];const xe=de[0];if(!(xe<=f.K))if(f.K=xe,de=de[1],f.I==2)if(de[0]=="c"){f.M=de[1],f.ba=de[2];const Tt=de[3];Tt!=null&&(f.ka=Tt,f.j.info("VER="+f.ka));const Vn=de[4];Vn!=null&&(f.za=Vn,f.j.info("SVER="+f.za));const Yt=de[5];Yt!=null&&typeof Yt=="number"&&Yt>0&&(g=1.5*Yt,f.O=g,f.j.info("backChannelRequestTimeoutMs_="+g)),g=f;const Xt=a.g;if(Xt){const Si=Xt.g?Xt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Si){var k=g.h;k.g||Si.indexOf("spdy")==-1&&Si.indexOf("quic")==-1&&Si.indexOf("h2")==-1||(k.j=k.l,k.g=new Set,k.h&&(Ca(k,k.h),k.h=null))}if(g.G){const Na=Xt.g?Xt.g.getResponseHeader("X-HTTP-Session-Id"):null;Na&&(g.wa=Na,pe(g.J,g.G,Na))}}f.I=3,f.l&&f.l.ra(),f.aa&&(f.T=Date.now()-a.F,f.j.info("Handshake RTT: "+f.T+"ms")),g=f;var F=a;if(g.na=Eh(g,g.L?g.ba:null,g.W),F.L){Xu(g.h,F);var te=F,ke=g.O;ke&&(te.H=ke),te.D&&(va(te),wi(te)),g.g=F}else yh(g);f.i.length>0&&Ai(f)}else de[0]!="stop"&&de[0]!="close"||xn(f,7);else f.I==3&&(de[0]=="stop"||de[0]=="close"?de[0]=="stop"?xn(f,7):Pa(f):de[0]!="noop"&&f.l&&f.l.qa(de),f.A=0)}}ns(4)}catch{}}var x_=class{constructor(a,h){this.g=a,this.map=h}};function Ku(a){this.l=a||10,o.PerformanceNavigationTiming?(a=o.performance.getEntriesByType("navigation"),a=a.length>0&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(o.chrome&&o.chrome.loadTimes&&o.chrome.loadTimes()&&o.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function Qu(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function Yu(a){return a.h?1:a.g?a.g.size:0}function Aa(a,h){return a.h?a.h==h:a.g?a.g.has(h):!1}function Ca(a,h){a.g?a.g.add(h):a.h=h}function Xu(a,h){a.h&&a.h==h?a.h=null:a.g&&a.g.has(h)&&a.g.delete(h)}Ku.prototype.cancel=function(){if(this.i=Zu(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function Zu(a){if(a.h!=null)return a.i.concat(a.h.G);if(a.g!=null&&a.g.size!==0){let h=a.i;for(const f of a.g.values())h=h.concat(f.G);return h}return E(a.i)}var eh=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function V_(a,h){if(a){a=a.split("&");for(let f=0;f<a.length;f++){const g=a[f].indexOf("=");let R,k=null;g>=0?(R=a[f].substring(0,g),k=a[f].substring(g+1)):R=a[f],h(R,k?decodeURIComponent(k.replace(/\+/g," ")):"")}}}function Jt(a){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let h;a instanceof Jt?(this.l=a.l,as(this,a.j),this.o=a.o,this.g=a.g,cs(this,a.u),this.h=a.h,Ra(this,oh(a.i)),this.m=a.m):a&&(h=String(a).match(eh))?(this.l=!1,as(this,h[1]||"",!0),this.o=ls(h[2]||""),this.g=ls(h[3]||"",!0),cs(this,h[4]),this.h=ls(h[5]||"",!0),Ra(this,h[6]||"",!0),this.m=ls(h[7]||"")):(this.l=!1,this.i=new hs(null,this.l))}Jt.prototype.toString=function(){const a=[];var h=this.j;h&&a.push(us(h,th,!0),":");var f=this.g;return(f||h=="file")&&(a.push("//"),(h=this.o)&&a.push(us(h,th,!0),"@"),a.push(is(f).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),f=this.u,f!=null&&a.push(":",String(f))),(f=this.h)&&(this.g&&f.charAt(0)!="/"&&a.push("/"),a.push(us(f,f.charAt(0)=="/"?O_:D_,!0))),(f=this.i.toString())&&a.push("?",f),(f=this.m)&&a.push("#",us(f,M_)),a.join("")},Jt.prototype.resolve=function(a){const h=wt(this);let f=!!a.j;f?as(h,a.j):f=!!a.o,f?h.o=a.o:f=!!a.g,f?h.g=a.g:f=a.u!=null;var g=a.h;if(f)cs(h,a.u);else if(f=!!a.h){if(g.charAt(0)!="/")if(this.g&&!this.h)g="/"+g;else{var R=h.h.lastIndexOf("/");R!=-1&&(g=h.h.slice(0,R+1)+g)}if(R=g,R==".."||R==".")g="";else if(R.indexOf("./")!=-1||R.indexOf("/.")!=-1){g=R.lastIndexOf("/",0)==0,R=R.split("/");const k=[];for(let F=0;F<R.length;){const te=R[F++];te=="."?g&&F==R.length&&k.push(""):te==".."?((k.length>1||k.length==1&&k[0]!="")&&k.pop(),g&&F==R.length&&k.push("")):(k.push(te),g=!0)}g=k.join("/")}else g=R}return f?h.h=g:f=a.i.toString()!=="",f?Ra(h,oh(a.i)):f=!!a.m,f&&(h.m=a.m),h};function wt(a){return new Jt(a)}function as(a,h,f){a.j=f?ls(h,!0):h,a.j&&(a.j=a.j.replace(/:$/,""))}function cs(a,h){if(h){if(h=Number(h),isNaN(h)||h<0)throw Error("Bad port number "+h);a.u=h}else a.u=null}function Ra(a,h,f){h instanceof hs?(a.i=h,F_(a.i,a.l)):(f||(h=us(h,L_)),a.i=new hs(h,a.l))}function pe(a,h,f){a.i.set(h,f)}function Ti(a){return pe(a,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),a}function ls(a,h){return a?h?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function us(a,h,f){return typeof a=="string"?(a=encodeURI(a).replace(h,N_),f&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function N_(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var th=/[#\/\?@]/g,D_=/[#\?:]/g,O_=/[#\?]/g,L_=/[#\?@]/g,M_=/#/g;function hs(a,h){this.h=this.g=null,this.i=a||null,this.j=!!h}function Pn(a){a.g||(a.g=new Map,a.h=0,a.i&&V_(a.i,function(h,f){a.add(decodeURIComponent(h.replace(/\+/g," ")),f)}))}n=hs.prototype,n.add=function(a,h){Pn(this),this.i=null,a=fr(this,a);let f=this.g.get(a);return f||this.g.set(a,f=[]),f.push(h),this.h+=1,this};function nh(a,h){Pn(a),h=fr(a,h),a.g.has(h)&&(a.i=null,a.h-=a.g.get(h).length,a.g.delete(h))}function rh(a,h){return Pn(a),h=fr(a,h),a.g.has(h)}n.forEach=function(a,h){Pn(this),this.g.forEach(function(f,g){f.forEach(function(R){a.call(h,R,g,this)},this)},this)};function sh(a,h){Pn(a);let f=[];if(typeof h=="string")rh(a,h)&&(f=f.concat(a.g.get(fr(a,h))));else for(a=Array.from(a.g.values()),h=0;h<a.length;h++)f=f.concat(a[h]);return f}n.set=function(a,h){return Pn(this),this.i=null,a=fr(this,a),rh(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[h]),this.h+=1,this},n.get=function(a,h){return a?(a=sh(this,a),a.length>0?String(a[0]):h):h};function ih(a,h,f){nh(a,h),f.length>0&&(a.i=null,a.g.set(fr(a,h),E(f)),a.h+=f.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],h=Array.from(this.g.keys());for(let g=0;g<h.length;g++){var f=h[g];const R=is(f);f=sh(this,f);for(let k=0;k<f.length;k++){let F=R;f[k]!==""&&(F+="="+is(f[k])),a.push(F)}}return this.i=a.join("&")};function oh(a){const h=new hs;return h.i=a.i,a.g&&(h.g=new Map(a.g),h.h=a.h),h}function fr(a,h){return h=String(h),a.j&&(h=h.toLowerCase()),h}function F_(a,h){h&&!a.j&&(Pn(a),a.i=null,a.g.forEach(function(f,g){const R=g.toLowerCase();g!=R&&(nh(this,g),ih(this,R,f))},a)),a.j=h}function U_(a,h){const f=new ss;if(o.Image){const g=new Image;g.onload=d(Kt,f,"TestLoadImage: loaded",!0,h,g),g.onerror=d(Kt,f,"TestLoadImage: error",!1,h,g),g.onabort=d(Kt,f,"TestLoadImage: abort",!1,h,g),g.ontimeout=d(Kt,f,"TestLoadImage: timeout",!1,h,g),o.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=a}else h(!1)}function j_(a,h){const f=new ss,g=new AbortController,R=setTimeout(()=>{g.abort(),Kt(f,"TestPingServer: timeout",!1,h)},1e4);fetch(a,{signal:g.signal}).then(k=>{clearTimeout(R),k.ok?Kt(f,"TestPingServer: ok",!0,h):Kt(f,"TestPingServer: server error",!1,h)}).catch(()=>{clearTimeout(R),Kt(f,"TestPingServer: error",!1,h)})}function Kt(a,h,f,g,R){try{R&&(R.onload=null,R.onerror=null,R.onabort=null,R.ontimeout=null),g(f)}catch{}}function B_(){this.g=new v_}function Sa(a){this.i=a.Sb||null,this.h=a.ab||!1}p(Sa,Lu),Sa.prototype.g=function(){return new Ei(this.i,this.h)};function Ei(a,h){Ue.call(this),this.H=a,this.o=h,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}p(Ei,Ue),n=Ei.prototype,n.open=function(a,h){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=a,this.D=h,this.readyState=1,fs(this)},n.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const h={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};a&&(h.body=a),(this.H||o).fetch(new Request(this.D,h)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,ds(this)),this.readyState=0},n.Pa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,fs(this)),this.g&&(this.readyState=3,fs(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof o.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;ah(this)}else a.text().then(this.Oa.bind(this),this.ga.bind(this))};function ah(a){a.j.read().then(a.Ma.bind(a)).catch(a.ga.bind(a))}n.Ma=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var h=a.value?a.value:new Uint8Array(0);(h=this.B.decode(h,{stream:!a.done}))&&(this.response=this.responseText+=h)}a.done?ds(this):fs(this),this.readyState==3&&ah(this)}},n.Oa=function(a){this.g&&(this.response=this.responseText=a,ds(this))},n.Na=function(a){this.g&&(this.response=a,ds(this))},n.ga=function(){this.g&&ds(this)};function ds(a){a.readyState=4,a.l=null,a.j=null,a.B=null,fs(a)}n.setRequestHeader=function(a,h){this.A.append(a,h)},n.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],h=this.h.entries();for(var f=h.next();!f.done;)f=f.value,a.push(f[0]+": "+f[1]),f=h.next();return a.join(`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qr(n){if(n.code!==V.FAILED_PRECONDITION||n.message!==S1)throw n;B("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kl=-1;function qo(n){return n==null}function ho(n){return n===0&&1/n==-1/0}function x1(n){return typeof n=="number"&&Number.isInteger(n)&&!ho(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rt{constructor(e){this.value=e}static empty(){return new rt({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!Wi(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=ks(t)}setAll(e){let t=Le.emptyPath(),r={},s=[];e.forEach(((o,c)=>{if(!t.isImmediateParentOf(c)){const l=this.getFieldsMap(t);this.applyChanges(l,r,s),r={},s=[],t=c.popLast()}o?r[c.lastSegment()]=ks(o):s.push(c.lastSegment())}));const i=this.getFieldsMap(t);this.applyChanges(i,r,s)}delete(e){const t=this.field(e.popLast());Wi(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return kt(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];Wi(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){ir(t,((s,i)=>e[s]=i));for(const s of r)delete e[s]}clone(){return new rt(ks(this.value))}}function hm(n){const e=[];return ir(n.fields,((t,r)=>{const s=new Le([t]);if(Wi(r)){const i=hm(r.mapValue).fields;if(i.length===0)e.push(s);else for(const o of i)e.push(s.child(o))}else e.push(s)})),new ut(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class go{constructor(e,t){this.position=e,this.inclusive=t}}function xd(n,e,t){let r=0;for(let s=0;s<n.position.length;s++){const i=e[s],o=n.position[s];if(i.field.isKeyField()?r=z.comparator(z.fromName(o.referenceValue),t.key):r=jr(o,t.data.field(i.field)),i.dir==="desc"&&(r*=-1),r!==0)break}return r}function Vd(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!kt(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gt{constructor(e){this._values=(e||[]).map((t=>t))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(r,s){if(r.length!==s.length)return!1;for(let i=0;i<r.length;++i)if(r[i]!==s[i])return!1;return!0})(this._values,e._values)}toJSON(){return{type:gt._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(si(e,gt._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((t=>typeof t=="number")))return new gt(e.vectorValues);throw new j(V.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}gt._jsonSchemaVersion="firestore/vectorValue/1.0",gt._jsonSchema={type:Se("string",gt._jsonSchemaVersion),vectorValues:Se("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Kn._jsonSchemaVersion="firestore/querySnapshot/1.0",Kn._jsonSchema={type:Se("string",Kn._jsonSchemaVersion),bundleSource:Se("string","QuerySnapshot"),bundleName:Se("string"),bundle:Se("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
