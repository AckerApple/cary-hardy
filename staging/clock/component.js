  ...
  return html`
    ...
    <div style="background-color:black;padding:0 0 .2em 0;">
      ...
      <div style="display:flex;gap:1em;justify-content: center;">
        ${calLinks.map(item => {
          return html`
            <a href=${item.url} target="_blank" style="color:inherit;text-decoration:none;border:1px solid #666;border-radius:.3em;width:62px;height:62px;display:flex;align-items:center;justify-content: center;">
        ...
        <a href="cary-hardy-meetup.ics" target="_blank" download="cary-hardy-meetup.ics" style="color:inherit;text-decoration:none;border:1px solid #666;border-radius:.3em;width:62px;height:62px;display:flex;align-items:center;justify-content: center;">
